...
- generatedAt: 2026-05-04T12:22:26.903Z
- sourceBranch: codex/managed-multi-agent-v1-foundation
- sourceCommit: 4ceaf3d9e37dcc1478270c5c2876194ba5e6f81c
...
| --- | --- | ---: | ---: | --- | --- |
| `npm run smoke:incident-slo-policy` | pass | 0 | 245 | 5s | yes |
| `npm run smoke:execution-v1-status` | pass | 0 | 1015 | 15s | yes |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 370 | 15s | yes |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 629 | 5s | yes |
| `npm run smoke:clean-deployment-release` | pass | 0 | 306 | 15s | yes |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 744 | 10s | yes |
| `npm run smoke:runtime-isolation` | pass | 0 | 1539 | 10s | yes |
...
```json
{
    ...
    "deterministic": "8/8",
    "runtimeRows": 8,
    "snapshotCommit": "007b0526d81b0bf9bd979518087d87f6547b5de5"
  }
```
