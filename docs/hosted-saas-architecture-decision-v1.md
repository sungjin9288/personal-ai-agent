...
| --- | --- | --- | --- |
| Tenant model | tenant identity source, org/user model, tenant isolation boundary, and tenant administration owner | local tenant claim and runtime isolation gates exist only for pilot boundary | blocked |
