...
- generatedAt: 2026-05-04T18:18:41.577Z
...
| `npm run smoke:web-oidc-rbac` | pass | 0 | 1326 |
| `npm run smoke:web-tenant-isolation` | pass | 0 | 1360 |
| `npm run smoke:web-rbac` | pass | 0 | 1409 |
