...
- generatedAt: 2026-05-05T01:41:56.254Z
...
| `npm run smoke:web-oidc-rbac` | pass | 0 | 1323 |
| `npm run smoke:web-tenant-isolation` | pass | 0 | 1311 |
| `npm run smoke:web-rbac` | pass | 0 | 1398 |
