...
- smoke:reference-adoptions: 53.2s elapsed, stdout 5.4KiB, stderr 0B, timeout 20.0m
- smoke:execution-v1-live-helpers: 11.8s elapsed, stdout 391B, stderr 0B, timeout 20.0m
- smoke:execution-v1-handoff: 2.8s elapsed, stdout 411B, stderr 0B, timeout 20.0m
- smoke:production-readiness-gate: 173ms elapsed, stdout 2.5KiB, stderr 0B, timeout 20.0m
...
- scripts/smoke-output-compaction.mjs: passed (291ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-mission-quality-gate.mjs: passed (433ms, timeout 5.0m, timedOut false)
- scripts/smoke-document-conversion.mjs: passed (672ms, timeout 5.0m, timedOut false)
- scripts/smoke-document-conversion-diagnostics.mjs: passed (737ms, timeout 5.0m, timedOut false)
- scripts/smoke-runtime-discovery.mjs: passed (3.8s, timeout 5.0m, timedOut false)
- scripts/smoke-visual-evidence-manifest.mjs: passed (98ms, timeout 5.0m, timedOut false)
- scripts/smoke-retrieval-memory.mjs: passed (412ms, timeout 5.0m, timedOut false)
- scripts/smoke-fact-graph-memory.mjs: passed (440ms, timeout 5.0m, timedOut false)
- scripts/smoke-instruction-boundary-fixture.mjs: passed (209ms, timeout 5.0m, timedOut false)
- scripts/smoke-openclaw-hermes-orchestration-docs.mjs: passed (51ms, timeout 5.0m, timedOut false)
- scripts/smoke-channel-adapter-seam.mjs: passed (506ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-context-records.mjs: passed (833ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-audit-surface.mjs: passed (638ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-audit-surface.mjs: passed (864ms, timeout 5.0m, timedOut false)
- scripts/smoke-permission-decision-records.mjs: passed (2.4s, timeout 5.0m, timedOut false)
- scripts/smoke-sandbox-decision-timelines.mjs: passed (794ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-learning-candidate.mjs: passed (606ms, timeout 5.0m, timedOut false)
- scripts/smoke-provider-fallback-route-decision.mjs: passed (607ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-parallel-specialists.mjs: passed (26.4s, timeout 5.0m, timedOut false)
...
- artifactSetSha256: 5b71684a8d8c2c3449e87706c49480973789e2cf8e72f787b759df65d18629e3
