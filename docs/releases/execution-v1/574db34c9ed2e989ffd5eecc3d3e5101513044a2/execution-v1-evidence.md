...
- smoke:execution-cli: 586ms elapsed, stdout 324B, stderr 0B, timeout 20.0m
- smoke:ui-execution-console: 708ms elapsed, stdout 343B, stderr 0B, timeout 20.0m
...
- scripts/smoke-mission-quality-gate.mjs: passed (403ms, timeout 5.0m, timedOut false)
- scripts/smoke-document-conversion.mjs: passed (496ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-visual-evidence-manifest.mjs: passed (64ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-channel-adapter-seam.mjs: passed (431ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-context-records.mjs: passed (589ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-audit-surface.mjs: passed (454ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-audit-surface.mjs: passed (505ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-provider-fallback-route-decision.mjs: passed (597ms, timeout 5.0m, timedOut false)
- scripts/smoke-learning-promotion-queue.mjs: passed (1.6s, timeout 5.0m, timedOut false)
- scripts/smoke-learning-candidate-audit-surface.mjs: passed (978ms, timeout 5.0m, timedOut false)
- scripts/smoke-learning-promotion-verification-gate.mjs: passed (789ms, timeout 5.0m, timedOut false)
...
- artifactSetSha256: 72e59a6a1e2fd650f11090bd739550866f5ac02ab8045bc8154a8d16c66ffbc6
