...
- smoke:execution-cli: 891ms elapsed, stdout 324B, stderr 0B, timeout 20.0m
- smoke:ui-execution-console: 895ms elapsed, stdout 343B, stderr 0B, timeout 20.0m
...
- smoke:execution-v1-handoff: 3.1s elapsed, stdout 419B, stderr 0B, timeout 20.0m
...
- scripts/smoke-channel-adapter-seam.mjs: passed (394ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-context-records.mjs: passed (547ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-audit-surface.mjs: passed (395ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-audit-surface.mjs: passed (435ms, timeout 5.0m, timedOut false)
- scripts/smoke-permission-decision-records.mjs: passed (906ms, timeout 5.0m, timedOut false)
- scripts/smoke-sandbox-decision-timelines.mjs: passed (531ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-learning-candidate.mjs: passed (526ms, timeout 5.0m, timedOut false)
- scripts/smoke-provider-fallback-route-decision.mjs: passed (533ms, timeout 5.0m, timedOut false)
- scripts/smoke-learning-promotion-queue.mjs: passed (1.4s, timeout 5.0m, timedOut false)
- scripts/smoke-learning-candidate-audit-surface.mjs: passed (796ms, timeout 5.0m, timedOut false)
- scripts/smoke-learning-promotion-verification-gate.mjs: passed (690ms, timeout 5.0m, timedOut false)
- scripts/smoke-learning-promotion-verification-stop-condition.mjs: passed (958ms, timeout 5.0m, timedOut false)
...
- artifactSetSha256: 06ad4962ca6aa0b06a097121f1e535caca11ce83ebd9754f84970152436fa36d
