...
- reference adoption aggregate: ready, 28 scripts, ok=true, totalDuration=1.3m
...
- visual artifact set: e8344945c989529506e8b90a5343c24c8a7a2840826e4cfca7be364649aa5bf6
...
6. Current verified commit is already contained in `origin/codex/learning-promotion-rollback-button-renderer`; only commit/push again after intentionally changing release artifacts.
