...
- smoke:ui-execution-console: 791ms elapsed, stdout 343B, stderr 0B, timeout 20.0m
- smoke:ui-execution-browser-e2e: 5.5m elapsed, stdout 7.1KiB, stderr 8.6KiB, timeout 20.0m
- smoke:reference-adoptions: 47.0s elapsed, stdout 5.4KiB, stderr 0B, timeout 20.0m
- smoke:execution-v1-live-helpers: 11.2s elapsed, stdout 391B, stderr 0B, timeout 20.0m
- smoke:execution-v1-handoff: 2.9s elapsed, stdout 411B, stderr 0B, timeout 20.0m
- smoke:production-readiness-gate: 168ms elapsed, stdout 2.5KiB, stderr 0B, timeout 20.0m
...
- scripts/smoke-output-compaction.mjs: passed (241ms, timeout 5.0m, timedOut false)
- scripts/smoke-provider-capability-rate-guard.mjs: passed (86ms, timeout 5.0m, timedOut false)
- scripts/smoke-hermes-provider.mjs: passed (191ms, timeout 5.0m, timedOut false)
- scripts/smoke-mission-quality-gate.mjs: passed (366ms, timeout 5.0m, timedOut false)
- scripts/smoke-document-conversion.mjs: passed (731ms, timeout 5.0m, timedOut false)
- scripts/smoke-document-conversion-diagnostics.mjs: passed (582ms, timeout 5.0m, timedOut false)
- scripts/smoke-runtime-discovery.mjs: passed (3.6s, timeout 5.0m, timedOut false)
- scripts/smoke-visual-evidence-manifest.mjs: passed (110ms, timeout 5.0m, timedOut false)
- scripts/smoke-retrieval-memory.mjs: passed (238ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-channel-adapter-seam.mjs: passed (400ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-context-records.mjs: passed (550ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-audit-surface.mjs: passed (406ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-audit-surface.mjs: passed (449ms, timeout 5.0m, timedOut false)
- scripts/smoke-permission-decision-records.mjs: passed (960ms, timeout 5.0m, timedOut false)
- scripts/smoke-sandbox-decision-timelines.mjs: passed (568ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-learning-candidate.mjs: passed (568ms, timeout 5.0m, timedOut false)
- scripts/smoke-provider-fallback-route-decision.mjs: passed (638ms, timeout 5.0m, timedOut false)
- scripts/smoke-learning-promotion-queue.mjs: passed (1.5s, timeout 5.0m, timedOut false)
- scripts/smoke-learning-candidate-audit-surface.mjs: passed (826ms, timeout 5.0m, timedOut false)
- scripts/smoke-learning-promotion-verification-gate.mjs: passed (718ms, timeout 5.0m, timedOut false)
...
- artifactSetSha256: 9ced5a746b7a6f6aae5ac97ef451a93c446d67077306ef79ae2c7b818c80c88b
