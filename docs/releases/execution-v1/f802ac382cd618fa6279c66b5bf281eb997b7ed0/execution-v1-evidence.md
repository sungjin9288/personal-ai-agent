...
- smoke:execution-cli: 909ms elapsed, stdout 324B, stderr 0B, timeout 20.0m
- smoke:ui-execution-console: 943ms elapsed, stdout 343B, stderr 0B, timeout 20.0m
- smoke:ui-execution-browser-e2e: 5.9m elapsed, stdout 7.1KiB, stderr 8.6KiB, timeout 20.0m
- smoke:reference-adoptions: 46.5s elapsed, stdout 5.4KiB, stderr 0B, timeout 20.0m
- smoke:execution-v1-live-helpers: 10.9s elapsed, stdout 391B, stderr 0B, timeout 20.0m
- smoke:execution-v1-handoff: 3.1s elapsed, stdout 406B, stderr 0B, timeout 20.0m
...
- scripts/smoke-provider-capability-rate-guard.mjs: passed (91ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-document-conversion.mjs: passed (550ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-retrieval-memory.mjs: passed (245ms, timeout 5.0m, timedOut false)
- scripts/smoke-fact-graph-memory.mjs: passed (321ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-identity-session-context-records.mjs: passed (567ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-audit-surface.mjs: passed (413ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-audit-surface.mjs: passed (458ms, timeout 5.0m, timedOut false)
- scripts/smoke-permission-decision-records.mjs: passed (969ms, timeout 5.0m, timedOut false)
- scripts/smoke-sandbox-decision-timelines.mjs: passed (567ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-learning-candidate.mjs: passed (566ms, timeout 5.0m, timedOut false)
- scripts/smoke-provider-fallback-route-decision.mjs: passed (568ms, timeout 5.0m, timedOut false)
- scripts/smoke-learning-promotion-queue.mjs: passed (1.5s, timeout 5.0m, timedOut false)
- scripts/smoke-learning-candidate-audit-surface.mjs: passed (852ms, timeout 5.0m, timedOut false)
- scripts/smoke-learning-promotion-verification-gate.mjs: passed (802ms, timeout 5.0m, timedOut false)
...
- artifactSetSha256: 1d3a70127887940fb376724a198151af67f0de0a3e4789b32e48b98655621718
