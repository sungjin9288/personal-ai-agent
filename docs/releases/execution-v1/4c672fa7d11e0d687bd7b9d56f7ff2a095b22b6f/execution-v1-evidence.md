...
- smoke:execution-cli: 764ms elapsed, stdout 324B, stderr 0B, timeout 30.0m
- smoke:ui-execution-console: 787ms elapsed, stdout 343B, stderr 0B, timeout 30.0m
- smoke:ui-execution-browser-e2e: 7.0m elapsed, stdout 7.0KiB, stderr 8.6KiB, timeout 30.0m
- smoke:reference-adoptions: 28.2s elapsed, stdout 2.9KiB, stderr 0B, timeout 30.0m
- smoke:execution-v1-live-helpers: 10.2s elapsed, stdout 391B, stderr 0B, timeout 30.0m
- smoke:execution-v1-handoff: 2.9s elapsed, stdout 443B, stderr 0B, timeout 30.0m
- smoke:production-readiness-gate: 149ms elapsed, stdout 2.5KiB, stderr 0B, timeout 30.0m
...
- scripts/smoke-fact-graph-memory.mjs: passed (273ms, timeout 5.0m, timedOut false)
- scripts/smoke-instruction-boundary-fixture.mjs: passed (150ms, timeout 5.0m, timedOut false)
- scripts/smoke-orchestration-profiles.mjs: passed (966ms, timeout 5.0m, timedOut false)
...
- artifactSetSha256: 03d84510437002631c43aaae50cf001ae837b8d0b47e9740471632d48597b821
