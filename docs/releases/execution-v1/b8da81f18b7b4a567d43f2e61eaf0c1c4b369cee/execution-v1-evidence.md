...
- smoke:execution-cli: 774ms elapsed, stdout 324B, stderr 0B, timeout 20.0m
- smoke:ui-execution-console: 821ms elapsed, stdout 343B, stderr 0B, timeout 20.0m
- smoke:ui-execution-browser-e2e: 6.1m elapsed, stdout 7.1KiB, stderr 8.6KiB, timeout 20.0m
- smoke:reference-adoptions: 52.7s elapsed, stdout 5.4KiB, stderr 0B, timeout 20.0m
- smoke:execution-v1-live-helpers: 13.3s elapsed, stdout 391B, stderr 0B, timeout 20.0m
- smoke:execution-v1-handoff: 2.8s elapsed, stdout 415B, stderr 0B, timeout 20.0m
- smoke:production-readiness-gate: 204ms elapsed, stdout 2.5KiB, stderr 0B, timeout 20.0m
...
- scripts/smoke-output-compaction.mjs: passed (248ms, timeout 5.0m, timedOut false)
- scripts/smoke-provider-capability-rate-guard.mjs: passed (107ms, timeout 5.0m, timedOut false)
- scripts/smoke-hermes-provider.mjs: passed (227ms, timeout 5.0m, timedOut false)
- scripts/smoke-mission-quality-gate.mjs: passed (390ms, timeout 5.0m, timedOut false)
- scripts/smoke-document-conversion.mjs: passed (521ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-visual-evidence-manifest.mjs: passed (150ms, timeout 5.0m, timedOut false)
- scripts/smoke-retrieval-memory.mjs: passed (267ms, timeout 5.0m, timedOut false)
- scripts/smoke-fact-graph-memory.mjs: passed (340ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-channel-adapter-seam.mjs: passed (462ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-context-records.mjs: passed (741ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-audit-surface.mjs: passed (451ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-audit-surface.mjs: passed (496ms, timeout 5.0m, timedOut false)
- scripts/smoke-permission-decision-records.mjs: passed (1.2s, timeout 5.0m, timedOut false)
- scripts/smoke-sandbox-decision-timelines.mjs: passed (653ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-learning-candidate.mjs: passed (683ms, timeout 5.0m, timedOut false)
- scripts/smoke-provider-fallback-route-decision.mjs: passed (764ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-learning-promotion-verification-gate.mjs: passed (863ms, timeout 5.0m, timedOut false)
...
- artifactSetSha256: de6be1f50715d381a957a957211d8c33120e37d6b8f94f201d36489d7bf9e68e
