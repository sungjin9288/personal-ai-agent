...
- smoke:execution-cli: 683ms elapsed, stdout 324B, stderr 0B, timeout 20.0m
...
- smoke:execution-v1-handoff: 3.1s elapsed, stdout 423B, stderr 0B, timeout 20.0m
...
- scripts/smoke-document-conversion-diagnostics.mjs: passed (712ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-fact-graph-memory.mjs: passed (505ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-identity-session-context-records.mjs: passed (701ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-audit-surface.mjs: passed (542ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-sandbox-decision-timelines.mjs: passed (662ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-learning-candidate.mjs: passed (693ms, timeout 5.0m, timedOut false)
- scripts/smoke-provider-fallback-route-decision.mjs: passed (711ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-learning-promotion-verification-gate.mjs: passed (923ms, timeout 5.0m, timedOut false)
...
- artifactSetSha256: ee40aa0ac6ab684eaa7f5883cf0174045149c11ba3a84c00bf971b7b22c515fe
