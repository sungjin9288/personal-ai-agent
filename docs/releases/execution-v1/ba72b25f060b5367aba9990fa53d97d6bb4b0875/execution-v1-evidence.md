...
- smoke:execution-cli: 746ms elapsed, stdout 324B, stderr 0B, timeout 20.0m
- smoke:ui-execution-console: 810ms elapsed, stdout 343B, stderr 0B, timeout 20.0m
- smoke:ui-execution-browser-e2e: 5.6m elapsed, stdout 7.1KiB, stderr 8.6KiB, timeout 20.0m
- smoke:reference-adoptions: 51.7s elapsed, stdout 5.4KiB, stderr 0B, timeout 20.0m
- smoke:execution-v1-live-helpers: 13.7s elapsed, stdout 391B, stderr 0B, timeout 20.0m
- smoke:execution-v1-handoff: 3.3s elapsed, stdout 422B, stderr 0B, timeout 20.0m
...
- scripts/smoke-document-conversion.mjs: passed (570ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-retrieval-memory.mjs: passed (312ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-channel-adapter-seam.mjs: passed (432ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-context-records.mjs: passed (652ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-audit-surface.mjs: passed (505ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-audit-surface.mjs: passed (561ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-provider-fallback-route-decision.mjs: passed (636ms, timeout 5.0m, timedOut false)
- scripts/smoke-learning-promotion-queue.mjs: passed (1.7s, timeout 5.0m, timedOut false)
- scripts/smoke-learning-candidate-audit-surface.mjs: passed (983ms, timeout 5.0m, timedOut false)
...
- artifactSetSha256: 170fd5eaee707aeaf94910c6b792779e77fc30823810f005a3a57fc6c0e5dd89
