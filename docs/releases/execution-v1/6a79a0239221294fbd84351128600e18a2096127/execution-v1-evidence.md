...
- smoke:execution-flow: 1.8s elapsed, stdout 421B, stderr 0B, timeout 20.0m
...
- smoke:reference-adoptions: 56.6s elapsed, stdout 5.4KiB, stderr 0B, timeout 20.0m
- smoke:execution-v1-live-helpers: 12.5s elapsed, stdout 391B, stderr 0B, timeout 20.0m
- smoke:execution-v1-handoff: 2.8s elapsed, stdout 416B, stderr 0B, timeout 20.0m
- smoke:production-readiness-gate: 210ms elapsed, stdout 2.5KiB, stderr 0B, timeout 20.0m
...
- scripts/smoke-provider-capability-rate-guard.mjs: passed (211ms, timeout 5.0m, timedOut false)
- scripts/smoke-hermes-provider.mjs: passed (329ms, timeout 5.0m, timedOut false)
- scripts/smoke-mission-quality-gate.mjs: passed (405ms, timeout 5.0m, timedOut false)
- scripts/smoke-document-conversion.mjs: passed (492ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-channel-adapter-seam.mjs: passed (646ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-context-records.mjs: passed (738ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-audit-surface.mjs: passed (557ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-sandbox-decision-timelines.mjs: passed (642ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-learning-candidate.mjs: passed (747ms, timeout 5.0m, timedOut false)
- scripts/smoke-provider-fallback-route-decision.mjs: passed (812ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-parallel-specialists.mjs: passed (31.0s, timeout 5.0m, timedOut false)
...
- artifactSetSha256: d3b11fbdf8595df477608bfba33ef9ac8e5f77cf4fe59f7cb7cf05cd6c2d27a1
