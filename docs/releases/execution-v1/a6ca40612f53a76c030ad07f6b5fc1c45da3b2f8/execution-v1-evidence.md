...
- smoke:execution-cli: 545ms elapsed, stdout 324B, stderr 0B, timeout 20.0m
- smoke:ui-execution-console: 701ms elapsed, stdout 343B, stderr 0B, timeout 20.0m
- smoke:ui-execution-browser-e2e: 5.2m elapsed, stdout 7.1KiB, stderr 8.7KiB, timeout 20.0m
...
- smoke:execution-v1-handoff: 2.0s elapsed, stdout 408B, stderr 0B, timeout 20.0m
...
- scripts/smoke-output-compaction.mjs: passed (258ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-mission-quality-gate.mjs: passed (373ms, timeout 5.0m, timedOut false)
- scripts/smoke-document-conversion.mjs: passed (686ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-visual-evidence-manifest.mjs: passed (60ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-channel-adapter-seam.mjs: passed (405ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-context-records.mjs: passed (550ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-audit-surface.mjs: passed (430ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-audit-surface.mjs: passed (457ms, timeout 5.0m, timedOut false)
- scripts/smoke-permission-decision-records.mjs: passed (958ms, timeout 5.0m, timedOut false)
- scripts/smoke-sandbox-decision-timelines.mjs: passed (600ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-learning-candidate.mjs: passed (577ms, timeout 5.0m, timedOut false)
- scripts/smoke-provider-fallback-route-decision.mjs: passed (577ms, timeout 5.0m, timedOut false)
- scripts/smoke-learning-promotion-queue.mjs: passed (1.6s, timeout 5.0m, timedOut false)
- scripts/smoke-learning-candidate-audit-surface.mjs: passed (872ms, timeout 5.0m, timedOut false)
- scripts/smoke-learning-promotion-verification-gate.mjs: passed (728ms, timeout 5.0m, timedOut false)
...
- artifactSetSha256: d3d357460c74690faca72c2c702842073f2eb4edf067dcab3ed97e5b82bc5f07
