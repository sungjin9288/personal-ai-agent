...
- smoke:execution-cli: 562ms elapsed, stdout 324B, stderr 0B, timeout 20.0m
...
- smoke:execution-v1-handoff: 2.0s elapsed, stdout 422B, stderr 0B, timeout 20.0m
- smoke:production-readiness-gate: 150ms elapsed, stdout 2.5KiB, stderr 0B, timeout 20.0m
...
- scripts/smoke-output-compaction.mjs: passed (278ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-document-conversion.mjs: passed (502ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-visual-evidence-manifest.mjs: passed (62ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-channel-adapter-seam.mjs: passed (465ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-context-records.mjs: passed (607ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-audit-surface.mjs: passed (448ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-audit-surface.mjs: passed (491ms, timeout 5.0m, timedOut false)
- scripts/smoke-permission-decision-records.mjs: passed (1.0s, timeout 5.0m, timedOut false)
- scripts/smoke-sandbox-decision-timelines.mjs: passed (607ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-learning-candidate.mjs: passed (648ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-learning-candidate-audit-surface.mjs: passed (947ms, timeout 5.0m, timedOut false)
- scripts/smoke-learning-promotion-verification-gate.mjs: passed (780ms, timeout 5.0m, timedOut false)
...
- artifactSetSha256: a5062f06ed5ef1b358d5fd56f7f9a61f32ede6663bb54603853fc1a821eee842
