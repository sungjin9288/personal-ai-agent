...
- generatedAt: 2026-07-16T19:42:46.077Z
...
- smoke:execution-cli: 560ms elapsed, stdout 324B, stderr 0B, timeout 20.0m
...
- smoke:reference-adoptions: 44.7s elapsed, stdout 5.4KiB, stderr 0B, timeout 20.0m
- smoke:execution-v1-live-helpers: 10.3s elapsed, stdout 391B, stderr 0B, timeout 20.0m
- smoke:execution-v1-handoff: 2.0s elapsed, stdout 418B, stderr 0B, timeout 20.0m
...
- scripts/smoke-output-compaction.mjs: passed (261ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-mission-quality-gate.mjs: passed (371ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-identity-session-context-records.mjs: passed (549ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-audit-surface.mjs: passed (422ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-audit-surface.mjs: passed (483ms, timeout 5.0m, timedOut false)
- scripts/smoke-permission-decision-records.mjs: passed (963ms, timeout 5.0m, timedOut false)
- scripts/smoke-sandbox-decision-timelines.mjs: passed (549ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-learning-candidate.mjs: passed (566ms, timeout 5.0m, timedOut false)
- scripts/smoke-provider-fallback-route-decision.mjs: passed (552ms, timeout 5.0m, timedOut false)
- scripts/smoke-learning-promotion-queue.mjs: passed (1.5s, timeout 5.0m, timedOut false)
- scripts/smoke-learning-candidate-audit-surface.mjs: passed (870ms, timeout 5.0m, timedOut false)
- scripts/smoke-learning-promotion-verification-gate.mjs: passed (731ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-process-timeout-utils.mjs: passed (896ms, timeout 5.0m, timedOut false)
...
- artifactSetSha256: c411fb2fe7a724135ff193abd693dcb8093aa39f39a9a7cc448bc67494c0e725
