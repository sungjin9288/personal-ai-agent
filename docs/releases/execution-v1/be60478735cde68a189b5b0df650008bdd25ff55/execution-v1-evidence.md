...
- smoke:ui-execution-console: 789ms elapsed, stdout 343B, stderr 0B, timeout 20.0m
- smoke:ui-execution-browser-e2e: 6.0m elapsed, stdout 7.1KiB, stderr 8.7KiB, timeout 20.0m
- smoke:reference-adoptions: 55.3s elapsed, stdout 5.4KiB, stderr 0B, timeout 20.0m
- smoke:execution-v1-live-helpers: 13.0s elapsed, stdout 391B, stderr 0B, timeout 20.0m
- smoke:execution-v1-handoff: 2.1s elapsed, stdout 422B, stderr 0B, timeout 20.0m
- smoke:production-readiness-gate: 189ms elapsed, stdout 2.5KiB, stderr 0B, timeout 20.0m
...
- scripts/smoke-output-compaction.mjs: passed (337ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-mission-quality-gate.mjs: passed (484ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-visual-evidence-manifest.mjs: passed (132ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-instruction-boundary-fixture.mjs: passed (230ms, timeout 5.0m, timedOut false)
- scripts/smoke-openclaw-hermes-orchestration-docs.mjs: passed (61ms, timeout 5.0m, timedOut false)
- scripts/smoke-channel-adapter-seam.mjs: passed (581ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-gateway-event-audit-surface.mjs: passed (589ms, timeout 5.0m, timedOut false)
- scripts/smoke-permission-decision-records.mjs: passed (1.1s, timeout 5.0m, timedOut false)
- scripts/smoke-sandbox-decision-timelines.mjs: passed (768ms, timeout 5.0m, timedOut false)
...
- artifactSetSha256: bded4b431b8e5452dd6e5cb771747928ceeb1f27584faff79c6c947e791181ee
