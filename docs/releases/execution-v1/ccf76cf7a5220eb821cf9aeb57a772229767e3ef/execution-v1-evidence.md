...
- smoke:execution-cli: 718ms elapsed, stdout 324B, stderr 0B, timeout 20.0m
- smoke:ui-execution-console: 797ms elapsed, stdout 343B, stderr 0B, timeout 20.0m
- smoke:ui-execution-browser-e2e: 6.8m elapsed, stdout 7.1KiB, stderr 8.7KiB, timeout 20.0m
- smoke:reference-adoptions: 53.4s elapsed, stdout 5.6KiB, stderr 0B, timeout 20.0m
- smoke:execution-v1-live-helpers: 12.9s elapsed, stdout 391B, stderr 0B, timeout 20.0m
- smoke:execution-v1-handoff: 2.1s elapsed, stdout 415B, stderr 0B, timeout 20.0m
- smoke:production-readiness-gate: 215ms elapsed, stdout 2.5KiB, stderr 0B, timeout 20.0m
...
- scripts/smoke-output-compaction.mjs: passed (528ms, timeout 5.0m, timedOut false)
- scripts/smoke-provider-capability-rate-guard.mjs: passed (141ms, timeout 5.0m, timedOut false)
- scripts/smoke-hermes-provider.mjs: passed (302ms, timeout 5.0m, timedOut false)
- scripts/smoke-mission-quality-gate.mjs: passed (552ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-retrieval-memory.mjs: passed (404ms, timeout 5.0m, timedOut false)
- scripts/smoke-fact-graph-memory.mjs: passed (424ms, timeout 5.0m, timedOut false)
- scripts/smoke-instruction-boundary-fixture.mjs: passed (263ms, timeout 5.0m, timedOut false)
- scripts/smoke-openclaw-hermes-orchestration-docs.mjs: passed (50ms, timeout 5.0m, timedOut false)
- scripts/smoke-channel-adapter-seam.mjs: passed (566ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-context-records.mjs: passed (761ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-audit-surface.mjs: passed (643ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-audit-surface.mjs: passed (785ms, timeout 5.0m, timedOut false)
- scripts/smoke-permission-decision-records.mjs: passed (1.4s, timeout 5.0m, timedOut false)
- scripts/smoke-sandbox-decision-timelines.mjs: passed (750ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-learning-candidate.mjs: passed (738ms, timeout 5.0m, timedOut false)
- scripts/smoke-provider-fallback-route-decision.mjs: passed (699ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-council-stub-runtime.mjs: passed (302ms, timeout 5.0m, timedOut false)
- scripts/smoke-ui-agent-blueprints.mjs: passed (5.3s, timeout 5.0m, timedOut false)
- scripts/smoke-parallel-specialists.mjs: passed (24.7s, timeout 5.0m, timedOut false)
...
- artifactSetSha256: 77432a0992a5e3ef43a032b75314e2fc34d856eac34599acfd026d5a549d13a9
