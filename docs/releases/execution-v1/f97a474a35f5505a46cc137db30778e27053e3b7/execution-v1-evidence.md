...
- smoke:execution-cli: 687ms elapsed, stdout 324B, stderr 0B, timeout 20.0m
...
- smoke:reference-adoptions: 50.5s elapsed, stdout 5.4KiB, stderr 0B, timeout 20.0m
- smoke:execution-v1-live-helpers: 12.2s elapsed, stdout 391B, stderr 0B, timeout 20.0m
- smoke:execution-v1-handoff: 3.0s elapsed, stdout 411B, stderr 0B, timeout 20.0m
...
- scripts/smoke-mission-quality-gate.mjs: passed (368ms, timeout 5.0m, timedOut false)
- scripts/smoke-document-conversion.mjs: passed (598ms, timeout 5.0m, timedOut false)
- scripts/smoke-document-conversion-diagnostics.mjs: passed (580ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-retrieval-memory.mjs: passed (236ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-channel-adapter-seam.mjs: passed (406ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-context-records.mjs: passed (568ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-audit-surface.mjs: passed (418ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-audit-surface.mjs: passed (463ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-provider-fallback-route-decision.mjs: passed (573ms, timeout 5.0m, timedOut false)
- scripts/smoke-learning-promotion-queue.mjs: passed (1.5s, timeout 5.0m, timedOut false)
- scripts/smoke-learning-candidate-audit-surface.mjs: passed (938ms, timeout 5.0m, timedOut false)
- scripts/smoke-learning-promotion-verification-gate.mjs: passed (734ms, timeout 5.0m, timedOut false)
...
- artifactSetSha256: ccbd766fdcf4c887bad52e4b8fbaf413e73d3e021a265bba34faf3d23cec2236
