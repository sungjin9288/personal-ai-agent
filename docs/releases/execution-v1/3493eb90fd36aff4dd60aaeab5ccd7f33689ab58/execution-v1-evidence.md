...
- smoke:execution-cli: 629ms elapsed, stdout 324B, stderr 0B, timeout 20.0m
- smoke:ui-execution-console: 730ms elapsed, stdout 343B, stderr 0B, timeout 20.0m
...
- smoke:execution-v1-live-helpers: 15.3s elapsed, stdout 391B, stderr 0B, timeout 20.0m
- smoke:execution-v1-handoff: 3.1s elapsed, stdout 415B, stderr 0B, timeout 20.0m
- smoke:production-readiness-gate: 409ms elapsed, stdout 2.5KiB, stderr 0B, timeout 20.0m
...
- scripts/smoke-mission-quality-gate.mjs: passed (726ms, timeout 5.0m, timedOut false)
- scripts/smoke-document-conversion.mjs: passed (632ms, timeout 5.0m, timedOut false)
- scripts/smoke-document-conversion-diagnostics.mjs: passed (744ms, timeout 5.0m, timedOut false)
- scripts/smoke-runtime-discovery.mjs: passed (5.4s, timeout 5.0m, timedOut false)
- scripts/smoke-visual-evidence-manifest.mjs: passed (86ms, timeout 5.0m, timedOut false)
- scripts/smoke-retrieval-memory.mjs: passed (299ms, timeout 5.0m, timedOut false)
- scripts/smoke-fact-graph-memory.mjs: passed (391ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-channel-adapter-seam.mjs: passed (505ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-context-records.mjs: passed (684ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-audit-surface.mjs: passed (498ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-audit-surface.mjs: passed (539ms, timeout 5.0m, timedOut false)
- scripts/smoke-permission-decision-records.mjs: passed (1.3s, timeout 5.0m, timedOut false)
- scripts/smoke-sandbox-decision-timelines.mjs: passed (877ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-learning-candidate.mjs: passed (904ms, timeout 5.0m, timedOut false)
- scripts/smoke-provider-fallback-route-decision.mjs: passed (881ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-learning-promotion-verification-gate.mjs: passed (894ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-parallel-specialists.mjs: passed (32.8s, timeout 5.0m, timedOut false)
- scripts/smoke-process-timeout-utils.mjs: passed (910ms, timeout 5.0m, timedOut false)
...
- artifactSetSha256: 1eb08274227b593b566976904ef3025c739fa0ce47a9cd7e78e3d981fd135beb
