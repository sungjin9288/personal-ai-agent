...
- smoke:execution-cli: 539ms elapsed, stdout 324B, stderr 0B, timeout 20.0m
...
- smoke:reference-adoptions: 47.5s elapsed, stdout 5.4KiB, stderr 0B, timeout 20.0m
- smoke:execution-v1-live-helpers: 10.9s elapsed, stdout 391B, stderr 0B, timeout 20.0m
- smoke:execution-v1-handoff: 3.0s elapsed, stdout 428B, stderr 0B, timeout 20.0m
- smoke:production-readiness-gate: 172ms elapsed, stdout 2.5KiB, stderr 0B, timeout 20.0m
...
- scripts/smoke-output-compaction.mjs: passed (238ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-mission-quality-gate.mjs: passed (357ms, timeout 5.0m, timedOut false)
- scripts/smoke-document-conversion.mjs: passed (2.1s, timeout 5.0m, timedOut false)
...
- scripts/smoke-retrieval-memory.mjs: passed (221ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-identity-session-context-records.mjs: passed (538ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-permission-decision-records.mjs: passed (928ms, timeout 5.0m, timedOut false)
- scripts/smoke-sandbox-decision-timelines.mjs: passed (539ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-learning-candidate.mjs: passed (539ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-learning-promotion-verification-gate.mjs: passed (709ms, timeout 5.0m, timedOut false)
- scripts/smoke-learning-promotion-verification-stop-condition.mjs: passed (979ms, timeout 5.0m, timedOut false)
...
- artifactSetSha256: ca263f88b277459d24e0c187e998352baff85cec514256c24e96a5fc609b16f6
