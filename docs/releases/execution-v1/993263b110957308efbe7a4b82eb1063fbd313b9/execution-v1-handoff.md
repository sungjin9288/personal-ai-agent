...
- reference adoption aggregate: ready, 18 scripts, ok=true, totalDuration=35.2s
...
- reference adoption aggregate: 18 scripts, ok=true
- deterministic runtime rows: 8
- visual artifact set: f8b1069e9c0ab9366364a603d58537d8f065f63736f45cbc6faa1ae8da21d0dd
