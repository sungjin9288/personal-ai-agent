...
- smoke:execution-cli: 582ms elapsed, stdout 324B, stderr 0B, timeout 20.0m
...
- smoke:execution-v1-handoff: 1.9s elapsed, stdout 415B, stderr 0B, timeout 20.0m
...
- scripts/smoke-fact-graph-memory.mjs: passed (354ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-channel-adapter-seam.mjs: passed (451ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-context-records.mjs: passed (621ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-audit-surface.mjs: passed (466ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-audit-surface.mjs: passed (514ms, timeout 5.0m, timedOut false)
- scripts/smoke-permission-decision-records.mjs: passed (1.0s, timeout 5.0m, timedOut false)
- scripts/smoke-sandbox-decision-timelines.mjs: passed (605ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-learning-candidate.mjs: passed (610ms, timeout 5.0m, timedOut false)
- scripts/smoke-provider-fallback-route-decision.mjs: passed (600ms, timeout 5.0m, timedOut false)
- scripts/smoke-learning-promotion-queue.mjs: passed (1.7s, timeout 5.0m, timedOut false)
- scripts/smoke-learning-candidate-audit-surface.mjs: passed (982ms, timeout 5.0m, timedOut false)
- scripts/smoke-learning-promotion-verification-gate.mjs: passed (791ms, timeout 5.0m, timedOut false)
...
- artifactSetSha256: 6905f25c71736fb3dd44e41c21f2e1a3a11e3a9f67e80c3b5297d83f58eb222b
