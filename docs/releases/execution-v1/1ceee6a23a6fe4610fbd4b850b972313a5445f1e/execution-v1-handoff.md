...
- reference adoption aggregate: ready, 20 scripts, ok=true, totalDuration=40.5s
...
- reference adoption aggregate: 20 scripts, ok=true
- deterministic runtime rows: 8
- visual artifact set: 288d6ec5aa171f272adc4efe6ca938a66b1ae0a67edfe7bd3defb18270b620b9
