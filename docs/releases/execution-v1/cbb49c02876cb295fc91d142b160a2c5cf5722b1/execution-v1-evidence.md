...
- smoke:execution-cli: 800ms elapsed, stdout 324B, stderr 0B, timeout 20.0m
- smoke:ui-execution-console: 808ms elapsed, stdout 343B, stderr 0B, timeout 20.0m
- smoke:ui-execution-browser-e2e: 5.7m elapsed, stdout 7.1KiB, stderr 8.6KiB, timeout 20.0m
- smoke:reference-adoptions: 52.6s elapsed, stdout 5.4KiB, stderr 0B, timeout 20.0m
- smoke:execution-v1-live-helpers: 13.2s elapsed, stdout 391B, stderr 0B, timeout 20.0m
- smoke:execution-v1-handoff: 2.9s elapsed, stdout 417B, stderr 0B, timeout 20.0m
- smoke:production-readiness-gate: 237ms elapsed, stdout 2.5KiB, stderr 0B, timeout 20.0m
...
- scripts/smoke-output-compaction.mjs: passed (228ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-document-conversion.mjs: passed (698ms, timeout 5.0m, timedOut false)
- scripts/smoke-document-conversion-diagnostics.mjs: passed (563ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-openclaw-hermes-orchestration-docs.mjs: passed (39ms, timeout 5.0m, timedOut false)
- scripts/smoke-channel-adapter-seam.mjs: passed (373ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-context-records.mjs: passed (523ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-audit-surface.mjs: passed (400ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-audit-surface.mjs: passed (422ms, timeout 5.0m, timedOut false)
- scripts/smoke-permission-decision-records.mjs: passed (957ms, timeout 5.0m, timedOut false)
- scripts/smoke-sandbox-decision-timelines.mjs: passed (632ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-learning-candidate.mjs: passed (532ms, timeout 5.0m, timedOut false)
- scripts/smoke-provider-fallback-route-decision.mjs: passed (584ms, timeout 5.0m, timedOut false)
- scripts/smoke-learning-promotion-queue.mjs: passed (1.5s, timeout 5.0m, timedOut false)
- scripts/smoke-learning-candidate-audit-surface.mjs: passed (822ms, timeout 5.0m, timedOut false)
- scripts/smoke-learning-promotion-verification-gate.mjs: passed (700ms, timeout 5.0m, timedOut false)
- scripts/smoke-learning-promotion-verification-stop-condition.mjs: passed (945ms, timeout 5.0m, timedOut false)
- scripts/smoke-orchestration-profiles.mjs: passed (990ms, timeout 5.0m, timedOut false)
- scripts/smoke-ui-agent-blueprints.mjs: passed (5.3s, timeout 5.0m, timedOut false)
- scripts/smoke-parallel-specialists.mjs: passed (30.5s, timeout 5.0m, timedOut false)
...
- artifactSetSha256: 77b30758ee2e84153baf1fd20c365adcd27a2ca3cb9e83c536965a20c3f8c468
