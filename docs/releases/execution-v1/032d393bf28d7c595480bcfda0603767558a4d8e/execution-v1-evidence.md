...
- archivedAt: 2026-07-15T11:56:36.493Z
- sourcePath: docs/execution-v1-evidence.md

- generatedAt: 2026-07-15T11:56:22.998Z
- branch: main
- commit: 032d393bf28d7c595480bcfda0603767558a4d8e
...
- smoke:execution-cli: 617ms elapsed, stdout 324B, stderr 0B, timeout 20.0m
- smoke:ui-execution-console: 710ms elapsed, stdout 343B, stderr 0B, timeout 20.0m
- smoke:ui-execution-browser-e2e: 6.3m elapsed, stdout 7.1KiB, stderr 8.7KiB, timeout 20.0m
- smoke:reference-adoptions: 46.6s elapsed, stdout 5.4KiB, stderr 0B, timeout 20.0m
...
- smoke:production-readiness-gate: 141ms elapsed, stdout 2.5KiB, stderr 0B, timeout 20.0m
...
- scripts/smoke-document-conversion-diagnostics.mjs: passed (542ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-fact-graph-memory.mjs: passed (315ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-identity-session-audit-surface.mjs: passed (445ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-sandbox-decision-timelines.mjs: passed (569ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-learning-candidate.mjs: passed (577ms, timeout 5.0m, timedOut false)
- scripts/smoke-provider-fallback-route-decision.mjs: passed (599ms, timeout 5.0m, timedOut false)
- scripts/smoke-learning-promotion-queue.mjs: passed (1.6s, timeout 5.0m, timedOut false)
- scripts/smoke-learning-candidate-audit-surface.mjs: passed (919ms, timeout 5.0m, timedOut false)
- scripts/smoke-learning-promotion-verification-gate.mjs: passed (779ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-process-timeout-utils.mjs: passed (874ms, timeout 5.0m, timedOut false)
...
- artifactSetSha256: dea78f1e4d98c053cb0b90b2336b436ef8afe4c80f5729d66239a257fe564f92
