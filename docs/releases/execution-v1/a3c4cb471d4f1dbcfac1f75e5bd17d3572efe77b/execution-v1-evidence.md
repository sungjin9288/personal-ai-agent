...
- smoke:execution-flow: 3.0s elapsed, stdout 420B, stderr 0B, timeout 20.0m
- smoke:execution-cli: 2.0s elapsed, stdout 324B, stderr 0B, timeout 20.0m
- smoke:ui-execution-console: 1.5s elapsed, stdout 343B, stderr 0B, timeout 20.0m
- smoke:ui-execution-browser-e2e: 9.7m elapsed, stdout 7.1KiB, stderr 8.7KiB, timeout 20.0m
...
- smoke:execution-v1-handoff: 2.5s elapsed, stdout 426B, stderr 0B, timeout 20.0m
- smoke:production-readiness-gate: 365ms elapsed, stdout 2.5KiB, stderr 0B, timeout 20.0m
...
- scripts/smoke-output-compaction.mjs: passed (503ms, timeout 5.0m, timedOut false)
- scripts/smoke-provider-capability-rate-guard.mjs: passed (163ms, timeout 5.0m, timedOut false)
- scripts/smoke-hermes-provider.mjs: passed (382ms, timeout 5.0m, timedOut false)
- scripts/smoke-mission-quality-gate.mjs: passed (702ms, timeout 5.0m, timedOut false)
- scripts/smoke-document-conversion.mjs: passed (793ms, timeout 5.0m, timedOut false)
- scripts/smoke-document-conversion-diagnostics.mjs: passed (732ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-fact-graph-memory.mjs: passed (426ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-identity-session-context-records.mjs: passed (732ms, timeout 5.0m, timedOut false)
- scripts/smoke-identity-session-audit-surface.mjs: passed (577ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-audit-surface.mjs: passed (631ms, timeout 5.0m, timedOut false)
- scripts/smoke-permission-decision-records.mjs: passed (1.3s, timeout 5.0m, timedOut false)
- scripts/smoke-sandbox-decision-timelines.mjs: passed (747ms, timeout 5.0m, timedOut false)
- scripts/smoke-gateway-event-learning-candidate.mjs: passed (840ms, timeout 5.0m, timedOut false)
- scripts/smoke-provider-fallback-route-decision.mjs: passed (821ms, timeout 5.0m, timedOut false)
...
- scripts/smoke-parallel-specialists.mjs: passed (37.2s, timeout 5.0m, timedOut false)
...
- artifactSetSha256: 1cfd971a7945ba248e1bc3e245ca861287e9ad0b20cbd09b64f76d7b0448f872
