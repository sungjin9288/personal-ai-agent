...
- generatedAt: 2026-05-07T05:20:32.576Z
- sourceBranch: codex/managed-multi-agent-v1-foundation
- sourceCommit: a4bc80cfd33476d42b538eeee86395f7644e9694
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 532
...
| `npm run smoke:identity-session-admin` | pass | 0 | 307 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 267 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 257 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 293 |
| `npm run smoke:customer-support-operations` | pass | 0 | 332 |
| `npm run smoke:support-escalation-review` | pass | 0 | 271 |
...
| `npm run smoke:observability-telemetry` | pass | 0 | 314 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 268 |
| `npm run smoke:target-observability-operations` | pass | 0 | 313 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 426 |
| `npm run smoke:target-slo-operations` | pass | 0 | 290 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 144 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 134 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 299 |
| `npm run smoke:target-retention-operations` | pass | 0 | 250 |
| `npm run smoke:target-backup-operations` | pass | 0 | 258 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 280 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1608 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 277 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 282 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 342 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 277 |
| `npm run smoke:target-provider-operations` | pass | 0 | 294 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 299 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 273 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 695 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 295 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 329 |
| `npm run smoke:runtime-isolation` | pass | 0 | 1203 |
| `npm run package:pilot-export` | pass | 0 | 310 |
| `npm run smoke:pilot-export-package` | pass | 0 | 336 |
