...
- generatedAt: 2026-05-29T05:19:04.295Z
- sourceBranch: codex/execution-v1-artifacts-d8999ec-refresh
- sourceCommit: d8999ecc86fca97bea387f5551754abb72971775
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 1550
...
| `npm run smoke:target-secret-manager` | pass | 0 | 232 |
| `npm run smoke:observability-telemetry` | pass | 0 | 189 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 202 |
| `npm run smoke:target-observability-operations` | pass | 0 | 196 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 193 |
| `npm run smoke:target-slo-operations` | pass | 0 | 189 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 223 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 215 |
...
| `npm run smoke:target-openai-provider-account` | pass | 0 | 192 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 208 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 216 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 192 |
| `npm run smoke:target-provider-operations` | pass | 0 | 205 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 198 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 215 |
