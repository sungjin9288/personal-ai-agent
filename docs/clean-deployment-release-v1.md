...
- generatedAt: 2026-05-20T01:23:38.147Z
- sourceBranch: codex/anthropic-open-blocker-stop-condition-wording
- sourceCommit: 5e6ac5a659de75fe17ce0bf2494239b34951be35
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 1117
...
| `npm run smoke:tenant-storage-admin` | pass | 0 | 204 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 196 |
| `npm run smoke:customer-support-operations` | pass | 0 | 178 |
| `npm run smoke:support-escalation-review` | pass | 0 | 265 |
| `npm run smoke:target-support-architecture` | pass | 0 | 217 |
| `npm run smoke:target-support-operations` | pass | 0 | 213 |
| `npm run smoke:secret-management` | pass | 0 | 210 |
...
| `npm run package:pilot-export` | pass | 0 | 186 |
| `npm run smoke:pilot-export-package` | pass | 0 | 203 |
