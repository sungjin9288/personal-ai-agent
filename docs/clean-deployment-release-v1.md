...
- generatedAt: 2026-07-16T12:41:44.069Z
- sourceBranch: codex/rag-local-model-qualification
- sourceCommit: 731b7740e0f1b5fc2afe00226ba174d8ccf23e36
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 5164
...
| `npm run smoke:target-support-architecture` | pass | 0 | 221 |
...
| `npm run smoke:target-observability-architecture` | pass | 0 | 237 |
...
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 157 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 222 |
| `npm run smoke:target-retention-operations` | pass | 0 | 196 |
| `npm run smoke:target-backup-operations` | pass | 0 | 256 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 191 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1450 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 182 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 173 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 211 |
...
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 750 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 254 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 208 |
| `npm run smoke:runtime-isolation` | pass | 0 | 1046 |
| `npm run package:pilot-export` | pass | 0 | 240 |
| `npm run smoke:pilot-export-package` | pass | 0 | 218 |
...
```json
{
    ...
    "verifiedCommit": "9a81e28a67fede39c3e93dfb5ae4e28ccf4017bc"
  }
```
