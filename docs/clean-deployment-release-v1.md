...
- generatedAt: 2026-05-13T14:42:45.590Z
- sourceBranch: codex/post-merge-web-production-blocker-artifact-sync
- sourceCommit: e14cb30199fbb0dc4f83f4c2a908af26ea156451
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 757
...
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 104 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 443 |
| `npm run package:pilot-export` | pass | 0 | 112 |
| `npm run smoke:pilot-export-package` | pass | 0 | 108 |
