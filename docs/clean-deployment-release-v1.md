...
- generatedAt: 2026-07-04T01:29:36.314Z
- sourceBranch: main
- sourceCommit: 74d3ecdec3f875b5f4267276c1141e7c0676b6eb
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 4724
...
| `npm run package:pilot-export` | pass | 0 | 108 |
