...
- generatedAt: 2026-07-22T10:19:50.361Z
- sourceBranch: codex/f2c25-runtime-exec-observation
- sourceCommit: d7f6b832d94247f3aba4d7dc68ec134f35d661b3
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 5779
...
| `npm run smoke:target-support-operations` | pass | 0 | 252 |
| `npm run smoke:secret-management` | pass | 0 | 361 |
...
| `npm run smoke:web-auth-rbac` | pass | 0 | 1622 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 684 |
| `npm run package:pilot-export` | pass | 0 | 172 |
| `npm run smoke:pilot-export-package` | pass | 0 | 178 |
