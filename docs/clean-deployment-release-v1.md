...
- generatedAt: 2026-05-24T15:31:53.874Z
- sourceBranch: codex/target-telemetry-gap-proof-detail
- sourceCommit: 9e88031af82be9d7c95e9a1eb49b8123b562330a
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 1401
...
| `npm run package:pilot-export` | pass | 0 | 117 |
...
```json
{
    ...
    "verifiedCommit": "9e88031af82be9d7c95e9a1eb49b8123b562330a"
  }
```
