...
- generatedAt: 2026-05-19T08:43:58.893Z
- sourceBranch: codex/target-data-lifecycle-architecture-stop-condition-wording
- sourceCommit: 4c672fa7d11e0d687bd7b9d56f7ff2a095b22b6f
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 1077
...
| `npm run smoke:target-openai-provider-account` | pass | 0 | 198 |
...
| `npm run package:pilot-export` | pass | 0 | 133 |
