...
- generatedAt: 2026-07-23T01:11:48.195Z
- sourceBranch: codex/f1-9-private-collection-item-admission
- sourceCommit: 2cad513257270b0d6000f744ab10e41e686f662f
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 5896
...
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 694 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 306 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 205 |
| `npm run smoke:runtime-isolation` | pass | 0 | 783 |
| `npm run package:pilot-export` | pass | 0 | 195 |
| `npm run smoke:pilot-export-package` | pass | 0 | 175 |
