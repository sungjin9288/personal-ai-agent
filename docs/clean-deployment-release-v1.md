...
- generatedAt: 2026-07-30T02:24:45.114Z
- sourceBranch: codex/council-concurrent-schedule-shadow
- sourceCommit: 05e5daa76c82d3204be9fbf7adac342c8bff653f
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 6382
...
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 137 |
...
| `npm run smoke:observability-telemetry` | pass | 0 | 169 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 310 |
...
| `npm run smoke:target-provider-operations` | pass | 0 | 129 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 111 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 157 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 394 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 148 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 151 |
| `npm run smoke:runtime-isolation` | pass | 0 | 628 |
| `npm run package:pilot-export` | pass | 0 | 164 |
| `npm run smoke:pilot-export-package` | pass | 0 | 160 |
