...
- generatedAt: 2026-05-20T02:48:39.759Z
- sourceBranch: codex/local-provider-blocker-stop-condition-wording
- sourceCommit: 01cbee8d1f315c030b87f4dc84eebeccac5d5630
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 1125
...
| `npm run smoke:target-identity-session-operations` | pass | 0 | 220 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 212 |
...
| `npm run smoke:target-support-operations` | pass | 0 | 217 |
| `npm run smoke:secret-management` | pass | 0 | 228 |
| `npm run smoke:target-secret-manager` | pass | 0 | 377 |
| `npm run smoke:observability-telemetry` | pass | 0 | 252 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 245 |
| `npm run smoke:target-observability-operations` | pass | 0 | 251 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 246 |
...
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 284 |
| `npm run smoke:target-retention-operations` | pass | 0 | 316 |
| `npm run smoke:target-backup-operations` | pass | 0 | 295 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 246 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1525 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 237 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 247 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 238 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 251 |
| `npm run smoke:target-provider-operations` | pass | 0 | 247 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 264 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 340 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 744 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 317 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 332 |
| `npm run smoke:runtime-isolation` | pass | 0 | 1225 |
| `npm run package:pilot-export` | pass | 0 | 304 |
