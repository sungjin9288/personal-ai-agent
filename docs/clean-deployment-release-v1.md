...
- generatedAt: 2026-08-03T02:27:11.942Z
- sourceBranch: codex/council-retry-terminality-shadow
- sourceCommit: 1faabcec7a447600a00123ede010194c1242e9cd
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 6418
...
| `npm run smoke:identity-session-admin` | pass | 0 | 223 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 148 |
...
| `npm run smoke:pilot-export-package` | pass | 0 | 234 |
