...
- generatedAt: 2026-05-12T05:18:31.016Z
- sourceBranch: codex/post-merge-target-deployment-artifact-sync
- sourceCommit: d8d7bc6c35a81f9aef278dec391766d97f19d1bf
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 641
...
| `npm run smoke:identity-session-admin` | pass | 0 | 265 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 291 |
...
| `npm run smoke:support-escalation-review` | pass | 0 | 139 |
...
| `npm run smoke:target-observability-operations` | pass | 0 | 136 |
...
| `npm run smoke:web-auth-rbac` | pass | 0 | 1393 |
