...
- generatedAt: 2026-07-27T05:06:17.218Z
- sourceBranch: codex/council-reviewer-parity
- sourceCommit: f2afd998febbf8edfccc9a1baa396129b33a25a8
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 6102
...
| `npm run smoke:identity-session-admin` | pass | 0 | 150 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 135 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 187 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 157 |
| `npm run smoke:customer-support-operations` | pass | 0 | 142 |
| `npm run smoke:support-escalation-review` | pass | 0 | 135 |
...
| `npm run smoke:web-auth-rbac` | pass | 0 | 1380 |
...
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 408 |
...
| `npm run package:pilot-export` | pass | 0 | 172 |
