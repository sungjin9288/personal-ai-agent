...
- generatedAt: 2026-05-24T05:45:39.770Z
- sourceBranch: codex/hosted-tenant-gap-proof-detail
- sourceCommit: e3814b23828f169bc153045221f97ceb2a3e2541
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 1369
...
| `npm run smoke:customer-support-operations` | pass | 0 | 155 |
| `npm run smoke:support-escalation-review` | pass | 0 | 145 |
| `npm run smoke:target-support-architecture` | pass | 0 | 165 |
| `npm run smoke:target-support-operations` | pass | 0 | 199 |
| `npm run smoke:secret-management` | pass | 0 | 344 |
| `npm run smoke:target-secret-manager` | pass | 0 | 277 |
| `npm run smoke:observability-telemetry` | pass | 0 | 162 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 172 |
| `npm run smoke:target-observability-operations` | pass | 0 | 206 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 171 |
...
| `npm run smoke:retention-delete-policy` | pass | 0 | 163 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1373 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 153 |
...
| `npm run package:pilot-export` | pass | 0 | 197 |
| `npm run smoke:pilot-export-package` | pass | 0 | 188 |
