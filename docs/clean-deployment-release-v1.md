...
- generatedAt: 2026-05-18T02:07:14.779Z
- sourceBranch: codex/production-target-local-provider-stop-condition
- sourceCommit: 9896bd51161dd7ba83d1cb0eabd1a1f8a272f78d
...
| `npm run smoke:identity-session-admin` | pass | 0 | 157 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 159 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 159 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 162 |
...
| `npm run smoke:target-slo-architecture` | pass | 0 | 144 |
...
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 617 |
...
| `npm run package:pilot-export` | pass | 0 | 157 |
