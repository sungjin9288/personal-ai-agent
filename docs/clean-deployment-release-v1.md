...
- generatedAt: 2026-07-17T00:30:29.155Z
- sourceBranch: codex/local-user-learning-operator-surface
- sourceCommit: be60478735cde68a189b5b0df650008bdd25ff55
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 5404
...
| `npm run package:pilot-export` | pass | 0 | 146 |
