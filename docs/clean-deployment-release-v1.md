...
- generatedAt: 2026-08-06T02:08:04.330Z
- sourceBranch: codex/council-deterministic-ci-gate
- sourceCommit: d18cfde08c526d0f09b236986a0edfe2c953541d
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 6486
...
| `npm run package:pilot-export` | pass | 0 | 175 |
