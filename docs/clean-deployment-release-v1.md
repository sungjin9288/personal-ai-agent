...
- generatedAt: 2026-07-15T17:44:54.877Z
- sourceBranch: codex/d4-4c-action-maintenance
- sourceCommit: adb64fd8ae6f6e06c163f8e61dd7cc0b31c48dfb
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 5049
...
| `npm run package:pilot-export` | pass | 0 | 122 |
| `npm run smoke:pilot-export-package` | pass | 0 | 111 |
