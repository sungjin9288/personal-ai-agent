...
- generatedAt: 2026-07-15T11:56:43.093Z
- sourceBranch: main
- sourceCommit: 032d393bf28d7c595480bcfda0603767558a4d8e
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 5004
...
| `npm run package:pilot-export` | pass | 0 | 113 |
| `npm run smoke:pilot-export-package` | pass | 0 | 103 |
