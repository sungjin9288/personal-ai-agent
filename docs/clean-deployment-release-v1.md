...
- generatedAt: 2026-05-12T15:09:21.059Z
- sourceBranch: codex/target-blocker-closure-verification-matrix
- sourceCommit: 2e2668e95398e3b4f213a093b82c066294ac6d2f
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 693
...
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 294 |
...
| `npm run smoke:pilot-export-package` | pass | 0 | 140 |
