...
- generatedAt: 2026-05-19T06:24:01.305Z
- sourceBranch: codex/target-support-architecture-stop-condition-wording
- sourceCommit: 2d0576c9bbb184652d41e9f53b2b435d3c4ae9dc
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 1057
...
| `npm run smoke:observability-telemetry` | pass | 0 | 225 |
...
| `npm run smoke:target-retention-operations` | pass | 0 | 148 |
...
| `npm run package:pilot-export` | pass | 0 | 153 |
| `npm run smoke:pilot-export-package` | pass | 0 | 159 |
