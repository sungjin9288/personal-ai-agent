...
- generatedAt: 2026-05-24T02:42:07.859Z
- sourceBranch: codex/main-staffed-on-call-gap-artifact-sync
- sourceCommit: 4e10759e82c9e3fa51947eab181a2a9a239ede82
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 1341
...
| `npm run smoke:tenant-storage-admin` | pass | 0 | 317 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 287 |
| `npm run smoke:customer-support-operations` | pass | 0 | 256 |
| `npm run smoke:support-escalation-review` | pass | 0 | 279 |
...
| `npm run smoke:target-slo-operations` | pass | 0 | 184 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 187 |
...
| `npm run smoke:retention-delete-policy` | pass | 0 | 182 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1441 |
...
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 467 |
...
| `npm run smoke:pilot-export-package` | pass | 0 | 280 |
