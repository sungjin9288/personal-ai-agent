...
- generatedAt: 2026-07-16T12:00:55.612Z
- sourceBranch: codex/rag-local-semantic-runtime
- sourceCommit: 9a81e28a67fede39c3e93dfb5ae4e28ccf4017bc
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 5151
...
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 86 |
| `npm run smoke:customer-support-operations` | pass | 0 | 86 |
| `npm run smoke:support-escalation-review` | pass | 0 | 86 |
| `npm run smoke:target-support-architecture` | pass | 0 | 85 |
| `npm run smoke:target-support-operations` | pass | 0 | 87 |
| `npm run smoke:secret-management` | pass | 0 | 85 |
| `npm run smoke:target-secret-manager` | pass | 0 | 86 |
| `npm run smoke:observability-telemetry` | pass | 0 | 86 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 86 |
| `npm run smoke:target-observability-operations` | pass | 0 | 85 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 86 |
| `npm run smoke:target-slo-operations` | pass | 0 | 86 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 86 |
...
| `npm run smoke:target-backup-operations` | pass | 0 | 86 |
...
| `npm run package:pilot-export` | pass | 0 | 96 |
