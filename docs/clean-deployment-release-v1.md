...
- generatedAt: 2026-05-22T01:14:30.146Z
- sourceBranch: codex/provider-architecture-stop-reason-proof-detail
- sourceCommit: 3d620ae68dfad721f14a63a50ce41ef3d0fc0f12
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 1221
...
| `npm run smoke:support-escalation-review` | pass | 0 | 151 |
...
| `npm run smoke:target-observability-architecture` | pass | 0 | 184 |
| `npm run smoke:target-observability-operations` | pass | 0 | 236 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 216 |
| `npm run smoke:target-slo-operations` | pass | 0 | 148 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 142 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 145 |
...
| `npm run smoke:web-auth-rbac` | pass | 0 | 1617 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 148 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 180 |
...
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 231 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 421 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 213 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 156 |
| `npm run smoke:runtime-isolation` | pass | 0 | 590 |
| `npm run package:pilot-export` | pass | 0 | 152 |
| `npm run smoke:pilot-export-package` | pass | 0 | 150 |
