...
- generatedAt: 2026-05-22T16:04:16.982Z
- sourceBranch: codex/main-tenant-isolation-artifact-sync
- sourceCommit: 26be70af480026fe54f4d788de3b0f21199992b0
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 1301
...
| `npm run smoke:tenant-storage-admin` | pass | 0 | 166 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 178 |
| `npm run smoke:customer-support-operations` | pass | 0 | 166 |
...
| `npm run smoke:target-retention-operations` | pass | 0 | 179 |
...
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 583 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 284 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 264 |
