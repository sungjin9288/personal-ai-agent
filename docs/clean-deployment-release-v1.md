...
- generatedAt: 2026-05-22T01:04:48.165Z
- sourceBranch: codex/anthropic-provider-account-action-proof-detail
- sourceCommit: cab6d6e51af20abb6f28eb19e295eb5b1d4ba678
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 1217
...
| `npm run smoke:tenant-storage-admin` | pass | 0 | 219 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 214 |
| `npm run smoke:customer-support-operations` | pass | 0 | 200 |
| `npm run smoke:support-escalation-review` | pass | 0 | 193 |
| `npm run smoke:target-support-architecture` | pass | 0 | 221 |
| `npm run smoke:target-support-operations` | pass | 0 | 184 |
...
| `npm run smoke:target-slo-architecture` | pass | 0 | 202 |
| `npm run smoke:target-slo-operations` | pass | 0 | 213 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 279 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 309 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 274 |
| `npm run smoke:target-retention-operations` | pass | 0 | 198 |
| `npm run smoke:target-backup-operations` | pass | 0 | 237 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 210 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1503 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 149 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 153 |
...
| `npm run smoke:target-deployment-contract` | pass | 0 | 216 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 170 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 397 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 168 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 182 |
| `npm run smoke:runtime-isolation` | pass | 0 | 543 |
| `npm run package:pilot-export` | pass | 0 | 143 |
| `npm run smoke:pilot-export-package` | pass | 0 | 142 |
