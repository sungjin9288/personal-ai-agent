...
- generatedAt: 2026-08-03T03:50:42.639Z
- sourceBranch: codex/portfolio-package-refresh
- sourceCommit: 5c28b488d10798270f20f6bbedc4ca371aa8e381
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 6426
...
| `npm run smoke:target-identity-session-operations` | pass | 0 | 121 |
...
| `npm run smoke:target-observability-operations` | pass | 0 | 118 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 687 |
| `npm run package:pilot-export` | pass | 0 | 173 |
| `npm run smoke:pilot-export-package` | pass | 0 | 133 |
