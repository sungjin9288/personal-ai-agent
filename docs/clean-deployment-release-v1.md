...
- generatedAt: 2026-05-31T16:55:01.710Z
- sourceBranch: codex/execution-v1-artifacts-26d17e4-refresh
- sourceCommit: 26d17e4ee9b4acf8e6463991e830f8c7f946be3a
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 1574
...
| `npm run smoke:customer-support-operations` | pass | 0 | 202 |
...
| `npm run smoke:target-slo-architecture` | pass | 0 | 159 |
...
| `npm run smoke:web-auth-rbac` | pass | 0 | 1345 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 205 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 234 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 224 |
