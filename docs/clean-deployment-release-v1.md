...
- generatedAt: 2026-05-20T18:08:56.871Z
- sourceBranch: codex/post-tenant-isolation-artifact-sync
- sourceCommit: b1c433c4ad45e32861abc9164ab49a4c5a129534
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 1173
...
| `npm run smoke:web-auth-rbac` | pass | 0 | 1263 |
...
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 245 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 101 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 103 |
| `npm run smoke:runtime-isolation` | pass | 0 | 387 |
| `npm run package:pilot-export` | pass | 0 | 101 |
| `npm run smoke:pilot-export-package` | pass | 0 | 94 |
