...
- generatedAt: 2026-07-28T04:53:13.681Z
- sourceBranch: codex/council-local-provider-shadow
- sourceCommit: ab0e7d1ba58231eaff6b555dd98d12b863cbd280
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 6199
...
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 403 |
...
| `npm run package:pilot-export` | pass | 0 | 207 |
| `npm run smoke:pilot-export-package` | pass | 0 | 131 |
