...
- generatedAt: 2026-07-30T00:09:24.546Z
- sourceBranch: codex/council-blueprint-preview
- sourceCommit: 49586b6179382f005bedecfb578f792707e4fcad
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 6366
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 161 |
...
| `npm run smoke:target-slo-operations` | pass | 0 | 237 |
...
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 296 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 704 |
| `npm run package:pilot-export` | pass | 0 | 285 |
