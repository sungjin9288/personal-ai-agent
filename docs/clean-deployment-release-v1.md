...
- generatedAt: 2026-05-22T05:37:46.972Z
- sourceBranch: codex/target-provider-evidence-intake-proof-fields
- sourceCommit: 25e64522cc6374d211a4293dd6b1db1025d4b982
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 1253
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 216 |
...
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 222 |
...
| `npm run smoke:retention-delete-policy` | pass | 0 | 201 |
...
| `npm run smoke:target-deployment-contract` | pass | 0 | 215 |
...
| `npm run smoke:backup-restore-drill` | pass | 0 | 198 |
| `npm run smoke:runtime-isolation` | pass | 0 | 694 |
| `npm run package:pilot-export` | pass | 0 | 194 |
| `npm run smoke:pilot-export-package` | pass | 0 | 186 |
