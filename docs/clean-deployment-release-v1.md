...
- generatedAt: 2026-07-13T21:41:01.873Z
- sourceBranch: main
- sourceCommit: dddc0a1bf196ac63016a007d469a2e44154bbdc8
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 4830
...
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 88 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 430 |
| `npm run package:pilot-export` | pass | 0 | 100 |
