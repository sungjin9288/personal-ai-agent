...
- generatedAt: 2026-05-23T15:36:22.096Z
- sourceBranch: codex/main-provider-secret-injection-artifact-sync
- sourceCommit: e24f08314e918f5d1fd9933f0179d81bb49d1000
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 1317
...
| `npm run smoke:pilot-export-package` | pass | 0 | 137 |
