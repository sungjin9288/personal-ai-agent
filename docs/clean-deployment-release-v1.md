...
- generatedAt: 2026-08-11T03:18:29.224Z
- sourceBranch: codex/second-workflow-deterministic-rehearsal
- sourceCommit: 6b313657d1bad1ec2cbbeb5503178506b9fc5d70
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 6554
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 205 |
| `npm run smoke:identity-session-admin` | pass | 0 | 228 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 181 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 183 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 170 |
| `npm run smoke:customer-support-operations` | pass | 0 | 241 |
| `npm run smoke:support-escalation-review` | pass | 0 | 240 |
| `npm run smoke:target-support-architecture` | pass | 0 | 219 |
| `npm run smoke:target-support-operations` | pass | 0 | 199 |
| `npm run smoke:secret-management` | pass | 0 | 215 |
| `npm run smoke:target-secret-manager` | pass | 0 | 196 |
| `npm run smoke:observability-telemetry` | pass | 0 | 201 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 191 |
| `npm run smoke:target-observability-operations` | pass | 0 | 207 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 218 |
...
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 206 |
| `npm run smoke:target-retention-operations` | pass | 0 | 247 |
| `npm run smoke:target-backup-operations` | pass | 0 | 201 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 261 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1790 |
...
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 266 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 642 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 229 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 289 |
| `npm run smoke:runtime-isolation` | pass | 0 | 1165 |
| `npm run package:pilot-export` | pass | 0 | 247 |
| `npm run smoke:pilot-export-package` | pass | 0 | 192 |
