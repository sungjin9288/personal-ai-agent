...
- generatedAt: 2026-07-15T16:35:43.726Z
- sourceBranch: codex/d4-2-execution-runtime
- sourceCommit: 361b6d626d9cba441cffe80fe7bf7ce57fef0033
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 5022
...
| `npm run smoke:target-retention-operations` | pass | 0 | 137 |
...
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 490 |
