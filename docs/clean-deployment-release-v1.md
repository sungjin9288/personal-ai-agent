...
- generatedAt: 2026-05-24T17:48:57.216Z
- sourceBranch: codex/deployment-clean-release-boundary-proof-detail
- sourceCommit: b36ac771d1b62a76800b06b2e8210f5952384c0c
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 1425
...
| `npm run smoke:runtime-isolation` | pass | 0 | 411 |
| `npm run package:pilot-export` | pass | 0 | 109 |
| `npm run smoke:pilot-export-package` | pass | 0 | 102 |
