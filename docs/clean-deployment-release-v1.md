...
- generatedAt: 2026-07-23T08:52:14.920Z
- sourceBranch: codex/f1-14-private-item-artifact-request
- sourceCommit: d538aff4da5ea9250b1a7c761f3318c88bd32ce3
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 5945
...
| `npm run smoke:web-auth-rbac` | pass | 0 | 1436 |
...
| `npm run package:pilot-export` | pass | 0 | 178 |
