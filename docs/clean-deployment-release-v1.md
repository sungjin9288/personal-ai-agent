...
- generatedAt: 2026-07-28T03:06:08.229Z
- sourceBranch: codex/claim-source-attribution-shadow
- sourceCommit: ef605608eebf5b61a55068908ca0d6457356d800
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 6175
...
| `npm run smoke:web-auth-rbac` | pass | 0 | 1288 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 527 |
| `npm run package:pilot-export` | pass | 0 | 136 |
