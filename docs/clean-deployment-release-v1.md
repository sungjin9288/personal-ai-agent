...
- generatedAt: 2026-08-03T01:12:01.099Z
- sourceBranch: codex/council-retry-lineage-shadow
- sourceCommit: 3df195e12f2f7089e05ad73b9368f0f8f71df0b7
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 6406
...
| `npm run smoke:target-slo-architecture` | pass | 0 | 255 |
...
| `npm run smoke:target-backup-operations` | pass | 0 | 222 |
...
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 232 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 766 |
| `npm run package:pilot-export` | pass | 0 | 211 |
