...
- generatedAt: 2026-07-22T03:02:45.940Z
- sourceBranch: codex/f2c20-mlx-launch-contract
- sourceCommit: 3b77191e08ade5b82615406e64994611581dc72c
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 5717
...
| `npm run smoke:target-support-operations` | pass | 0 | 203 |
| `npm run smoke:secret-management` | pass | 0 | 173 |
| `npm run smoke:target-secret-manager` | pass | 0 | 223 |
...
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 211 |
| `npm run smoke:target-retention-operations` | pass | 0 | 156 |
| `npm run smoke:target-backup-operations` | pass | 0 | 179 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 347 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1580 |
...
| `npm run smoke:target-deployment-contract` | pass | 0 | 127 |
...
| `npm run package:pilot-export` | pass | 0 | 212 |
| `npm run smoke:pilot-export-package` | pass | 0 | 138 |
