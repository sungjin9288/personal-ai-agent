...
- generatedAt: 2026-05-22T02:03:56.525Z
- sourceBranch: codex/target-provider-operations-proof-detail
- sourceCommit: ef49fa8c327b04e12dea7255ded04fc0523a6a32
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 1233
...
| `npm run smoke:target-identity-session-operations` | pass | 0 | 205 |
...
| `npm run smoke:target-support-architecture` | pass | 0 | 189 |
| `npm run smoke:target-support-operations` | pass | 0 | 169 |
| `npm run smoke:secret-management` | pass | 0 | 183 |
| `npm run smoke:target-secret-manager` | pass | 0 | 229 |
...
| `npm run smoke:target-backup-operations` | pass | 0 | 166 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 167 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1382 |
...
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 387 |
...
| `npm run smoke:pilot-export-package` | pass | 0 | 189 |
