...
- generatedAt: 2026-07-29T05:42:36.722Z
- sourceBranch: codex/council-rebuttal-stability-chair-reachability-shadow
- sourceCommit: f60887df38cefeb7e9aa19d47fdb8823211e2eca
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 6296
...
| `npm run smoke:target-slo-architecture` | pass | 0 | 134 |
...
| `npm run smoke:target-provider-operations` | pass | 0 | 238 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 218 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 157 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 409 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 148 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 152 |
| `npm run smoke:runtime-isolation` | pass | 0 | 676 |
| `npm run package:pilot-export` | pass | 0 | 177 |
| `npm run smoke:pilot-export-package` | pass | 0 | 153 |
