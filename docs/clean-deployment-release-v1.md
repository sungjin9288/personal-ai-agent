...
- generatedAt: 2026-07-27T06:59:04.067Z
- sourceBranch: codex/council-closeout
- sourceCommit: ac031bd0dccca1faa5dd2d6baf589a191e0d8d4a
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 6111
...
| `npm run smoke:runtime-isolation` | pass | 0 | 709 |
| `npm run package:pilot-export` | pass | 0 | 179 |
| `npm run smoke:pilot-export-package` | pass | 0 | 139 |
