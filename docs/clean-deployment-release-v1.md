...
- generatedAt: 2026-07-27T00:43:16.862Z
- sourceBranch: codex/council-contract-stub-runtime
- sourceCommit: ccf76cf7a5220eb821cf9aeb57a772229767e3ef
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 6078
...
| `npm run smoke:target-slo-operations` | pass | 0 | 112 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 625 |
| `npm run package:pilot-export` | pass | 0 | 165 |
| `npm run smoke:pilot-export-package` | pass | 0 | 128 |
