...
- generatedAt: 2026-05-25T14:10:48.869Z
- sourceBranch: codex/provider-boundary-proof-detail
- sourceCommit: ff47e62ee655d8c1c961cbbf02f56b7cf0f65fb0
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 1433
...
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 263 |
...
| `npm run package:pilot-export` | pass | 0 | 110 |
| `npm run smoke:pilot-export-package` | pass | 0 | 106 |
