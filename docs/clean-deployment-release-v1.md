...
- generatedAt: 2026-05-12T04:35:12.904Z
- sourceBranch: codex/target-environment-evidence-template
- sourceCommit: 966aa6a7f1c992ffd84053bdd287c62d269936a0
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 629
...
| `npm run smoke:target-slo-architecture` | pass | 0 | 155 |
...
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 291 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 121 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 127 |
| `npm run smoke:runtime-isolation` | pass | 0 | 450 |
| `npm run package:pilot-export` | pass | 0 | 112 |
| `npm run smoke:pilot-export-package` | pass | 0 | 109 |
...
```json
{
    ...
    "verifiedCommit": "966aa6a7f1c992ffd84053bdd287c62d269936a0"
  }
```
