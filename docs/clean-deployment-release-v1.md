...
- generatedAt: 2026-07-22T17:23:25.128Z
- sourceBranch: codex/f1-3-reviewed-data-intake-request
- sourceCommit: b9ad8fd8d4926bb08d9116fab03f0405b9e1083c
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 5841
...
| `npm run smoke:runtime-isolation` | pass | 0 | 630 |
| `npm run package:pilot-export` | pass | 0 | 169 |
