...
- generatedAt: 2026-07-15T06:20:48.092Z
- sourceBranch: main
- sourceCommit: bc6b48fdaa808803eba9230c6d157e0d32566e2a
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 4930
...
| `npm run smoke:customer-support-operations` | pass | 0 | 135 |
...
| `npm run package:pilot-export` | pass | 0 | 183 |
