...
- generatedAt: 2026-07-24T08:32:29.706Z
- sourceBranch: codex/f1-23-private-answer-quality-readiness-impact
- sourceCommit: 4bc89b572b40f2af0c30ed4671baf9f0b37a334c
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 6043
...
| `npm run package:pilot-export` | pass | 0 | 135 |
| `npm run smoke:pilot-export-package` | pass | 0 | 104 |
...
```json
{
    ...
    "verifiedCommit": "4bc89b572b40f2af0c30ed4671baf9f0b37a334c"
  }
```
