...
- generatedAt: 2026-07-16T09:06:47.523Z
- sourceBranch: codex/rag-semantic-retrieval-experiment
- sourceCommit: 4b4849e45be00bd4c2ec352dd81311a20e845385
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 5101
...
| `npm run smoke:runtime-isolation` | pass | 0 | 573 |
| `npm run package:pilot-export` | pass | 0 | 129 |
