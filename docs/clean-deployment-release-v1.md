...
- generatedAt: 2026-07-16T09:40:36.559Z
- sourceBranch: codex/rag-deterministic-reranking
- sourceCommit: 390775e0bd94cb7d7a78c5bfa74f8c79d7ee4ac5
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 5109
...
| `npm run smoke:runtime-isolation` | pass | 0 | 652 |
