...
- generatedAt: 2026-05-22T15:51:43.365Z
- sourceBranch: codex/target-tenant-isolation-ui-proof-detail
- sourceCommit: 272446400dbb6d83d84a483a35f57c00440489fb
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 1297
...
| `npm run smoke:support-escalation-review` | pass | 0 | 160 |
...
| `npm run smoke:target-retention-operations` | pass | 0 | 151 |
...
| `npm run package:pilot-export` | pass | 0 | 161 |
| `npm run smoke:pilot-export-package` | pass | 0 | 152 |
