...
- generatedAt: 2026-07-22T08:07:26.735Z
- sourceBranch: codex/f2c24-training-os-isolation
- sourceCommit: 2bdd5521f8c4992bcc5172f61db19c088bba7d65
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 5766
...
| `npm run smoke:pilot-export-package` | pass | 0 | 114 |
