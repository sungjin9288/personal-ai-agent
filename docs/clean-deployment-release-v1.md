...
- generatedAt: 2026-05-24T01:40:36.804Z
- sourceBranch: codex/observability-slo-ui-proof-detail
- sourceCommit: 1970c1bf8cebcea08e5deb39139b58d03e43fa46
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 1329
...
| `npm run smoke:target-support-architecture` | pass | 0 | 162 |
| `npm run smoke:target-support-operations` | pass | 0 | 160 |
| `npm run smoke:secret-management` | pass | 0 | 159 |
...
| `npm run smoke:target-slo-architecture` | pass | 0 | 158 |
...
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 415 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 177 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 187 |
| `npm run smoke:runtime-isolation` | pass | 0 | 651 |
| `npm run package:pilot-export` | pass | 0 | 174 |
| `npm run smoke:pilot-export-package` | pass | 0 | 170 |
