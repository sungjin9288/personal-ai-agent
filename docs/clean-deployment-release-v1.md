...
- generatedAt: 2026-05-19T12:45:02.624Z
- sourceBranch: codex/target-openai-provider-account-stop-condition-wording
- sourceCommit: 6e22ee7b5c2531f530caf51b825b7d9fb33ad97c
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 1089
...
| `npm run package:pilot-export` | pass | 0 | 101 |
| `npm run smoke:pilot-export-package` | pass | 0 | 99 |
