...
- generatedAt: 2026-05-20T03:20:22.775Z
- sourceBranch: codex/hermes-current-blocker-stop-condition-wording
- sourceCommit: 1c292acfc3676b678e8927b71cef70d04db9c02f
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 1129
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 312 |
| `npm run smoke:identity-session-admin` | pass | 0 | 351 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 339 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 324 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 342 |
| `npm run smoke:customer-support-operations` | pass | 0 | 303 |
| `npm run smoke:support-escalation-review` | pass | 0 | 348 |
| `npm run smoke:target-support-architecture` | pass | 0 | 322 |
| `npm run smoke:target-support-operations` | pass | 0 | 331 |
| `npm run smoke:secret-management` | pass | 0 | 487 |
| `npm run smoke:target-secret-manager` | pass | 0 | 438 |
| `npm run smoke:observability-telemetry` | pass | 0 | 455 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 383 |
| `npm run smoke:target-observability-operations` | pass | 0 | 354 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 351 |
| `npm run smoke:target-slo-operations` | pass | 0 | 325 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 329 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 311 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 304 |
| `npm run smoke:target-retention-operations` | pass | 0 | 325 |
| `npm run smoke:target-backup-operations` | pass | 0 | 317 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 515 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1856 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 525 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 369 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 411 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 359 |
| `npm run smoke:target-provider-operations` | pass | 0 | 357 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 378 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 359 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 960 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 392 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 377 |
| `npm run smoke:runtime-isolation` | pass | 0 | 1605 |
| `npm run package:pilot-export` | pass | 0 | 753 |
| `npm run smoke:pilot-export-package` | pass | 0 | 506 |
