...
- generatedAt: 2026-07-22T14:14:03.015Z
- sourceBranch: codex/f1-1-training-data-sufficiency
- sourceCommit: cc19deb60f3d6f948f5be7b1991df532298be922
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 5813
...
| `npm run smoke:runtime-isolation` | pass | 0 | 643 |
| `npm run package:pilot-export` | pass | 0 | 166 |
