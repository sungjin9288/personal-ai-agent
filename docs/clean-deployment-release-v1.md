...
- generatedAt: 2026-07-29T12:24:10.088Z
- sourceBranch: codex/local-v1-completion-closeout
- sourceCommit: bb67e79641f737656e2b62f9256fc7002c584e40
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 6347
...
| `npm run package:pilot-export` | pass | 0 | 156 |
...
```json
{
    ...
    "verifiedCommit": "bb67e79641f737656e2b62f9256fc7002c584e40"
  }
```
