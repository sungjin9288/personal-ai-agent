...
- generatedAt: 2026-07-22T12:46:22.164Z
- sourceBranch: codex/f2c27-darwin-suspended-exec
- sourceCommit: d37e0df71c4114b07141df5a634b59c3080ed81d
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 5806
...
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 349 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 136 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 142 |
| `npm run smoke:runtime-isolation` | pass | 0 | 614 |
| `npm run package:pilot-export` | pass | 0 | 171 |
| `npm run smoke:pilot-export-package` | pass | 0 | 121 |
