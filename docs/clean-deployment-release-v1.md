...
- generatedAt: 2026-05-13T04:56:16.404Z
- sourceBranch: codex/post-merge-fallback-policy-help-artifact-sync
- sourceCommit: 5b0ea8d8a1132476dc85256a99647e494445bda4
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 737
...
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 172 |
...
| `npm run smoke:pilot-export-package` | pass | 0 | 144 |
