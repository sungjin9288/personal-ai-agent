...
- generatedAt: 2026-07-17T04:41:42.679Z
- sourceBranch: codex/q5-answer-input-boundary
- sourceCommit: 2fec5abfdf96229279aad83b9684edbb67c51b47
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 5499
...
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 297 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 102 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 106 |
| `npm run smoke:runtime-isolation` | pass | 0 | 493 |
| `npm run package:pilot-export` | pass | 0 | 131 |
