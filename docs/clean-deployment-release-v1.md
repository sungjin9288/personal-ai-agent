...
- generatedAt: 2026-08-02T23:55:04.225Z
- sourceBranch: codex/council-concurrent-envelope-shadow
- sourceCommit: 7099a44f5459e2af91ab7f6062bea5e6317e368b
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 6394
...
| `npm run smoke:target-openai-provider-account` | pass | 0 | 147 |
...
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 528 |
