...
- generatedAt: 2026-07-24T05:58:18.355Z
- sourceBranch: codex/f1-21-private-reviewed-example-canonicalization
- sourceCommit: 77f39a136111567bd0708a49ba75c58e7dbe6eec
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 6024
...
| `npm run smoke:observability-telemetry` | pass | 0 | 106 |
...
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 98 |
...
| `npm run package:pilot-export` | pass | 0 | 142 |
| `npm run smoke:pilot-export-package` | pass | 0 | 112 |
