...
- generatedAt: 2026-07-22T23:48:15.792Z
- sourceBranch: codex/f1-8-private-collection-workspace
- sourceCommit: 30d8022d013dfe38094c2c3292c05fd5bc4bfb18
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 5887
...
| `npm run smoke:support-escalation-review` | pass | 0 | 127 |
...
| `npm run smoke:target-observability-operations` | pass | 0 | 124 |
...
| `npm run smoke:web-auth-rbac` | pass | 0 | 1333 |
...
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 473 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 151 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 149 |
| `npm run smoke:runtime-isolation` | pass | 0 | 1169 |
| `npm run package:pilot-export` | pass | 0 | 222 |
