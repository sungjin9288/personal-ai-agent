...
- generatedAt: 2026-05-24T14:58:31.191Z
- sourceBranch: codex/support-operations-gap-proof-detail
- sourceCommit: fe1ea0fc4a153692e4a68ced67843a3976196380
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 1393
...
| `npm run smoke:target-backup-operations` | pass | 0 | 144 |
...
| `npm run package:pilot-export` | pass | 0 | 158 |
