...
- generatedAt: 2026-07-29T02:10:37.510Z
- sourceBranch: codex/docs-evidence-freshness-closure
- sourceCommit: d146be320d0a674930baf7613da082e8c091733f
- releaseLabel: provider-scoped pilot ready for OpenAI-backed local-first path
- cleanCheckoutMode: tracked-files-only
- cleanCheckoutFileCount: 6262
...
| `npm run smoke:target-deployment-contract` | pass | 0 | 138 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 609 |
| `npm run package:pilot-export` | pass | 0 | 154 |
