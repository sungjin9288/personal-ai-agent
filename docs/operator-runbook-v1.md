...
- missing-env provider rows include `stopConditionId`, `targetStopConditionId`, `stopReason`, `requiredClosingEvidence`, and `evidenceCommand` for the target blocker closure workflow
