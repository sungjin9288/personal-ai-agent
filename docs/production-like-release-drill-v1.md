...
- generatedAt: 2026-07-28T00:20:39.053Z
- branch: codex/evidence-gated-answer-robustness
- verifiedCommit: 6c869d84c01034527440e735f87160c8199c02ae
...
| `npm run smoke:target-identity-session-operations` | pass | 0 | 112 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 109 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 109 |
...
| `npm run smoke:target-support-architecture` | pass | 0 | 110 |
...
| `npm run smoke:target-observability-architecture` | pass | 0 | 127 |
| `npm run smoke:target-observability-operations` | pass | 0 | 115 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 110 |
...
| `npm run smoke:web-auth-rbac` | pass | 0 | 1331 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 108 |
...
| `npm run smoke:clean-deployment-release` | pass | 0 | 115 |
| `npm run smoke:execution-v1-status` | pass | 0 | 530 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 667 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 602 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "6c869d84c01034527440e735f87160c8199c02ae"
  }
```
