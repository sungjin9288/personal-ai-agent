...
- generatedAt: 2026-05-22T07:41:06.257Z
- branch: codex/provider-fallback-event-ui-proof-detail
- verifiedCommit: 8a0ffc72bc9bf7c5815a28efc1225e159953f754
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 293 |
| `npm run smoke:identity-session-admin` | pass | 0 | 228 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 278 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 268 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 325 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 300 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 309 |
| `npm run smoke:customer-support-operations` | pass | 0 | 257 |
| `npm run smoke:support-escalation-review` | pass | 0 | 294 |
| `npm run smoke:target-support-architecture` | pass | 0 | 282 |
| `npm run smoke:target-support-operations` | pass | 0 | 249 |
| `npm run smoke:secret-management` | pass | 0 | 267 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 304 |
| `npm run smoke:target-secret-manager` | pass | 0 | 272 |
| `npm run smoke:observability-telemetry` | pass | 0 | 318 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 254 |
| `npm run smoke:target-observability-operations` | pass | 0 | 295 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 319 |
| `npm run smoke:target-slo-operations` | pass | 0 | 304 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 242 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 295 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 267 |
| `npm run smoke:target-retention-operations` | pass | 0 | 208 |
| `npm run smoke:target-backup-operations` | pass | 0 | 197 |
| `npm run smoke:production-slo-operating` | pass | 0 | 194 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1422 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 190 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 181 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 193 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 190 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 193 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 187 |
| `npm run smoke:target-provider-operations` | pass | 0 | 185 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 191 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 188 |
| `npm run smoke:production-retention-operating` | pass | 0 | 210 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 288 |
| `npm run smoke:execution-v1-status` | pass | 0 | 564 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 303 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 220 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 201 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 481 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 199 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 212 |
| `npm run smoke:runtime-isolation` | pass | 0 | 753 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "8a0ffc72bc9bf7c5815a28efc1225e159953f754"
  }
```
