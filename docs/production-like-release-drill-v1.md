...
- generatedAt: 2026-07-27T05:06:33.678Z
- branch: codex/council-reviewer-parity
- verifiedCommit: f2afd998febbf8edfccc9a1baa396129b33a25a8
...
| `npm run smoke:target-slo-operations` | pass | 0 | 160 |
...
| `npm run smoke:target-retention-operations` | pass | 0 | 160 |
| `npm run smoke:target-backup-operations` | pass | 0 | 176 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "f2afd998febbf8edfccc9a1baa396129b33a25a8"
  }
```
