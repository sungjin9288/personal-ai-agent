...
- generatedAt: 2026-05-12T14:30:03.575Z
- branch: codex/release-readiness-blocker-disposition-surface
- verifiedCommit: d0084490316a7fb86ade2ef8bc3ea9d691400ca6
...
| `npm run smoke:target-observability-operations` | pass | 0 | 108 |
...
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 155 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "d0084490316a7fb86ade2ef8bc3ea9d691400ca6"
  }
```
