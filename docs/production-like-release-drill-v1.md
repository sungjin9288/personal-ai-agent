...
- generatedAt: 2026-07-22T19:41:28.869Z
- branch: codex/f1-6-collection-execution-request
- verifiedCommit: 3d3b19d7b528aef627f3832b490f2bf8065324c4
...
| `npm run smoke:target-slo-operations` | pass | 0 | 94 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 518 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "3d3b19d7b528aef627f3832b490f2bf8065324c4"
  }
```
