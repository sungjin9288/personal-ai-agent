...
- generatedAt: 2026-05-13T09:36:33.434Z
- branch: codex/post-merge-web-fallback-policy-artifact-sync
- verifiedCommit: c797cab244ed540f37c1f36a2903ccb75f9ea2bc
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 109 |
| `npm run smoke:identity-session-admin` | pass | 0 | 116 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 120 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 117 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 122 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 112 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 107 |
| `npm run smoke:customer-support-operations` | pass | 0 | 107 |
| `npm run smoke:support-escalation-review` | pass | 0 | 116 |
| `npm run smoke:target-support-architecture` | pass | 0 | 120 |
| `npm run smoke:target-support-operations` | pass | 0 | 113 |
| `npm run smoke:secret-management` | pass | 0 | 117 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 128 |
...
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 172 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 118 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 184 |
| `npm run smoke:target-retention-operations` | pass | 0 | 112 |
| `npm run smoke:target-backup-operations` | pass | 0 | 116 |
| `npm run smoke:production-slo-operating` | pass | 0 | 107 |
...
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 103 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 101 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 105 |
| `npm run smoke:target-provider-operations` | pass | 0 | 102 |
...
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 165 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 110 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 107 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 275 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 116 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 119 |
| `npm run smoke:runtime-isolation` | pass | 0 | 425 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "c797cab244ed540f37c1f36a2903ccb75f9ea2bc"
  }
```
