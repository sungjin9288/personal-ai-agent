...
- generatedAt: 2026-08-03T01:12:12.106Z
- branch: codex/council-retry-lineage-shadow
- verifiedCommit: 3df195e12f2f7089e05ad73b9368f0f8f71df0b7
...
| `npm run smoke:identity-session-admin` | pass | 0 | 146 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 148 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 153 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 167 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 167 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 154 |
...
| `npm run smoke:target-support-operations` | pass | 0 | 156 |
| `npm run smoke:secret-management` | pass | 0 | 188 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 157 |
| `npm run smoke:target-secret-manager` | pass | 0 | 171 |
| `npm run smoke:observability-telemetry` | pass | 0 | 146 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 144 |
| `npm run smoke:target-observability-operations` | pass | 0 | 159 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 153 |
| `npm run smoke:target-slo-operations` | pass | 0 | 172 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 185 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 170 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 185 |
| `npm run smoke:target-retention-operations` | pass | 0 | 157 |
| `npm run smoke:target-backup-operations` | pass | 0 | 168 |
| `npm run smoke:production-slo-operating` | pass | 0 | 161 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1442 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 285 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 188 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 218 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 234 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 149 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 159 |
| `npm run smoke:target-provider-operations` | pass | 0 | 180 |
...
| `npm run smoke:clean-deployment-release` | pass | 0 | 247 |
| `npm run smoke:execution-v1-status` | pass | 0 | 664 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 779 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 207 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "3df195e12f2f7089e05ad73b9368f0f8f71df0b7"
  }
```
