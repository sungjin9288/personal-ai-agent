...
- generatedAt: 2026-05-24T16:06:04.972Z
- branch: codex/staffed-on-call-slo-gap-proof-detail
- verifiedCommit: a6786b001a3272091c63d6e4dc1f815d856e1773
...
| `npm run smoke:tenant-storage-admin` | pass | 0 | 123 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 126 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 125 |
| `npm run smoke:customer-support-operations` | pass | 0 | 125 |
| `npm run smoke:support-escalation-review` | pass | 0 | 134 |
| `npm run smoke:target-support-architecture` | pass | 0 | 127 |
...
| `npm run smoke:target-observability-operations` | pass | 0 | 127 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 123 |
| `npm run smoke:target-slo-operations` | pass | 0 | 122 |
...
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 140 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 141 |
| `npm run smoke:runtime-isolation` | pass | 0 | 495 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "a6786b001a3272091c63d6e4dc1f815d856e1773"
  }
```
