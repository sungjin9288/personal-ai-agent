...
- generatedAt: 2026-07-24T07:13:08.339Z
- branch: codex/f1-22-private-dataset-reassessment-shadow
- verifiedCommit: d9e5836bca236ba12c03ee39d658fbfb6a17c4ff
...
| `npm run smoke:tenant-storage-admin` | pass | 0 | 97 |
...
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 103 |
| `npm run smoke:target-secret-manager` | pass | 0 | 103 |
| `npm run smoke:observability-telemetry` | pass | 0 | 102 |
...
| `npm run smoke:execution-v1-status` | pass | 0 | 411 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 250 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 139 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 134 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 327 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 115 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 115 |
| `npm run smoke:runtime-isolation` | pass | 0 | 540 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "d9e5836bca236ba12c03ee39d658fbfb6a17c4ff"
  }
```
