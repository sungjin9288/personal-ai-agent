...
- generatedAt: 2026-05-22T01:14:44.507Z
- branch: codex/provider-architecture-stop-reason-proof-detail
- verifiedCommit: 3d620ae68dfad721f14a63a50ce41ef3d0fc0f12
...
| `npm run smoke:customer-support-operations` | pass | 0 | 133 |
| `npm run smoke:support-escalation-review` | pass | 0 | 136 |
| `npm run smoke:target-support-architecture` | pass | 0 | 147 |
| `npm run smoke:target-support-operations` | pass | 0 | 131 |
| `npm run smoke:secret-management` | pass | 0 | 129 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 126 |
| `npm run smoke:target-secret-manager` | pass | 0 | 125 |
...
| `npm run smoke:target-slo-architecture` | pass | 0 | 129 |
| `npm run smoke:target-slo-operations` | pass | 0 | 127 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 125 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 127 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 132 |
...
| `npm run smoke:production-provider-readiness` | pass | 0 | 223 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 186 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 189 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 150 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 150 |
| `npm run smoke:target-provider-operations` | pass | 0 | 147 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 182 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 172 |
| `npm run smoke:production-retention-operating` | pass | 0 | 150 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 153 |
| `npm run smoke:execution-v1-status` | pass | 0 | 500 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 325 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 214 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 158 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 482 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 168 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 149 |
| `npm run smoke:runtime-isolation` | pass | 0 | 526 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "3d620ae68dfad721f14a63a50ce41ef3d0fc0f12"
  }
```
