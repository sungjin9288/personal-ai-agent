...
- generatedAt: 2026-07-16T18:33:29.673Z
- branch: codex/rag-cache-termination-soak
- verifiedCommit: 16380f6dbfc361e33cd9e1f67746795f9dcd2f4b
...
| `npm run smoke:identity-session-admin` | pass | 0 | 89 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 90 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 90 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 91 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 90 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 90 |
| `npm run smoke:customer-support-operations` | pass | 0 | 90 |
| `npm run smoke:support-escalation-review` | pass | 0 | 92 |
| `npm run smoke:target-support-architecture` | pass | 0 | 142 |
| `npm run smoke:target-support-operations` | pass | 0 | 92 |
| `npm run smoke:secret-management` | pass | 0 | 91 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 90 |
| `npm run smoke:target-secret-manager` | pass | 0 | 90 |
| `npm run smoke:observability-telemetry` | pass | 0 | 89 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 89 |
| `npm run smoke:target-observability-operations` | pass | 0 | 92 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 96 |
| `npm run smoke:target-slo-operations` | pass | 0 | 90 |
...
| `npm run smoke:retention-delete-policy` | pass | 0 | 98 |
...
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 217 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 109 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 102 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 296 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 107 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 110 |
| `npm run smoke:runtime-isolation` | pass | 0 | 483 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "16380f6dbfc361e33cd9e1f67746795f9dcd2f4b"
  }
```
...
```json
{
    ...
    "releaseArtifactHygieneScannedFiles": 77
  }
```
