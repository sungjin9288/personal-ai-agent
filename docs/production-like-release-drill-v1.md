...
- generatedAt: 2026-07-10T03:08:50.295Z
- branch: main
- verifiedCommit: 66c846bb08f53255ce55d6049adc9e49608775b1
...
| `npm run smoke:target-identity-session-operations` | pass | 0 | 114 |
...
| `npm run smoke:target-support-operations` | pass | 0 | 107 |
| `npm run smoke:secret-management` | pass | 0 | 110 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 115 |
...
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 562 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 136 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 112 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 340 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 130 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 125 |
| `npm run smoke:runtime-isolation` | pass | 0 | 560 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "23605160683d17f3846742b3b8be147c0086af74"
  }
```
