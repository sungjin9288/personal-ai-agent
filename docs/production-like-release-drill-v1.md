...
- generatedAt: 2026-07-28T07:43:55.732Z
- branch: codex/council-seat-contract-shadow
- verifiedCommit: 258dba820168b4b1e296525cbff10c0cc66d1180
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 212 |
| `npm run smoke:identity-session-admin` | pass | 0 | 235 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 200 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 174 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 176 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 168 |
...
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 226 |
| `npm run smoke:target-secret-manager` | pass | 0 | 208 |
| `npm run smoke:observability-telemetry` | pass | 0 | 207 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 243 |
| `npm run smoke:target-observability-operations` | pass | 0 | 237 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 213 |
| `npm run smoke:target-slo-operations` | pass | 0 | 285 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 248 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 225 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 191 |
| `npm run smoke:target-retention-operations` | pass | 0 | 180 |
| `npm run smoke:target-backup-operations` | pass | 0 | 154 |
| `npm run smoke:production-slo-operating` | pass | 0 | 174 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1614 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 174 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 151 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 167 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 207 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 172 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 171 |
| `npm run smoke:target-provider-operations` | pass | 0 | 170 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 149 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 172 |
| `npm run smoke:production-retention-operating` | pass | 0 | 180 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 191 |
| `npm run smoke:execution-v1-status` | pass | 0 | 786 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 740 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 231 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 236 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 592 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 160 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 182 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "258dba820168b4b1e296525cbff10c0cc66d1180"
  }
```
