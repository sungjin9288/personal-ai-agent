...
- generatedAt: 2026-05-13T09:27:11.513Z
- branch: codex/web-fallback-policy-run-controls
- verifiedCommit: 3fad23643178a58e7029356a45d2d5678a6a7cec
...
| `npm run smoke:clean-deployment-release` | pass | 0 | 109 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 422 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "3fad23643178a58e7029356a45d2d5678a6a7cec"
  }
```
