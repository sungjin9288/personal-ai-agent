...
- generatedAt: 2026-05-24T17:49:06.773Z
- branch: codex/deployment-clean-release-boundary-proof-detail
- verifiedCommit: b36ac771d1b62a76800b06b2e8210f5952384c0c
...
| `npm run smoke:execution-v1-status` | pass | 0 | 361 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "b36ac771d1b62a76800b06b2e8210f5952384c0c"
  }
```
