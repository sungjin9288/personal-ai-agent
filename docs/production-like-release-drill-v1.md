...
- generatedAt: 2026-07-22T18:54:47.270Z
- branch: codex/f1-5-private-collection-plan
- verifiedCommit: ef8f386f7855478312c46db39d1502e5ee767979
...
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 98 |
...
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 279 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 142 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 135 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 323 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 111 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 116 |
| `npm run smoke:runtime-isolation` | pass | 0 | 531 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "ef8f386f7855478312c46db39d1502e5ee767979"
  }
```
