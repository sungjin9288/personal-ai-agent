...
- generatedAt: 2026-05-24T15:10:47.645Z
- branch: codex/main-support-operations-gap-artifact-sync
- verifiedCommit: 089c713fea880fbc583179bcf65a8e02949e2ce3
...
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 144 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 149 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 151 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 147 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 139 |
| `npm run smoke:customer-support-operations` | pass | 0 | 157 |
| `npm run smoke:support-escalation-review` | pass | 0 | 145 |
| `npm run smoke:target-support-architecture` | pass | 0 | 139 |
| `npm run smoke:target-support-operations` | pass | 0 | 151 |
| `npm run smoke:secret-management` | pass | 0 | 147 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 143 |
| `npm run smoke:target-secret-manager` | pass | 0 | 145 |
| `npm run smoke:observability-telemetry` | pass | 0 | 150 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 149 |
| `npm run smoke:target-observability-operations` | pass | 0 | 140 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 153 |
| `npm run smoke:target-slo-operations` | pass | 0 | 145 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 145 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 146 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 151 |
...
| `npm run smoke:production-enterprise-controls` | pass | 0 | 153 |
...
| `npm run smoke:retention-delete-policy` | pass | 0 | 148 |
| `npm run smoke:production-retention-operating` | pass | 0 | 143 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 159 |
| `npm run smoke:execution-v1-status` | pass | 0 | 564 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 194 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 160 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 153 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 371 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 164 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 162 |
| `npm run smoke:runtime-isolation` | pass | 0 | 576 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "089c713fea880fbc583179bcf65a8e02949e2ce3"
  }
```
