...
- generatedAt: 2026-07-14T06:24:47.165Z
- branch: main
- verifiedCommit: 2f3100392612a0d432fdf7402786a4994b4dc26c
...
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 111 |
...
| `npm run smoke:web-auth-rbac` | pass | 0 | 1315 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "2f3100392612a0d432fdf7402786a4994b4dc26c"
  }
```
