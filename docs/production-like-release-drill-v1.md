...
- generatedAt: 2026-05-31T16:55:18.027Z
- branch: codex/execution-v1-artifacts-26d17e4-refresh
- verifiedCommit: 26d17e4ee9b4acf8e6463991e830f8c7f946be3a
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 175 |
| `npm run smoke:identity-session-admin` | pass | 0 | 242 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 164 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 172 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 158 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 172 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 171 |
| `npm run smoke:customer-support-operations` | pass | 0 | 207 |
| `npm run smoke:support-escalation-review` | pass | 0 | 194 |
| `npm run smoke:target-support-architecture` | pass | 0 | 192 |
| `npm run smoke:target-support-operations` | pass | 0 | 180 |
| `npm run smoke:secret-management` | pass | 0 | 222 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 175 |
| `npm run smoke:target-secret-manager` | pass | 0 | 164 |
| `npm run smoke:observability-telemetry` | pass | 0 | 206 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 178 |
| `npm run smoke:target-observability-operations` | pass | 0 | 178 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 175 |
| `npm run smoke:target-slo-operations` | pass | 0 | 177 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 177 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 183 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 231 |
| `npm run smoke:target-retention-operations` | pass | 0 | 181 |
| `npm run smoke:target-backup-operations` | pass | 0 | 175 |
| `npm run smoke:production-slo-operating` | pass | 0 | 185 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1391 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 207 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 191 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 157 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 174 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 164 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 180 |
| `npm run smoke:target-provider-operations` | pass | 0 | 183 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 163 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 186 |
| `npm run smoke:production-retention-operating` | pass | 0 | 208 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 180 |
| `npm run smoke:execution-v1-status` | pass | 0 | 603 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 360 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 202 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 201 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 541 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 249 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 245 |
| `npm run smoke:runtime-isolation` | pass | 0 | 680 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "26d17e4ee9b4acf8e6463991e830f8c7f946be3a"
  }
```
