...
- generatedAt: 2026-05-24T15:41:59.076Z
- branch: codex/main-target-telemetry-gap-artifact-sync
- verifiedCommit: dbe7fb923f94a72370ae89d27eb6c78da955dc3a
...
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 104 |
...
| `npm run smoke:target-support-operations` | pass | 0 | 112 |
...
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 125 |
...
| `npm run smoke:clean-deployment-release` | pass | 0 | 140 |
| `npm run smoke:execution-v1-status` | pass | 0 | 400 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 156 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 117 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 111 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 273 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 122 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 121 |
| `npm run smoke:runtime-isolation` | pass | 0 | 434 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "dbe7fb923f94a72370ae89d27eb6c78da955dc3a"
  }
```
