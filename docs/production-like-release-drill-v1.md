...
- generatedAt: 2026-05-13T00:27:27.730Z
- branch: codex/handoff-publish-status-origin-main-fallback
- verifiedCommit: 380235e9fde8a2620e5d6525748d9613f30e47d4
...
| `npm run smoke:backup-restore-drill` | pass | 0 | 180 |
| `npm run smoke:runtime-isolation` | pass | 0 | 546 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "380235e9fde8a2620e5d6525748d9613f30e47d4"
  }
```
