...
- generatedAt: 2026-07-15T08:02:35.368Z
- branch: main
- verifiedCommit: d2a19a3706a2476d285888f205afd583b156e024
...
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 94 |
...
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 93 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 93 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 95 |
| `npm run smoke:target-retention-operations` | pass | 0 | 93 |
| `npm run smoke:target-backup-operations` | pass | 0 | 94 |
| `npm run smoke:production-slo-operating` | pass | 0 | 93 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1266 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 94 |
...
| `npm run smoke:clean-deployment-release` | pass | 0 | 102 |
| `npm run smoke:execution-v1-status` | pass | 0 | 381 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 219 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 107 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 106 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 287 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 105 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 109 |
| `npm run smoke:runtime-isolation` | pass | 0 | 465 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "d2a19a3706a2476d285888f205afd583b156e024"
  }
```
