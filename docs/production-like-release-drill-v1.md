...
- generatedAt: 2026-05-20T17:58:26.897Z
- branch: codex/tenant-isolation-proof-detail
- verifiedCommit: 6f26132d203b96554377e4d60ae395a2c5682a0f
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 94 |
...
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 102 |
...
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 102 |
| `npm run smoke:target-secret-manager` | pass | 0 | 100 |
| `npm run smoke:observability-telemetry` | pass | 0 | 101 |
...
| `npm run smoke:target-deployment-contract` | pass | 0 | 102 |
...
| `npm run smoke:execution-v1-status` | pass | 0 | 365 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 132 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 109 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 107 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 267 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 111 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 115 |
| `npm run smoke:runtime-isolation` | pass | 0 | 420 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "6f26132d203b96554377e4d60ae395a2c5682a0f"
  }
```
