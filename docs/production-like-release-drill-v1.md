...
- generatedAt: 2026-07-15T07:07:54.867Z
- branch: main
- verifiedCommit: f85afad1a7ec167486d41267cdb34213b55d981b
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 90 |
| `npm run smoke:identity-session-admin` | pass | 0 | 90 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 90 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 92 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 92 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 91 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 92 |
| `npm run smoke:customer-support-operations` | pass | 0 | 91 |
| `npm run smoke:support-escalation-review` | pass | 0 | 90 |
| `npm run smoke:target-support-architecture` | pass | 0 | 92 |
| `npm run smoke:target-support-operations` | pass | 0 | 91 |
| `npm run smoke:secret-management` | pass | 0 | 93 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 96 |
| `npm run smoke:target-secret-manager` | pass | 0 | 93 |
| `npm run smoke:observability-telemetry` | pass | 0 | 93 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 102 |
| `npm run smoke:target-observability-operations` | pass | 0 | 95 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 102 |
...
| `npm run smoke:target-retention-operations` | pass | 0 | 92 |
| `npm run smoke:target-backup-operations` | pass | 0 | 93 |
| `npm run smoke:production-slo-operating` | pass | 0 | 91 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1276 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 104 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 92 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 91 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 91 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 90 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 95 |
| `npm run smoke:target-provider-operations` | pass | 0 | 103 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 94 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 91 |
| `npm run smoke:production-retention-operating` | pass | 0 | 91 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 95 |
| `npm run smoke:execution-v1-status` | pass | 0 | 385 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 213 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 102 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 97 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 272 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 103 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 107 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "f85afad1a7ec167486d41267cdb34213b55d981b"
  }
```
