...
- generatedAt: 2026-08-05T01:19:18.897Z
- branch: codex/local-v1-verification-provenance
- verifiedCommit: c69aa2cd1a5aeb76d0992d636531dbbba706a7c1
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 159 |
| `npm run smoke:identity-session-admin` | pass | 0 | 166 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 159 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 159 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 156 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 184 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 163 |
| `npm run smoke:customer-support-operations` | pass | 0 | 153 |
| `npm run smoke:support-escalation-review` | pass | 0 | 164 |
| `npm run smoke:target-support-architecture` | pass | 0 | 161 |
| `npm run smoke:target-support-operations` | pass | 0 | 154 |
| `npm run smoke:secret-management` | pass | 0 | 148 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 156 |
| `npm run smoke:target-secret-manager` | pass | 0 | 166 |
| `npm run smoke:observability-telemetry` | pass | 0 | 153 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 154 |
| `npm run smoke:target-observability-operations` | pass | 0 | 147 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 163 |
| `npm run smoke:target-slo-operations` | pass | 0 | 273 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 375 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 341 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 380 |
| `npm run smoke:target-retention-operations` | pass | 0 | 761 |
| `npm run smoke:target-backup-operations` | pass | 0 | 400 |
| `npm run smoke:production-slo-operating` | pass | 0 | 673 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 2574 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 218 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 243 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 239 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 224 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 192 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 158 |
| `npm run smoke:target-provider-operations` | pass | 0 | 151 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 166 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 184 |
| `npm run smoke:production-retention-operating` | pass | 0 | 158 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 173 |
| `npm run smoke:execution-v1-status` | pass | 0 | 607 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 707 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 220 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 199 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 505 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 176 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 173 |
| `npm run smoke:runtime-isolation` | pass | 0 | 842 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "c69aa2cd1a5aeb76d0992d636531dbbba706a7c1"
  }
```
...
```json
{
    ...
    "releaseArtifactHygieneScannedFiles": 122
  }
```
