...
- generatedAt: 2026-05-22T01:05:02.036Z
- branch: codex/anthropic-provider-account-action-proof-detail
- verifiedCommit: cab6d6e51af20abb6f28eb19e295eb5b1d4ba678
...
| `npm run smoke:target-identity-session-operations` | pass | 0 | 223 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 257 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 269 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 323 |
| `npm run smoke:customer-support-operations` | pass | 0 | 340 |
| `npm run smoke:support-escalation-review` | pass | 0 | 302 |
| `npm run smoke:target-support-architecture` | pass | 0 | 293 |
| `npm run smoke:target-support-operations` | pass | 0 | 288 |
| `npm run smoke:secret-management` | pass | 0 | 254 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 337 |
| `npm run smoke:target-secret-manager` | pass | 0 | 275 |
| `npm run smoke:observability-telemetry` | pass | 0 | 255 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 260 |
| `npm run smoke:target-observability-operations` | pass | 0 | 272 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 254 |
| `npm run smoke:target-slo-operations` | pass | 0 | 295 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 289 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 282 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 318 |
| `npm run smoke:target-retention-operations` | pass | 0 | 333 |
| `npm run smoke:target-backup-operations` | pass | 0 | 230 |
| `npm run smoke:production-slo-operating` | pass | 0 | 291 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1403 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 173 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 179 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 194 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 181 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 179 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 160 |
| `npm run smoke:target-provider-operations` | pass | 0 | 222 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 212 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 310 |
| `npm run smoke:production-retention-operating` | pass | 0 | 306 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 274 |
| `npm run smoke:execution-v1-status` | pass | 0 | 752 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 427 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 347 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 252 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 609 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 265 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 331 |
| `npm run smoke:runtime-isolation` | pass | 0 | 835 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "cab6d6e51af20abb6f28eb19e295eb5b1d4ba678"
  }
```
