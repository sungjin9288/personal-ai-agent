...
- generatedAt: 2026-07-13T18:15:28.787Z
- branch: main
- verifiedCommit: 5b1425447412461bd2f2d8bf383d5076ef3f00da
...
| `npm run smoke:identity-session-admin` | pass | 0 | 88 |
...
| `npm run smoke:production-enterprise-controls` | pass | 0 | 92 |
...
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 270 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "5b1425447412461bd2f2d8bf383d5076ef3f00da"
  }
```
