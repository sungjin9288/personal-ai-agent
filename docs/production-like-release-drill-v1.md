...
- generatedAt: 2026-07-29T05:42:45.848Z
- branch: codex/council-rebuttal-stability-chair-reachability-shadow
- verifiedCommit: f60887df38cefeb7e9aa19d47fdb8823211e2eca
...
| `npm run smoke:identity-session-admin` | pass | 0 | 139 |
...
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 127 |
...
| `npm run smoke:target-support-architecture` | pass | 0 | 134 |
...
| `npm run smoke:observability-telemetry` | pass | 0 | 138 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 154 |
| `npm run smoke:target-observability-operations` | pass | 0 | 157 |
...
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 195 |
...
| `npm run smoke:clean-deployment-release` | pass | 0 | 151 |
| `npm run smoke:execution-v1-status` | pass | 0 | 555 |
...
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 470 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 151 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 221 |
| `npm run smoke:runtime-isolation` | pass | 0 | 1138 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "f60887df38cefeb7e9aa19d47fdb8823211e2eca"
  }
```
