...
- generatedAt: 2026-08-03T04:27:28.427Z
- branch: codex/smoke-failure-diagnostics
- verifiedCommit: 42aef644264ce7a447715da08d80e28cfdd27d4c
...
| `npm run smoke:target-slo-operations` | pass | 0 | 136 |
...
| `npm run smoke:target-openai-provider-account` | pass | 0 | 130 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 129 |
...
| `npm run smoke:execution-v1-status` | pass | 0 | 532 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 583 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 161 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 152 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 369 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 159 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 132 |
| `npm run smoke:runtime-isolation` | pass | 0 | 670 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "42aef644264ce7a447715da08d80e28cfdd27d4c"
  }
```
