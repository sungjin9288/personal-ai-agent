...
- generatedAt: 2026-08-05T04:15:54.206Z
- branch: codex/execution-v1-freshness-ci-gate
- verifiedCommit: eb4fef6cbf8e1608e7d135545ddda0a96691ec2e
...
| `npm run smoke:identity-session-admin` | pass | 0 | 118 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 113 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 122 |
...
| `npm run smoke:customer-support-operations` | pass | 0 | 184 |
| `npm run smoke:support-escalation-review` | pass | 0 | 150 |
| `npm run smoke:target-support-architecture` | pass | 0 | 117 |
| `npm run smoke:target-support-operations` | pass | 0 | 169 |
...
| `npm run smoke:observability-telemetry` | pass | 0 | 115 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 124 |
...
| `npm run smoke:production-enterprise-controls` | pass | 0 | 121 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 115 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 133 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 133 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 126 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 123 |
| `npm run smoke:target-provider-operations` | pass | 0 | 124 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 131 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 118 |
| `npm run smoke:production-retention-operating` | pass | 0 | 115 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 170 |
| `npm run smoke:execution-v1-status` | pass | 0 | 557 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 639 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 194 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 160 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 381 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 125 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 240 |
| `npm run smoke:runtime-isolation` | pass | 0 | 1155 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "eb4fef6cbf8e1608e7d135545ddda0a96691ec2e"
  }
```
