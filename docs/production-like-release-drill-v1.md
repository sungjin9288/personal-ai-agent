...
- generatedAt: 2026-07-23T12:40:30.926Z
- branch: codex/f1-16-private-answer-quality-enrichment-candidate
- verifiedCommit: 2fa7a4c44796ec2e506036e020aa3b08d6b104a5
...
| `npm run smoke:tenant-storage-admin` | pass | 0 | 115 |
...
| `npm run smoke:target-support-architecture` | pass | 0 | 106 |
...
| `npm run smoke:target-openai-provider-account` | pass | 0 | 97 |
...
| `npm run smoke:backup-restore-drill` | pass | 0 | 114 |
| `npm run smoke:runtime-isolation` | pass | 0 | 542 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "2fa7a4c44796ec2e506036e020aa3b08d6b104a5"
  }
```
