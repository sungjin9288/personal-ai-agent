...
- generatedAt: 2026-05-13T14:42:54.943Z
- branch: codex/post-merge-web-production-blocker-artifact-sync
- verifiedCommit: e14cb30199fbb0dc4f83f4c2a908af26ea156451
...
| `npm run smoke:target-identity-session-operations` | pass | 0 | 103 |
...
| `npm run smoke:target-support-architecture` | pass | 0 | 107 |
| `npm run smoke:target-support-operations` | pass | 0 | 103 |
| `npm run smoke:secret-management` | pass | 0 | 104 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 105 |
| `npm run smoke:target-secret-manager` | pass | 0 | 105 |
| `npm run smoke:observability-telemetry` | pass | 0 | 104 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 104 |
| `npm run smoke:target-observability-operations` | pass | 0 | 105 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 109 |
| `npm run smoke:target-slo-operations` | pass | 0 | 108 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 106 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 106 |
...
| `npm run smoke:target-openai-provider-account` | pass | 0 | 107 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 109 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 122 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 106 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "e14cb30199fbb0dc4f83f4c2a908af26ea156451"
  }
```
