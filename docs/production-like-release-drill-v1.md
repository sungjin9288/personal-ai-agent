...
- generatedAt: 2026-07-15T12:48:05.404Z
- branch: main
...
| `npm run smoke:target-slo-operations` | pass | 0 | 113 |
...
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 243 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "e9fafce7a3073765b5902e5bed9f6e2a2db41510"
  }
```
