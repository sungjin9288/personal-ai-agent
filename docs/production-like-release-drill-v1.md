...
- generatedAt: 2026-07-13T18:56:04.304Z
- branch: main
- verifiedCommit: b845d7f2f09f784278b78155b07d4850c43c719c
...
| `npm run smoke:execution-v1-status` | pass | 0 | 383 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "b845d7f2f09f784278b78155b07d4850c43c719c"
  }
```
