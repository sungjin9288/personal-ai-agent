...
- generatedAt: 2026-07-13T17:47:01.627Z
- branch: main
- verifiedCommit: a8494981c103b1ab9114bdb4af3e4553e0793640
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 86 |
| `npm run smoke:identity-session-admin` | pass | 0 | 87 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 86 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 88 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 86 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 88 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 87 |
| `npm run smoke:customer-support-operations` | pass | 0 | 87 |
| `npm run smoke:support-escalation-review` | pass | 0 | 86 |
| `npm run smoke:target-support-architecture` | pass | 0 | 87 |
| `npm run smoke:target-support-operations` | pass | 0 | 87 |
| `npm run smoke:secret-management` | pass | 0 | 87 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 93 |
| `npm run smoke:target-secret-manager` | pass | 0 | 86 |
| `npm run smoke:observability-telemetry` | pass | 0 | 85 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 88 |
| `npm run smoke:target-observability-operations` | pass | 0 | 88 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 87 |
| `npm run smoke:target-slo-operations` | pass | 0 | 87 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 88 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 88 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 88 |
| `npm run smoke:target-retention-operations` | pass | 0 | 86 |
| `npm run smoke:target-backup-operations` | pass | 0 | 87 |
| `npm run smoke:production-slo-operating` | pass | 0 | 86 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1272 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 114 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 88 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 87 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 87 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 87 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 87 |
| `npm run smoke:target-provider-operations` | pass | 0 | 88 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 88 |
...
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 200 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 97 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 92 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 262 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 98 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 101 |
| `npm run smoke:runtime-isolation` | pass | 0 | 426 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "a8494981c103b1ab9114bdb4af3e4553e0793640"
  }
```
