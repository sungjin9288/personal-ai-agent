...
- generatedAt: 2026-07-29T08:05:52.117Z
- branch: codex/council-v6-actual-compatibility-observation
- verifiedCommit: a8795f390cbd9a8b432ce112a3c9d91362af6c5f
...
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 254 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 141 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 132 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 336 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 117 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 120 |
| `npm run smoke:runtime-isolation` | pass | 0 | 563 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "a8795f390cbd9a8b432ce112a3c9d91362af6c5f"
  }
```
