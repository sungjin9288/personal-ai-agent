...
- generatedAt: 2026-06-01T02:56:04.394Z
- branch: codex/execution-v1-artifacts-bc2ec5a-refresh
- verifiedCommit: bc2ec5aba8e9b16ba087eef47a99e10e05fcee8a
...
| `npm run smoke:target-identity-session-operations` | pass | 0 | 142 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 141 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 159 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 165 |
| `npm run smoke:customer-support-operations` | pass | 0 | 151 |
...
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 133 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 121 |
| `npm run smoke:target-provider-operations` | pass | 0 | 131 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 123 |
...
| `npm run smoke:execution-v1-status` | pass | 0 | 424 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 182 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 501 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "bc2ec5aba8e9b16ba087eef47a99e10e05fcee8a"
  }
```
