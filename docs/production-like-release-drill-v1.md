...
- generatedAt: 2026-05-24T06:22:43.187Z
- branch: codex/target-secret-injection-gap-proof-detail
- verifiedCommit: c3e244c1d7adceae1facbf4a1bb10267498cd8ee
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 147 |
...
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 198 |
| `npm run smoke:customer-support-operations` | pass | 0 | 192 |
| `npm run smoke:support-escalation-review` | pass | 0 | 191 |
| `npm run smoke:target-support-architecture` | pass | 0 | 209 |
| `npm run smoke:target-support-operations` | pass | 0 | 215 |
| `npm run smoke:secret-management` | pass | 0 | 228 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 210 |
| `npm run smoke:target-secret-manager` | pass | 0 | 206 |
| `npm run smoke:observability-telemetry` | pass | 0 | 200 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 180 |
| `npm run smoke:target-observability-operations` | pass | 0 | 184 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 188 |
| `npm run smoke:target-slo-operations` | pass | 0 | 180 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 184 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 182 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 184 |
| `npm run smoke:target-retention-operations` | pass | 0 | 178 |
| `npm run smoke:target-backup-operations` | pass | 0 | 173 |
| `npm run smoke:production-slo-operating` | pass | 0 | 298 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1453 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 192 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 205 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 208 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 194 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 190 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 187 |
| `npm run smoke:target-provider-operations` | pass | 0 | 189 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 180 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 167 |
| `npm run smoke:production-retention-operating` | pass | 0 | 174 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 174 |
| `npm run smoke:execution-v1-status` | pass | 0 | 482 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 233 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 302 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 206 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 475 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 203 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 232 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "c3e244c1d7adceae1facbf4a1bb10267498cd8ee"
  }
```
