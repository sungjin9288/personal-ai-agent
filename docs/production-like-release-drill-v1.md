...
- generatedAt: 2026-07-16T10:45:23.909Z
- branch: codex/training-dataset-quality-gate
- verifiedCommit: 425d72101229ac5f2919327e8090deb4f43821e3
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 102 |
| `npm run smoke:identity-session-admin` | pass | 0 | 98 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 109 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 140 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 103 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 99 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 100 |
| `npm run smoke:customer-support-operations` | pass | 0 | 94 |
| `npm run smoke:support-escalation-review` | pass | 0 | 97 |
| `npm run smoke:target-support-architecture` | pass | 0 | 98 |
| `npm run smoke:target-support-operations` | pass | 0 | 97 |
| `npm run smoke:secret-management` | pass | 0 | 97 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 97 |
| `npm run smoke:target-secret-manager` | pass | 0 | 95 |
| `npm run smoke:observability-telemetry` | pass | 0 | 96 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 96 |
| `npm run smoke:target-observability-operations` | pass | 0 | 94 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 94 |
| `npm run smoke:target-slo-operations` | pass | 0 | 101 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 97 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 113 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 113 |
| `npm run smoke:target-retention-operations` | pass | 0 | 105 |
| `npm run smoke:target-backup-operations` | pass | 0 | 100 |
| `npm run smoke:production-slo-operating` | pass | 0 | 102 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1273 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 100 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 108 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 112 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 108 |
...
| `npm run smoke:clean-deployment-release` | pass | 0 | 100 |
| `npm run smoke:execution-v1-status` | pass | 0 | 469 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 544 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 113 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 100 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 295 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 120 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "425d72101229ac5f2919327e8090deb4f43821e3"
  }
```
