...
- generatedAt: 2026-07-16T14:33:04.579Z
- branch: codex/rag-reranker-resource-envelope
- verifiedCommit: ea47874a05f10ca70bde587031fdb53a124056a3
...
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 104 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 96 |
| `npm run smoke:customer-support-operations` | pass | 0 | 97 |
| `npm run smoke:support-escalation-review` | pass | 0 | 95 |
| `npm run smoke:target-support-architecture` | pass | 0 | 94 |
...
| `npm run smoke:production-enterprise-controls` | pass | 0 | 99 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 104 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 96 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 100 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 94 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 102 |
| `npm run smoke:target-provider-operations` | pass | 0 | 94 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 106 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 93 |
| `npm run smoke:production-retention-operating` | pass | 0 | 93 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 97 |
| `npm run smoke:execution-v1-status` | pass | 0 | 485 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 489 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 104 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 101 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 478 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "ea47874a05f10ca70bde587031fdb53a124056a3"
  }
```
...
```json
{
    ...
    "releaseArtifactHygieneScannedFiles": 69
  }
```
