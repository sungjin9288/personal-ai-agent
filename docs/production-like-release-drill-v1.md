...
- generatedAt: 2026-05-12T16:36:15.617Z
- branch: codex/provider-evidence-intake-closure-link
- verifiedCommit: e223adca827e748bbc747e8cadd93fd3c59caa82
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 168 |
| `npm run smoke:identity-session-admin` | pass | 0 | 183 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 192 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 166 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 179 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 199 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 197 |
| `npm run smoke:customer-support-operations` | pass | 0 | 200 |
| `npm run smoke:support-escalation-review` | pass | 0 | 177 |
| `npm run smoke:target-support-architecture` | pass | 0 | 179 |
| `npm run smoke:target-support-operations` | pass | 0 | 186 |
| `npm run smoke:secret-management` | pass | 0 | 170 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 180 |
| `npm run smoke:target-secret-manager` | pass | 0 | 183 |
| `npm run smoke:observability-telemetry` | pass | 0 | 172 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 173 |
| `npm run smoke:target-observability-operations` | pass | 0 | 181 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 168 |
| `npm run smoke:target-slo-operations` | pass | 0 | 174 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 185 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 191 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 203 |
...
| `npm run smoke:web-auth-rbac` | pass | 0 | 1395 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 182 |
...
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 169 |
...
| `npm run smoke:production-retention-operating` | pass | 0 | 183 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 189 |
| `npm run smoke:execution-v1-status` | pass | 0 | 511 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 240 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 192 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 156 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 468 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 188 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 230 |
| `npm run smoke:runtime-isolation` | pass | 0 | 702 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "e223adca827e748bbc747e8cadd93fd3c59caa82"
  }
```
