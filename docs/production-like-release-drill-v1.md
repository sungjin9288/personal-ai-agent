...
- generatedAt: 2026-07-17T08:12:35.395Z
...
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 98 |
...
| `npm run smoke:production-retention-operating` | pass | 0 | 92 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 96 |
| `npm run smoke:execution-v1-status` | pass | 0 | 478 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 487 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "49f8e6fcf50bb2e7b0548b84e8829439368bbcfc"
  }
```
...
```json
{
    ...
    "releaseArtifactHygieneScannedFiles": 104
  }
```
