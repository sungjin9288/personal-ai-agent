...
- generatedAt: 2026-05-24T01:40:50.339Z
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 163 |
| `npm run smoke:identity-session-admin` | pass | 0 | 160 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 164 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 162 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 157 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 167 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 161 |
| `npm run smoke:customer-support-operations` | pass | 0 | 158 |
| `npm run smoke:support-escalation-review` | pass | 0 | 159 |
| `npm run smoke:target-support-architecture` | pass | 0 | 166 |
| `npm run smoke:target-support-operations` | pass | 0 | 164 |
| `npm run smoke:secret-management` | pass | 0 | 152 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 162 |
| `npm run smoke:target-secret-manager` | pass | 0 | 162 |
| `npm run smoke:observability-telemetry` | pass | 0 | 160 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 160 |
| `npm run smoke:target-observability-operations` | pass | 0 | 162 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 160 |
| `npm run smoke:target-slo-operations` | pass | 0 | 162 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 163 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 165 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 156 |
| `npm run smoke:target-retention-operations` | pass | 0 | 166 |
| `npm run smoke:target-backup-operations` | pass | 0 | 158 |
| `npm run smoke:production-slo-operating` | pass | 0 | 161 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1387 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 159 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 164 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 163 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 164 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 164 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 163 |
| `npm run smoke:target-provider-operations` | pass | 0 | 163 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 165 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 161 |
| `npm run smoke:production-retention-operating` | pass | 0 | 161 |
...
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 171 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 412 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 178 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 191 |
| `npm run smoke:runtime-isolation` | pass | 0 | 648 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "1970c1bf8cebcea08e5deb39139b58d03e43fa46"
  }
```
