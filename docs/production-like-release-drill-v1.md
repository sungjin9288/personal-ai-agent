...
- generatedAt: 2026-07-16T10:16:00.707Z
...
| `npm run smoke:production-retention-operating` | pass | 0 | 88 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 91 |
| `npm run smoke:execution-v1-status` | pass | 0 | 473 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 450 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 467 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "fd26bf5165e243066d9f7aa46c38679f17484411"
  }
```
