...
- generatedAt: 2026-08-06T01:22:34.520Z
- branch: codex/council-retry-operator-surface-v1-1f
- verifiedCommit: 521ef6dec85bcd07076c2c7aadb2589c9ad4821e
...
| `npm run smoke:secret-management` | pass | 0 | 107 |
...
| `npm run smoke:target-observability-architecture` | pass | 0 | 105 |
| `npm run smoke:target-observability-operations` | pass | 0 | 107 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 106 |
| `npm run smoke:target-slo-operations` | pass | 0 | 103 |
...
| `npm run smoke:target-openai-provider-account` | pass | 0 | 118 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "521ef6dec85bcd07076c2c7aadb2589c9ad4821e"
  }
```
