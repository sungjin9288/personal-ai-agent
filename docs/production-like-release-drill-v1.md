...
- generatedAt: 2026-05-24T06:54:56.378Z
- branch: codex/hosted-identity-gap-proof-detail
- verifiedCommit: 1256221954242e98c83835bdfcce22f61656ef48
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 184 |
| `npm run smoke:identity-session-admin` | pass | 0 | 159 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 167 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 164 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 179 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 176 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 216 |
| `npm run smoke:customer-support-operations` | pass | 0 | 224 |
| `npm run smoke:support-escalation-review` | pass | 0 | 203 |
| `npm run smoke:target-support-architecture` | pass | 0 | 207 |
| `npm run smoke:target-support-operations` | pass | 0 | 179 |
| `npm run smoke:secret-management` | pass | 0 | 175 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 176 |
| `npm run smoke:target-secret-manager` | pass | 0 | 170 |
| `npm run smoke:observability-telemetry` | pass | 0 | 161 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 189 |
| `npm run smoke:target-observability-operations` | pass | 0 | 186 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 168 |
| `npm run smoke:target-slo-operations` | pass | 0 | 166 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 167 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 156 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 159 |
| `npm run smoke:target-retention-operations` | pass | 0 | 168 |
| `npm run smoke:target-backup-operations` | pass | 0 | 159 |
| `npm run smoke:production-slo-operating` | pass | 0 | 160 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1379 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 164 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 179 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 183 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 188 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 179 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 177 |
| `npm run smoke:target-provider-operations` | pass | 0 | 175 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 181 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 159 |
| `npm run smoke:production-retention-operating` | pass | 0 | 160 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 168 |
| `npm run smoke:execution-v1-status` | pass | 0 | 451 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 204 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 165 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 177 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 412 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 205 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 221 |
| `npm run smoke:runtime-isolation` | pass | 0 | 649 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "1256221954242e98c83835bdfcce22f61656ef48"
  }
```
