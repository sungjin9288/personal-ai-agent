...
- generatedAt: 2026-07-24T00:13:59.137Z
- branch: codex/f1-18-private-answer-quality-case-materialization
- verifiedCommit: 878d12eb33f265493817d123f273cf3db040fea6
...
| `npm run smoke:identity-session-admin` | pass | 0 | 102 |
...
| `npm run smoke:target-observability-operations` | pass | 0 | 104 |
...
| `npm run smoke:web-auth-rbac` | pass | 0 | 1295 |
...
| `npm run smoke:execution-v1-status` | pass | 0 | 414 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 262 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 153 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "878d12eb33f265493817d123f273cf3db040fea6"
  }
```
