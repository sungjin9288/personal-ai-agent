...
- generatedAt: 2026-05-24T04:53:45.975Z
- branch: codex/release-approval-gap-proof-detail
- verifiedCommit: c252c3332248739ebb3dd508b2e951250ff1cbe7
...
| `npm run smoke:identity-session-admin` | pass | 0 | 131 |
...
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 148 |
...
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 140 |
| `npm run smoke:target-secret-manager` | pass | 0 | 133 |
| `npm run smoke:observability-telemetry` | pass | 0 | 131 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 148 |
| `npm run smoke:target-observability-operations` | pass | 0 | 153 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 181 |
| `npm run smoke:target-slo-operations` | pass | 0 | 224 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 186 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 133 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 136 |
| `npm run smoke:target-retention-operations` | pass | 0 | 182 |
| `npm run smoke:target-backup-operations` | pass | 0 | 184 |
| `npm run smoke:production-slo-operating` | pass | 0 | 196 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1351 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 151 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 132 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 134 |
...
| `npm run smoke:target-provider-operations` | pass | 0 | 145 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 160 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 195 |
| `npm run smoke:production-retention-operating` | pass | 0 | 195 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 216 |
| `npm run smoke:execution-v1-status` | pass | 0 | 450 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 209 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 164 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 186 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 369 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 173 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 163 |
| `npm run smoke:runtime-isolation` | pass | 0 | 525 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "c252c3332248739ebb3dd508b2e951250ff1cbe7"
  }
```
