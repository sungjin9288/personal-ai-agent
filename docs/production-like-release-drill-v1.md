...
- generatedAt: 2026-05-22T02:04:14.352Z
- branch: codex/target-provider-operations-proof-detail
- verifiedCommit: ef49fa8c327b04e12dea7255ded04fc0523a6a32
...
| `npm run smoke:target-support-operations` | pass | 0 | 196 |
| `npm run smoke:secret-management` | pass | 0 | 181 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 175 |
| `npm run smoke:target-secret-manager` | pass | 0 | 178 |
| `npm run smoke:observability-telemetry` | pass | 0 | 163 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 168 |
| `npm run smoke:target-observability-operations` | pass | 0 | 248 |
...
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 175 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 192 |
| `npm run smoke:target-retention-operations` | pass | 0 | 191 |
| `npm run smoke:target-backup-operations` | pass | 0 | 187 |
| `npm run smoke:production-slo-operating` | pass | 0 | 178 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1423 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 167 |
...
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 168 |
...
| `npm run smoke:execution-v1-status` | pass | 0 | 593 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 276 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 184 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 151 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 406 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 183 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 196 |
| `npm run smoke:runtime-isolation` | pass | 0 | 601 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "ef49fa8c327b04e12dea7255ded04fc0523a6a32"
  }
```
