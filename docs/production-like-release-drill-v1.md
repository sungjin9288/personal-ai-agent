...
- generatedAt: 2026-07-16T14:00:21.677Z
- branch: codex/rag-local-relevance-reranker
- verifiedCommit: 574db34c9ed2e989ffd5eecc3d3e5101513044a2
...
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 95 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 95 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 95 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 96 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 95 |
...
| `npm run smoke:target-backup-operations` | pass | 0 | 106 |
...
| `npm run smoke:production-retention-operating` | pass | 0 | 95 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 100 |
| `npm run smoke:execution-v1-status` | pass | 0 | 486 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 472 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 106 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "574db34c9ed2e989ffd5eecc3d3e5101513044a2"
  }
```
...
```json
{
    ...
    "releaseArtifactHygieneScannedFiles": 68
  }
```
