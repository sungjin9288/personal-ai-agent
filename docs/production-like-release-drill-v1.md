...
- generatedAt: 2026-05-18T03:21:08.706Z
- branch: codex/hermes-stop-condition-detail
- verifiedCommit: b4b4fb55e4616e5dc34e0225fe7da1092409cb08
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 180 |
| `npm run smoke:identity-session-admin` | pass | 0 | 204 |
...
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 173 |
...
| `npm run smoke:target-support-operations` | pass | 0 | 181 |
| `npm run smoke:secret-management` | pass | 0 | 226 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 157 |
| `npm run smoke:target-secret-manager` | pass | 0 | 169 |
| `npm run smoke:observability-telemetry` | pass | 0 | 170 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 169 |
| `npm run smoke:target-observability-operations` | pass | 0 | 148 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 168 |
| `npm run smoke:target-slo-operations` | pass | 0 | 153 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 164 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 161 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 164 |
| `npm run smoke:target-retention-operations` | pass | 0 | 152 |
| `npm run smoke:target-backup-operations` | pass | 0 | 148 |
| `npm run smoke:production-slo-operating` | pass | 0 | 152 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1375 |
...
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 171 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 169 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 162 |
| `npm run smoke:target-provider-operations` | pass | 0 | 163 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 150 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 167 |
| `npm run smoke:production-retention-operating` | pass | 0 | 204 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 221 |
| `npm run smoke:execution-v1-status` | pass | 0 | 517 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 256 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 189 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 172 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 481 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 166 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 194 |
| `npm run smoke:runtime-isolation` | pass | 0 | 703 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "b4b4fb55e4616e5dc34e0225fe7da1092409cb08"
  }
```
