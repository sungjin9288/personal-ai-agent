...
- generatedAt: 2026-07-15T17:17:06.235Z
- branch: codex/d4-4a-escalation-handoff
- verifiedCommit: 5d96167909289a6dabe13421aa496a45a3325445
...
| `npm run smoke:support-escalation-review` | pass | 0 | 106 |
...
| `npm run smoke:target-observability-architecture` | pass | 0 | 98 |
...
| `npm run smoke:production-slo-operating` | pass | 0 | 105 |
...
| `npm run smoke:production-retention-operating` | pass | 0 | 106 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 113 |
| `npm run smoke:execution-v1-status` | pass | 0 | 406 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 240 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 120 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 113 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 538 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "5d96167909289a6dabe13421aa496a45a3325445"
  }
```
