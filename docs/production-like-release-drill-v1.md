...
- generatedAt: 2026-07-13T21:41:08.268Z
- branch: main
- verifiedCommit: dddc0a1bf196ac63016a007d469a2e44154bbdc8
...
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 87 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 88 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 87 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 90 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 88 |
| `npm run smoke:customer-support-operations` | pass | 0 | 89 |
| `npm run smoke:support-escalation-review` | pass | 0 | 89 |
| `npm run smoke:target-support-architecture` | pass | 0 | 88 |
| `npm run smoke:target-support-operations` | pass | 0 | 88 |
| `npm run smoke:secret-management` | pass | 0 | 88 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 89 |
| `npm run smoke:target-secret-manager` | pass | 0 | 88 |
| `npm run smoke:observability-telemetry` | pass | 0 | 87 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 91 |
| `npm run smoke:target-observability-operations` | pass | 0 | 89 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 91 |
| `npm run smoke:target-slo-operations` | pass | 0 | 88 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 89 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 89 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 88 |
| `npm run smoke:target-retention-operations` | pass | 0 | 88 |
| `npm run smoke:target-backup-operations` | pass | 0 | 87 |
| `npm run smoke:production-slo-operating` | pass | 0 | 87 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1273 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 105 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 88 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 89 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 89 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 91 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 87 |
| `npm run smoke:target-provider-operations` | pass | 0 | 92 |
...
| `npm run smoke:clean-deployment-release` | pass | 0 | 92 |
| `npm run smoke:execution-v1-status` | pass | 0 | 378 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 210 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 100 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 95 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 294 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 100 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 104 |
| `npm run smoke:runtime-isolation` | pass | 0 | 433 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "dddc0a1bf196ac63016a007d469a2e44154bbdc8"
  }
```
