...
- generatedAt: 2026-07-15T10:56:27.425Z
- branch: main
...
| `npm run smoke:identity-session-admin` | pass | 0 | 103 |
...
| `npm run smoke:support-escalation-review` | pass | 0 | 107 |
...
| `npm run smoke:target-observability-architecture` | pass | 0 | 109 |
...
| `npm run smoke:web-auth-rbac` | pass | 0 | 1275 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 107 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 100 |
...
| `npm run smoke:target-deployment-contract` | pass | 0 | 104 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 97 |
| `npm run smoke:production-retention-operating` | pass | 0 | 98 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 101 |
| `npm run smoke:execution-v1-status` | pass | 0 | 397 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 222 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 502 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "4224272fc0e4262b1c05f7f090ef40c99a23355e"
  }
```
