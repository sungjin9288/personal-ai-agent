...
- generatedAt: 2026-05-22T06:53:01.675Z
...
| `npm run smoke:support-escalation-review` | pass | 0 | 154 |
...
| `npm run smoke:target-slo-architecture` | pass | 0 | 214 |
| `npm run smoke:target-slo-operations` | pass | 0 | 301 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 209 |
...
| `npm run smoke:target-deployment-contract` | pass | 0 | 134 |
...
| `npm run smoke:execution-v1-status` | pass | 0 | 430 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 257 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 695 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "9a33d6e28d0058b4324bdd4232f9fddf049c2125"
  }
```
