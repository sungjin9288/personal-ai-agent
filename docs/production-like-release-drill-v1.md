...
- generatedAt: 2026-05-12T05:18:46.083Z
- branch: codex/post-merge-target-deployment-artifact-sync
- verifiedCommit: d8d7bc6c35a81f9aef278dec391766d97f19d1bf
...
| `npm run smoke:identity-session-admin` | pass | 0 | 135 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 133 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 138 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 126 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 129 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 130 |
| `npm run smoke:customer-support-operations` | pass | 0 | 133 |
| `npm run smoke:support-escalation-review` | pass | 0 | 141 |
...
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 131 |
| `npm run smoke:target-secret-manager` | pass | 0 | 134 |
| `npm run smoke:observability-telemetry` | pass | 0 | 140 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 147 |
| `npm run smoke:target-observability-operations` | pass | 0 | 151 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 199 |
| `npm run smoke:target-slo-operations` | pass | 0 | 156 |
...
| `npm run smoke:target-backup-operations` | pass | 0 | 174 |
| `npm run smoke:production-slo-operating` | pass | 0 | 159 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1346 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 141 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 136 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 143 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 130 |
...
| `npm run smoke:production-retention-operating` | pass | 0 | 190 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 144 |
| `npm run smoke:execution-v1-status` | pass | 0 | 440 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 195 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 144 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 156 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 440 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 141 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 141 |
| `npm run smoke:runtime-isolation` | pass | 0 | 591 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "d8d7bc6c35a81f9aef278dec391766d97f19d1bf"
  }
```
