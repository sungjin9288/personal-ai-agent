...
- generatedAt: 2026-05-12T17:33:00.461Z
- branch: codex/post-merge-release-readiness-publish-artifact-sync
- verifiedCommit: 74babecba22e554b9914ff04c7c83ec207ae5ba3
...
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 162 |
...
| `npm run smoke:backup-restore-drill` | pass | 0 | 147 |
| `npm run smoke:runtime-isolation` | pass | 0 | 559 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "74babecba22e554b9914ff04c7c83ec207ae5ba3"
  }
```
