...
- generatedAt: 2026-05-12T11:48:28.799Z
- branch: codex/post-merge-environment-submission-artifact-sync
- verifiedCommit: aee1f0e7790c3d702902a8328bd2f249e9bd6a8a
...
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 123 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 123 |
...
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 109 |
| `npm run smoke:target-secret-manager` | pass | 0 | 119 |
| `npm run smoke:observability-telemetry` | pass | 0 | 109 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 112 |
...
| `npm run smoke:production-provider-readiness` | pass | 0 | 121 |
...
| `npm run smoke:clean-deployment-release` | pass | 0 | 116 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 509 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "aee1f0e7790c3d702902a8328bd2f249e9bd6a8a"
  }
```
