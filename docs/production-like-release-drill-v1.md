...
- generatedAt: 2026-07-27T02:51:43.447Z
- branch: codex/council-quality-shadow
- verifiedCommit: 3c70129317a1d552f54dee03811c5269aed14723
...
| `npm run smoke:customer-support-operations` | pass | 0 | 111 |
...
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 240 |
...
| `npm run smoke:target-deployment-contract` | pass | 0 | 115 |
...
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 701 |
...
| `npm run smoke:backup-restore-drill` | pass | 0 | 130 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "3c70129317a1d552f54dee03811c5269aed14723"
  }
```
