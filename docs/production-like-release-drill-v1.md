...
- generatedAt: 2026-05-22T00:31:03.741Z
- branch: codex/release-label-proof-detail
- verifiedCommit: 11aeb946b5905b62916584bde48db0edf2ae0469
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 259 |
| `npm run smoke:identity-session-admin` | pass | 0 | 243 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 253 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 254 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 293 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 248 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 252 |
| `npm run smoke:customer-support-operations` | pass | 0 | 250 |
| `npm run smoke:support-escalation-review` | pass | 0 | 251 |
| `npm run smoke:target-support-architecture` | pass | 0 | 239 |
| `npm run smoke:target-support-operations` | pass | 0 | 274 |
| `npm run smoke:secret-management` | pass | 0 | 248 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 280 |
| `npm run smoke:target-secret-manager` | pass | 0 | 290 |
| `npm run smoke:observability-telemetry` | pass | 0 | 307 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 324 |
| `npm run smoke:target-observability-operations` | pass | 0 | 295 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 266 |
| `npm run smoke:target-slo-operations` | pass | 0 | 283 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 256 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 303 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 319 |
| `npm run smoke:target-retention-operations` | pass | 0 | 283 |
| `npm run smoke:target-backup-operations` | pass | 0 | 298 |
| `npm run smoke:production-slo-operating` | pass | 0 | 289 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1552 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 262 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 256 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 270 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 252 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 277 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 309 |
| `npm run smoke:target-provider-operations` | pass | 0 | 287 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 322 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 396 |
| `npm run smoke:production-retention-operating` | pass | 0 | 370 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 525 |
| `npm run smoke:execution-v1-status` | pass | 0 | 1298 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 649 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 364 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 327 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 883 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 349 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 340 |
| `npm run smoke:runtime-isolation` | pass | 0 | 1213 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "11aeb946b5905b62916584bde48db0edf2ae0469"
  }
```
