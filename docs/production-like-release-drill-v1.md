...
- generatedAt: 2026-07-15T09:00:26.955Z
- branch: main
- verifiedCommit: 548155335a3528ecf844b31b4a562d19d9de92ed
...
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 93 |
...
| `npm run smoke:target-observability-operations` | pass | 0 | 87 |
...
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 87 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 87 |
| `npm run smoke:target-retention-operations` | pass | 0 | 87 |
| `npm run smoke:target-backup-operations` | pass | 0 | 88 |
| `npm run smoke:production-slo-operating` | pass | 0 | 87 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1271 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 113 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 87 |
...
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 88 |
| `npm run smoke:target-provider-operations` | pass | 0 | 88 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 89 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 89 |
| `npm run smoke:production-retention-operating` | pass | 0 | 87 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 92 |
| `npm run smoke:execution-v1-status` | pass | 0 | 375 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 208 |
...
| `npm run smoke:backup-restore-drill` | pass | 0 | 102 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "548155335a3528ecf844b31b4a562d19d9de92ed"
  }
```
