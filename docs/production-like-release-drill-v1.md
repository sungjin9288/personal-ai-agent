...
- generatedAt: 2026-05-22T05:55:19.901Z
- branch: codex/local-provider-ui-proof-detail
- verifiedCommit: d1247655f829ee00312d2871fc1d657e5a5a0637
...
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 194 |
...
| `npm run smoke:customer-support-operations` | pass | 0 | 164 |
...
| `npm run smoke:target-secret-manager` | pass | 0 | 150 |
| `npm run smoke:observability-telemetry` | pass | 0 | 152 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 159 |
| `npm run smoke:target-observability-operations` | pass | 0 | 155 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 154 |
| `npm run smoke:target-slo-operations` | pass | 0 | 168 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 244 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 252 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 295 |
| `npm run smoke:target-retention-operations` | pass | 0 | 192 |
...
| `npm run smoke:execution-v1-status` | pass | 0 | 456 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 273 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 198 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 260 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 554 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 195 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 283 |
| `npm run smoke:runtime-isolation` | pass | 0 | 987 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "d1247655f829ee00312d2871fc1d657e5a5a0637"
  }
```
