...
- generatedAt: 2026-05-12T00:28:55.362Z
- branch: codex/target-local-provider-evidence-packet
- verifiedCommit: 9209986f6b516e88fbf6c8171899d01c23a2168a
...
| `npm run smoke:tenant-storage-admin` | pass | 0 | 229 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 225 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 150 |
| `npm run smoke:customer-support-operations` | pass | 0 | 150 |
| `npm run smoke:support-escalation-review` | pass | 0 | 125 |
| `npm run smoke:target-support-architecture` | pass | 0 | 132 |
...
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 122 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 119 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 115 |
| `npm run smoke:target-retention-operations` | pass | 0 | 109 |
...
| `npm run smoke:target-openai-provider-account` | pass | 0 | 124 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 136 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 143 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 132 |
| `npm run smoke:target-provider-operations` | pass | 0 | 126 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 122 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 120 |
| `npm run smoke:production-retention-operating` | pass | 0 | 124 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 263 |
| `npm run smoke:execution-v1-status` | pass | 0 | 416 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 168 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 639 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "9209986f6b516e88fbf6c8171899d01c23a2168a"
  }
```
