...
- generatedAt: 2026-07-17T06:53:38.312Z
...
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 89 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 88 |
| `npm run smoke:customer-support-operations` | pass | 0 | 88 |
| `npm run smoke:support-escalation-review` | pass | 0 | 88 |
...
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 88 |
| `npm run smoke:target-secret-manager` | pass | 0 | 87 |
| `npm run smoke:observability-telemetry` | pass | 0 | 88 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 87 |
...
| `npm run smoke:execution-v1-status` | pass | 0 | 468 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 479 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 145 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 485 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "303b9b384db582c66d558322a3d02db76d44f025"
  }
```
...
```json
{
    ...
    "releaseArtifactHygieneScannedFiles": 102
  }
```
