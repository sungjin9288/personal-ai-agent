...
- generatedAt: 2026-07-22T08:07:34.556Z
...
| `npm run smoke:target-secret-manager` | pass | 0 | 104 |
...
| `npm run smoke:production-slo-operating` | pass | 0 | 111 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "2bdd5521f8c4992bcc5172f61db19c088bba7d65"
  }
```
...
```json
{
    ...
    "releaseArtifactHygieneScannedFiles": 115
  }
```
