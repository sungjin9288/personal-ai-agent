...
- generatedAt: 2026-05-22T16:04:33.725Z
- branch: codex/main-tenant-isolation-artifact-sync
- verifiedCommit: 26be70af480026fe54f4d788de3b0f21199992b0
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 176 |
| `npm run smoke:identity-session-admin` | pass | 0 | 158 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 165 |
...
| `npm run smoke:target-support-architecture` | pass | 0 | 215 |
| `npm run smoke:target-support-operations` | pass | 0 | 210 |
| `npm run smoke:secret-management` | pass | 0 | 208 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 208 |
| `npm run smoke:target-secret-manager` | pass | 0 | 209 |
| `npm run smoke:observability-telemetry` | pass | 0 | 168 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 179 |
| `npm run smoke:target-observability-operations` | pass | 0 | 168 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 177 |
...
| `npm run smoke:target-backup-operations` | pass | 0 | 167 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "26be70af480026fe54f4d788de3b0f21199992b0"
  }
```
