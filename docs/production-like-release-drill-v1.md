...
- generatedAt: 2026-05-25T15:52:49.688Z
- branch: codex/provider-exception-risk-proof-detail
- verifiedCommit: 6511cff064e5f0452435c2328cda1ad39a528bd3
...
| `npm run smoke:target-secret-manager` | pass | 0 | 101 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "6511cff064e5f0452435c2328cda1ad39a528bd3"
  }
```
