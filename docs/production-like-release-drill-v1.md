...
- generatedAt: 2026-05-12T10:12:31.404Z
- branch: codex/target-provider-operations-evidence-template
- verifiedCommit: 53cb3430c7975b23b5abed8d4cfe64ee84aa0ae5
...
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 199 |
...
| `npm run smoke:backup-restore-drill` | pass | 0 | 144 |
| `npm run smoke:runtime-isolation` | pass | 0 | 497 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "53cb3430c7975b23b5abed8d4cfe64ee84aa0ae5"
  }
```
