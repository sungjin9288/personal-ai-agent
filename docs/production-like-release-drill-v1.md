...
- generatedAt: 2026-05-20T11:56:37.210Z
...
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 353 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 280 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 275 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 280 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 292 |
| `npm run smoke:customer-support-operations` | pass | 0 | 266 |
| `npm run smoke:support-escalation-review` | pass | 0 | 302 |
| `npm run smoke:target-support-architecture` | pass | 0 | 281 |
| `npm run smoke:target-support-operations` | pass | 0 | 280 |
| `npm run smoke:secret-management` | pass | 0 | 298 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 302 |
| `npm run smoke:target-secret-manager` | pass | 0 | 285 |
| `npm run smoke:observability-telemetry` | pass | 0 | 282 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 348 |
| `npm run smoke:target-observability-operations` | pass | 0 | 439 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 380 |
| `npm run smoke:target-slo-operations` | pass | 0 | 397 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 391 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 395 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 359 |
| `npm run smoke:target-retention-operations` | pass | 0 | 381 |
| `npm run smoke:target-backup-operations` | pass | 0 | 383 |
| `npm run smoke:production-slo-operating` | pass | 0 | 402 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1812 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 242 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 253 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 291 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 279 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 277 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 340 |
| `npm run smoke:target-provider-operations` | pass | 0 | 252 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 252 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 247 |
| `npm run smoke:production-retention-operating` | pass | 0 | 231 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 242 |
| `npm run smoke:execution-v1-status` | pass | 0 | 587 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 312 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 196 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 176 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 433 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 193 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 195 |
| `npm run smoke:runtime-isolation` | pass | 0 | 691 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "fcd68c853d1f37e8d8f0dc3175d986e845a4299c"
  }
```
