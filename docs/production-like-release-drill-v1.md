...
- generatedAt: 2026-07-22T16:20:20.920Z
- branch: codex/f1-2-reviewed-data-collection-plan
- verifiedCommit: 3073267742e05b32c29b79f52e71d51a90aeec17
...
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 103 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 105 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 101 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 108 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 102 |
...
| `npm run smoke:observability-telemetry` | pass | 0 | 107 |
...
| `npm run smoke:target-slo-operations` | pass | 0 | 124 |
...
| `npm run smoke:target-backup-operations` | pass | 0 | 115 |
...
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 111 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 105 |
| `npm run smoke:target-provider-operations` | pass | 0 | 111 |
...
| `npm run smoke:execution-v1-status` | pass | 0 | 620 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 1004 |
...
| `npm run smoke:backup-restore-drill` | pass | 0 | 356 |
| `npm run smoke:runtime-isolation` | pass | 0 | 579 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "3073267742e05b32c29b79f52e71d51a90aeec17"
  }
```
...
```json
{
    ...
    "releaseArtifactHygieneScannedFiles": 120
  }
```
