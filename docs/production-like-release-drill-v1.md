...
- generatedAt: 2026-07-16T09:47:21.221Z
- branch: codex/rag-deterministic-reranking
- verifiedCommit: 390775e0bd94cb7d7a78c5bfa74f8c79d7ee4ac5
...
| `npm run smoke:web-auth-rbac` | pass | 0 | 1278 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "390775e0bd94cb7d7a78c5bfa74f8c79d7ee4ac5"
  }
```
