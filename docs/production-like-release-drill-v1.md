...
- generatedAt: 2026-05-24T00:44:27.838Z
- branch: codex/main-clean-deployment-secret-injection-artifact-sync
- verifiedCommit: 4edccddbe204969701069ddb014c5f2318ce672c
...
| `npm run smoke:target-support-architecture` | pass | 0 | 129 |
...
| `npm run smoke:production-enterprise-controls` | pass | 0 | 133 |
...
| `npm run smoke:production-retention-operating` | pass | 0 | 132 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 143 |
| `npm run smoke:execution-v1-status` | pass | 0 | 407 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 172 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 147 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 139 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 341 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 147 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "4edccddbe204969701069ddb014c5f2318ce672c"
  }
```
