...
- generatedAt: 2026-05-12T05:14:49.953Z
- branch: codex/target-deployment-contract-evidence-template
- verifiedCommit: 51307eb053a5e81cf2fdee13092f6a6b4210a10b
...
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 116 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 150 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 104 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 105 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 105 |
| `npm run smoke:customer-support-operations` | pass | 0 | 105 |
| `npm run smoke:support-escalation-review` | pass | 0 | 114 |
| `npm run smoke:target-support-architecture` | pass | 0 | 112 |
| `npm run smoke:target-support-operations` | pass | 0 | 105 |
| `npm run smoke:secret-management` | pass | 0 | 110 |
...
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 104 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 109 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 105 |
| `npm run smoke:target-retention-operations` | pass | 0 | 104 |
| `npm run smoke:target-backup-operations` | pass | 0 | 107 |
| `npm run smoke:production-slo-operating` | pass | 0 | 116 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1303 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 112 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 107 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 111 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 114 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 112 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 107 |
| `npm run smoke:target-provider-operations` | pass | 0 | 106 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 109 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 108 |
| `npm run smoke:production-retention-operating` | pass | 0 | 111 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 128 |
| `npm run smoke:execution-v1-status` | pass | 0 | 371 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 134 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 111 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 111 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 279 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 115 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 119 |
| `npm run smoke:runtime-isolation` | pass | 0 | 481 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "51307eb053a5e81cf2fdee13092f6a6b4210a10b"
  }
```
