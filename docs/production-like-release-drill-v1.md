...
- generatedAt: 2026-05-24T02:29:34.080Z
- branch: codex/staffed-on-call-gap-proof-detail
- verifiedCommit: a395f035d5a6f01ecf7fd2867763142a2460d83c
...
| `npm run smoke:target-identity-session-operations` | pass | 0 | 176 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 182 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 214 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 255 |
| `npm run smoke:customer-support-operations` | pass | 0 | 240 |
| `npm run smoke:support-escalation-review` | pass | 0 | 241 |
| `npm run smoke:target-support-architecture` | pass | 0 | 243 |
| `npm run smoke:target-support-operations` | pass | 0 | 236 |
| `npm run smoke:secret-management` | pass | 0 | 240 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 243 |
| `npm run smoke:target-secret-manager` | pass | 0 | 169 |
| `npm run smoke:observability-telemetry` | pass | 0 | 175 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 177 |
| `npm run smoke:target-observability-operations` | pass | 0 | 179 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 173 |
...
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 182 |
...
| `npm run smoke:web-auth-rbac` | pass | 0 | 1394 |
...
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 177 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 178 |
...
| `npm run smoke:production-retention-operating` | pass | 0 | 179 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 183 |
...
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 192 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 735 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "a395f035d5a6f01ecf7fd2867763142a2460d83c"
  }
```
