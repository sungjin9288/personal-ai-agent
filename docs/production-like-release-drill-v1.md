...
- generatedAt: 2026-07-13T15:59:29.744Z
- branch: main
- verifiedCommit: f1e12af61f9ebc365b85ef1cf25f0ef0a748db53
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 234 |
| `npm run smoke:identity-session-admin` | pass | 0 | 123 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 122 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 119 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 120 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 122 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 121 |
| `npm run smoke:customer-support-operations` | pass | 0 | 120 |
| `npm run smoke:support-escalation-review` | pass | 0 | 136 |
| `npm run smoke:target-support-architecture` | pass | 0 | 146 |
...
| `npm run smoke:target-secret-manager` | pass | 0 | 120 |
| `npm run smoke:observability-telemetry` | pass | 0 | 122 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 118 |
...
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 126 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 141 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 128 |
| `npm run smoke:target-retention-operations` | pass | 0 | 112 |
| `npm run smoke:target-backup-operations` | pass | 0 | 126 |
| `npm run smoke:production-slo-operating` | pass | 0 | 113 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1347 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 226 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 154 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 213 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 173 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 169 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 176 |
| `npm run smoke:target-provider-operations` | pass | 0 | 438 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 236 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 177 |
| `npm run smoke:production-retention-operating` | pass | 0 | 201 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 179 |
| `npm run smoke:execution-v1-status` | pass | 0 | 702 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 646 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 715 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "f1e12af61f9ebc365b85ef1cf25f0ef0a748db53"
  }
```
