...
- generatedAt: 2026-05-24T06:36:18.238Z
- branch: codex/main-target-secret-gap-artifact-sync
- verifiedCommit: 6acf1d384c885f7f7096ff31662f7701d46606d9
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 162 |
| `npm run smoke:identity-session-admin` | pass | 0 | 163 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 161 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 159 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 158 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 162 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 168 |
| `npm run smoke:customer-support-operations` | pass | 0 | 173 |
| `npm run smoke:support-escalation-review` | pass | 0 | 157 |
| `npm run smoke:target-support-architecture` | pass | 0 | 159 |
| `npm run smoke:target-support-operations` | pass | 0 | 155 |
| `npm run smoke:secret-management` | pass | 0 | 164 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 155 |
| `npm run smoke:target-secret-manager` | pass | 0 | 154 |
| `npm run smoke:observability-telemetry` | pass | 0 | 160 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 157 |
| `npm run smoke:target-observability-operations` | pass | 0 | 161 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 157 |
| `npm run smoke:target-slo-operations` | pass | 0 | 159 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 175 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 183 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 175 |
| `npm run smoke:target-retention-operations` | pass | 0 | 166 |
| `npm run smoke:target-backup-operations` | pass | 0 | 170 |
| `npm run smoke:production-slo-operating` | pass | 0 | 153 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1360 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 155 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 158 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 170 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 157 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 155 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 161 |
| `npm run smoke:target-provider-operations` | pass | 0 | 154 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 157 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 159 |
| `npm run smoke:production-retention-operating` | pass | 0 | 158 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 171 |
| `npm run smoke:execution-v1-status` | pass | 0 | 453 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 210 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 172 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 167 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 395 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 182 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 179 |
| `npm run smoke:runtime-isolation` | pass | 0 | 612 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "6acf1d384c885f7f7096ff31662f7701d46606d9"
  }
```
