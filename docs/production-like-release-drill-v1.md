...
- generatedAt: 2026-05-07T12:03:32.204Z
- branch: codex/managed-multi-agent-v1-foundation
- verifiedCommit: b977c141161631fe235c5ccb45941fc4e5da739a
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 346 |
| `npm run smoke:identity-session-admin` | pass | 0 | 368 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 444 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 352 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 257 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 219 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 219 |
| `npm run smoke:customer-support-operations` | pass | 0 | 217 |
| `npm run smoke:support-escalation-review` | pass | 0 | 215 |
| `npm run smoke:target-support-architecture` | pass | 0 | 229 |
| `npm run smoke:target-support-operations` | pass | 0 | 242 |
| `npm run smoke:secret-management` | pass | 0 | 234 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 268 |
| `npm run smoke:target-secret-manager` | pass | 0 | 255 |
| `npm run smoke:observability-telemetry` | pass | 0 | 234 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 235 |
| `npm run smoke:target-observability-operations` | pass | 0 | 220 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 229 |
| `npm run smoke:target-slo-operations` | pass | 0 | 228 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 215 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 227 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 225 |
| `npm run smoke:target-retention-operations` | pass | 0 | 215 |
| `npm run smoke:target-backup-operations` | pass | 0 | 236 |
| `npm run smoke:production-slo-operating` | pass | 0 | 217 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1455 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 215 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 258 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 231 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 241 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 221 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 213 |
| `npm run smoke:target-provider-operations` | pass | 0 | 231 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 273 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 237 |
| `npm run smoke:production-retention-operating` | pass | 0 | 214 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 239 |
| `npm run smoke:execution-v1-status` | pass | 0 | 678 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 334 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 243 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 251 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 571 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 262 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 267 |
| `npm run smoke:runtime-isolation` | pass | 0 | 883 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "b977c141161631fe235c5ccb45941fc4e5da739a"
  }
```
