...
- generatedAt: 2026-05-25T14:20:54.491Z
- branch: codex/main-provider-boundary-artifact-sync
- verifiedCommit: 2c34e9a8c1a1add0a4f36f43d88458ef47427a70
...
| `npm run smoke:retention-delete-policy` | pass | 0 | 129 |
...
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 138 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "2c34e9a8c1a1add0a4f36f43d88458ef47427a70"
  }
```
