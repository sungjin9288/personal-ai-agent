...
- generatedAt: 2026-05-22T07:20:54.446Z
- branch: codex/provider-attention-fallback-audit-coverage
- verifiedCommit: b33bb92bf59b08983fc5da2fe489109b51b0fc8f
...
| `npm run smoke:identity-session-admin` | pass | 0 | 207 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 209 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 236 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 320 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 327 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 263 |
| `npm run smoke:customer-support-operations` | pass | 0 | 229 |
| `npm run smoke:support-escalation-review` | pass | 0 | 352 |
| `npm run smoke:target-support-architecture` | pass | 0 | 369 |
| `npm run smoke:target-support-operations` | pass | 0 | 267 |
| `npm run smoke:secret-management` | pass | 0 | 229 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 337 |
| `npm run smoke:target-secret-manager` | pass | 0 | 240 |
| `npm run smoke:observability-telemetry` | pass | 0 | 250 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 216 |
| `npm run smoke:target-observability-operations` | pass | 0 | 222 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 212 |
| `npm run smoke:target-slo-operations` | pass | 0 | 210 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 212 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 218 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 226 |
| `npm run smoke:target-retention-operations` | pass | 0 | 220 |
| `npm run smoke:target-backup-operations` | pass | 0 | 238 |
| `npm run smoke:production-slo-operating` | pass | 0 | 225 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1460 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 214 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 225 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 234 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 257 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 258 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 250 |
| `npm run smoke:target-provider-operations` | pass | 0 | 237 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 213 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 223 |
| `npm run smoke:production-retention-operating` | pass | 0 | 220 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 326 |
| `npm run smoke:execution-v1-status` | pass | 0 | 736 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 409 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 271 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 309 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 695 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 278 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 282 |
| `npm run smoke:runtime-isolation` | pass | 0 | 1170 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "b33bb92bf59b08983fc5da2fe489109b51b0fc8f"
  }
```
