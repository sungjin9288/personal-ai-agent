...
- generatedAt: 2026-07-14T00:54:51.357Z
- branch: main
- verifiedCommit: b5a3837e4e75eae889e0a816fc0edf0a7fe02655
...
| `npm run smoke:runtime-isolation` | pass | 0 | 442 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "b5a3837e4e75eae889e0a816fc0edf0a7fe02655"
  }
```
