...
- generatedAt: 2026-05-12T04:07:24.303Z
- branch: codex/target-provider-account-evidence-templates
- verifiedCommit: fcf8847adc2a75404e264f8f8113bb21513b458d
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 150 |
| `npm run smoke:identity-session-admin` | pass | 0 | 127 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 115 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 113 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 135 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 123 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 116 |
| `npm run smoke:customer-support-operations` | pass | 0 | 114 |
...
| `npm run smoke:observability-telemetry` | pass | 0 | 114 |
...
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 189 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 116 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 126 |
| `npm run smoke:target-retention-operations` | pass | 0 | 124 |
...
| `npm run smoke:production-enterprise-controls` | pass | 0 | 131 |
...
| `npm run smoke:production-retention-operating` | pass | 0 | 117 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 187 |
| `npm run smoke:execution-v1-status` | pass | 0 | 406 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 163 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 129 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 129 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 370 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 156 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 156 |
| `npm run smoke:runtime-isolation` | pass | 0 | 553 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "fcf8847adc2a75404e264f8f8113bb21513b458d"
  }
```
