...
- generatedAt: 2026-07-23T04:53:23.677Z
- branch: codex/f1-11-private-collection-item-lifecycle
- verifiedCommit: 60eb54c863eda815ab0975601d820f391e61a901
...
| `npm run smoke:identity-session-admin` | pass | 0 | 137 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 124 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 147 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 116 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 115 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 111 |
| `npm run smoke:customer-support-operations` | pass | 0 | 121 |
| `npm run smoke:support-escalation-review` | pass | 0 | 130 |
| `npm run smoke:target-support-architecture` | pass | 0 | 144 |
| `npm run smoke:target-support-operations` | pass | 0 | 145 |
| `npm run smoke:secret-management` | pass | 0 | 130 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 122 |
| `npm run smoke:target-secret-manager` | pass | 0 | 135 |
| `npm run smoke:observability-telemetry` | pass | 0 | 116 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 139 |
| `npm run smoke:target-observability-operations` | pass | 0 | 138 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 122 |
| `npm run smoke:target-slo-operations` | pass | 0 | 153 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 151 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 127 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 119 |
| `npm run smoke:target-retention-operations` | pass | 0 | 217 |
| `npm run smoke:target-backup-operations` | pass | 0 | 135 |
| `npm run smoke:production-slo-operating` | pass | 0 | 129 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1448 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 218 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 188 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 164 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 165 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 118 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 119 |
| `npm run smoke:target-provider-operations` | pass | 0 | 119 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 126 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 141 |
| `npm run smoke:production-retention-operating` | pass | 0 | 140 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 141 |
| `npm run smoke:execution-v1-status` | pass | 0 | 547 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 611 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 182 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 180 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 398 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 121 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 159 |
| `npm run smoke:runtime-isolation` | pass | 0 | 659 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "60eb54c863eda815ab0975601d820f391e61a901"
  }
```
