...
- generatedAt: 2026-05-12T01:55:34.699Z
- branch: codex/post-merge-hermes-artifact-sync
- verifiedCommit: 43c547238d20f63f285474b6c5d1ef58f4b4b322
...
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 101 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "43c547238d20f63f285474b6c5d1ef58f4b4b322"
  }
```
