...
- generatedAt: 2026-05-12T15:13:16.934Z
- branch: codex/post-merge-blocker-closure-matrix-artifact-sync
- verifiedCommit: 2f83b1f532b4b32a58f8f835031aec59957ec22a
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 119 |
| `npm run smoke:identity-session-admin` | pass | 0 | 116 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 198 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 218 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 241 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 216 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 196 |
| `npm run smoke:customer-support-operations` | pass | 0 | 208 |
| `npm run smoke:support-escalation-review` | pass | 0 | 189 |
| `npm run smoke:target-support-architecture` | pass | 0 | 194 |
| `npm run smoke:target-support-operations` | pass | 0 | 200 |
| `npm run smoke:secret-management` | pass | 0 | 183 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 179 |
| `npm run smoke:target-secret-manager` | pass | 0 | 177 |
| `npm run smoke:observability-telemetry` | pass | 0 | 137 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 235 |
| `npm run smoke:target-observability-operations` | pass | 0 | 232 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 164 |
| `npm run smoke:target-slo-operations` | pass | 0 | 167 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 174 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 140 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 143 |
| `npm run smoke:target-retention-operations` | pass | 0 | 139 |
| `npm run smoke:target-backup-operations` | pass | 0 | 136 |
| `npm run smoke:production-slo-operating` | pass | 0 | 136 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1341 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 341 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 260 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 193 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 222 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 287 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 411 |
| `npm run smoke:target-provider-operations` | pass | 0 | 300 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 160 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 160 |
| `npm run smoke:production-retention-operating` | pass | 0 | 171 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 168 |
| `npm run smoke:execution-v1-status` | pass | 0 | 455 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 225 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 217 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 161 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 448 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 173 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 175 |
| `npm run smoke:runtime-isolation` | pass | 0 | 975 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "2f83b1f532b4b32a58f8f835031aec59957ec22a"
  }
```
