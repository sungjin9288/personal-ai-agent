...
- generatedAt: 2026-07-22T10:20:00.790Z
...
| `npm run smoke:identity-session-admin` | pass | 0 | 175 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 132 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 128 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 128 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 126 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 122 |
| `npm run smoke:customer-support-operations` | pass | 0 | 126 |
| `npm run smoke:support-escalation-review` | pass | 0 | 132 |
| `npm run smoke:target-support-architecture` | pass | 0 | 121 |
| `npm run smoke:target-support-operations` | pass | 0 | 132 |
| `npm run smoke:secret-management` | pass | 0 | 124 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 125 |
| `npm run smoke:target-secret-manager` | pass | 0 | 129 |
| `npm run smoke:observability-telemetry` | pass | 0 | 129 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 123 |
| `npm run smoke:target-observability-operations` | pass | 0 | 125 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 127 |
| `npm run smoke:target-slo-operations` | pass | 0 | 135 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 129 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 126 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 127 |
| `npm run smoke:target-retention-operations` | pass | 0 | 131 |
| `npm run smoke:target-backup-operations` | pass | 0 | 122 |
| `npm run smoke:production-slo-operating` | pass | 0 | 123 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1361 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 127 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 124 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 129 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 136 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 162 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 244 |
| `npm run smoke:target-provider-operations` | pass | 0 | 143 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 139 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 135 |
| `npm run smoke:production-retention-operating` | pass | 0 | 165 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 235 |
| `npm run smoke:execution-v1-status` | pass | 0 | 576 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 568 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 174 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 154 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 393 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 135 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 134 |
| `npm run smoke:runtime-isolation` | pass | 0 | 647 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "d7f6b832d94247f3aba4d7dc68ec134f35d661b3"
  }
```
...
```json
{
    ...
    "releaseArtifactHygieneScannedFiles": 116
  }
```
