...
- generatedAt: 2026-05-24T03:24:31.556Z
- branch: codex/main-retention-gap-artifact-sync
- verifiedCommit: 69eed14c1798143333cabceb84d622334fe4fa35
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 188 |
| `npm run smoke:identity-session-admin` | pass | 0 | 184 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 159 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 155 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 151 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 160 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 186 |
| `npm run smoke:customer-support-operations` | pass | 0 | 214 |
| `npm run smoke:support-escalation-review` | pass | 0 | 214 |
| `npm run smoke:target-support-architecture` | pass | 0 | 216 |
| `npm run smoke:target-support-operations` | pass | 0 | 210 |
| `npm run smoke:secret-management` | pass | 0 | 177 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 159 |
| `npm run smoke:target-secret-manager` | pass | 0 | 157 |
| `npm run smoke:observability-telemetry` | pass | 0 | 151 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 158 |
| `npm run smoke:target-observability-operations` | pass | 0 | 150 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 147 |
| `npm run smoke:target-slo-operations` | pass | 0 | 154 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 148 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 154 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 162 |
| `npm run smoke:target-retention-operations` | pass | 0 | 174 |
| `npm run smoke:target-backup-operations` | pass | 0 | 149 |
| `npm run smoke:production-slo-operating` | pass | 0 | 144 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1362 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "69eed14c1798143333cabceb84d622334fe4fa35"
  }
```
