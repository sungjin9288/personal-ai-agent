...
- generatedAt: 2026-08-05T06:20:41.229Z
- branch: codex/f1-review-projection-clock-determinism
- verifiedCommit: 7b6f937369675d6d557a443eecc74e5c589ff099
...
| `npm run smoke:target-identity-session-operations` | pass | 0 | 102 |
...
| `npm run smoke:support-escalation-review` | pass | 0 | 111 |
...
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 108 |
...
| `npm run smoke:target-retention-operations` | pass | 0 | 233 |
| `npm run smoke:target-backup-operations` | pass | 0 | 123 |
| `npm run smoke:production-slo-operating` | pass | 0 | 114 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1344 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 112 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 112 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 139 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 104 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 108 |
...
| `npm run smoke:production-retention-operating` | pass | 0 | 110 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 105 |
| `npm run smoke:execution-v1-status` | pass | 0 | 507 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 535 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 156 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 159 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 380 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "7b6f937369675d6d557a443eecc74e5c589ff099"
  }
```
