...
- generatedAt: 2026-07-13T20:48:26.068Z
- branch: main
- verifiedCommit: e60ab4fdfd002363c523de834c6ce74d154b7ab2
...
| `npm run smoke:support-escalation-review` | pass | 0 | 93 |
| `npm run smoke:target-support-architecture` | pass | 0 | 92 |
| `npm run smoke:target-support-operations` | pass | 0 | 94 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "e60ab4fdfd002363c523de834c6ce74d154b7ab2"
  }
```
