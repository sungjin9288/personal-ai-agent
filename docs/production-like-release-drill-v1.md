...
- generatedAt: 2026-07-22T00:16:39.086Z
- branch: codex/f2c19-host-restart-receipt
- verifiedCommit: 32326ca64baa4fff0ac60072ebad37ad9b434df2
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 130 |
| `npm run smoke:identity-session-admin` | pass | 0 | 133 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 141 |
...
| `npm run smoke:secret-management` | pass | 0 | 120 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 123 |
| `npm run smoke:target-secret-manager` | pass | 0 | 124 |
...
| `npm run smoke:target-slo-operations` | pass | 0 | 138 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 123 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 138 |
...
| `npm run smoke:target-provider-operations` | pass | 0 | 120 |
...
| `npm run smoke:execution-v1-status` | pass | 0 | 459 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 294 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "32326ca64baa4fff0ac60072ebad37ad9b434df2"
  }
```
