...
- generatedAt: 2026-07-22T07:21:23.316Z
...
| `npm run smoke:tenant-storage-admin` | pass | 0 | 94 |
...
| `npm run smoke:target-slo-operations` | pass | 0 | 97 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 96 |
...
| `npm run smoke:production-enterprise-controls` | pass | 0 | 124 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 103 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 102 |
...
| `npm run smoke:target-provider-operations` | pass | 0 | 98 |
...
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 310 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 107 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 111 |
| `npm run smoke:runtime-isolation` | pass | 0 | 524 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "12b2a02da070053fb5615c5759d03b551562b1bb"
  }
```
...
```json
{
    ...
    "releaseArtifactHygieneScannedFiles": 114
  }
```
