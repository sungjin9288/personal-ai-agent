...
- generatedAt: 2026-05-19T06:24:08.483Z
- branch: codex/target-support-architecture-stop-condition-wording
- verifiedCommit: 2d0576c9bbb184652d41e9f53b2b435d3c4ae9dc
...
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 131 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 135 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 133 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 144 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 127 |
| `npm run smoke:customer-support-operations` | pass | 0 | 127 |
| `npm run smoke:support-escalation-review` | pass | 0 | 123 |
| `npm run smoke:target-support-architecture` | pass | 0 | 121 |
| `npm run smoke:target-support-operations` | pass | 0 | 118 |
| `npm run smoke:secret-management` | pass | 0 | 118 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 120 |
| `npm run smoke:target-secret-manager` | pass | 0 | 118 |
| `npm run smoke:observability-telemetry` | pass | 0 | 118 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 117 |
| `npm run smoke:target-observability-operations` | pass | 0 | 121 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 120 |
| `npm run smoke:target-slo-operations` | pass | 0 | 117 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 118 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 117 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 120 |
| `npm run smoke:target-retention-operations` | pass | 0 | 117 |
| `npm run smoke:target-backup-operations` | pass | 0 | 118 |
| `npm run smoke:production-slo-operating` | pass | 0 | 118 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1311 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 139 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 141 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 150 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 174 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 182 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 183 |
| `npm run smoke:target-provider-operations` | pass | 0 | 142 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 153 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 168 |
| `npm run smoke:production-retention-operating` | pass | 0 | 162 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 209 |
| `npm run smoke:execution-v1-status` | pass | 0 | 621 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 302 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 310 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 205 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 463 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 180 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 211 |
| `npm run smoke:runtime-isolation` | pass | 0 | 765 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "2d0576c9bbb184652d41e9f53b2b435d3c4ae9dc"
  }
```
