...
- generatedAt: 2026-07-17T05:52:57.671Z
- branch: codex/q7-reviewer-action-generalization
- verifiedCommit: 95e00374731f393b207bfc0a8ae902aa5e396718
...
| `npm run smoke:production-slo-operating` | pass | 0 | 141 |
...
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 474 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "95e00374731f393b207bfc0a8ae902aa5e396718"
  }
```
...
```json
{
    ...
    "releaseArtifactHygieneScannedFiles": 100
  }
```
