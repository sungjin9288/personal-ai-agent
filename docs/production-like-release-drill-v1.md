...
- generatedAt: 2026-07-04T01:29:43.058Z
- branch: main
- verifiedCommit: 74d3ecdec3f875b5f4267276c1141e7c0676b6eb
...
| `npm run smoke:execution-v1-status` | pass | 0 | 449 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 336 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 453 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "d092407c0600046c12e31c17f49a6111de81b4d9"
  }
```
...
```json
{
    ...
    "runtimeRows": 8,
    "verifiedCommit": "d092407c0600046c12e31c17f49a6111de81b4d9"
  }
```
