...
- generatedAt: 2026-08-09T15:19:29.068Z
...
| `npm run smoke:identity-session-admin` | pass | 0 | 138 |
...
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 142 |
...
| `npm run smoke:target-support-operations` | pass | 0 | 128 |
| `npm run smoke:secret-management` | pass | 0 | 126 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 121 |
...
| `npm run smoke:target-provider-operations` | pass | 0 | 116 |
...
| `npm run smoke:clean-deployment-release` | pass | 0 | 131 |
| `npm run smoke:execution-v1-status` | pass | 0 | 458 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 280 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 642 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "316adac571a62202e5f2feca63f59edb7e5c8994"
  }
```
