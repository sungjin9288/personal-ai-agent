...
- generatedAt: 2026-05-31T15:52:27.307Z
- branch: codex/execution-v1-artifacts-a51a3ab-refresh
...
| `npm run smoke:identity-session-admin` | pass | 0 | 187 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 195 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 187 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 210 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 237 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 202 |
| `npm run smoke:customer-support-operations` | pass | 0 | 192 |
| `npm run smoke:support-escalation-review` | pass | 0 | 197 |
| `npm run smoke:target-support-architecture` | pass | 0 | 179 |
| `npm run smoke:target-support-operations` | pass | 0 | 185 |
| `npm run smoke:secret-management` | pass | 0 | 163 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 212 |
...
| `npm run smoke:target-observability-operations` | pass | 0 | 177 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 169 |
| `npm run smoke:target-slo-operations` | pass | 0 | 167 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 180 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 176 |
...
| `npm run smoke:production-slo-operating` | pass | 0 | 173 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1428 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 181 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 185 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 194 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 243 |
...
| `npm run smoke:execution-v1-status` | pass | 0 | 521 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 280 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 197 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 188 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 611 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "a51a3abfeb62a0deac1dfc0f2b07ceac8cfefed3"
  }
```
