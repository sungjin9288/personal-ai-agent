...
- generatedAt: 2026-07-27T18:25:25.122Z
- branch: codex/rag-evidence-gated-answer-shadow
- verifiedCommit: 9e69c94cfa4ea53915c80050099a80adc762b444
...
| `npm run smoke:target-support-architecture` | pass | 0 | 180 |
| `npm run smoke:target-support-operations` | pass | 0 | 222 |
...
| `npm run smoke:web-auth-rbac` | pass | 0 | 1358 |
...
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 155 |
| `npm run smoke:target-provider-operations` | pass | 0 | 155 |
...
| `npm run smoke:execution-v1-status` | pass | 0 | 472 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "9e69c94cfa4ea53915c80050099a80adc762b444"
  }
```
