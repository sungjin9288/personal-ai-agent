...
- generatedAt: 2026-05-20T01:23:47.531Z
- branch: codex/anthropic-open-blocker-stop-condition-wording
- verifiedCommit: 5e6ac5a659de75fe17ce0bf2494239b34951be35
...
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 183 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 175 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 159 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 130 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 133 |
| `npm run smoke:customer-support-operations` | pass | 0 | 132 |
| `npm run smoke:support-escalation-review` | pass | 0 | 133 |
| `npm run smoke:target-support-architecture` | pass | 0 | 136 |
| `npm run smoke:target-support-operations` | pass | 0 | 145 |
| `npm run smoke:secret-management` | pass | 0 | 144 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 137 |
| `npm run smoke:target-secret-manager` | pass | 0 | 129 |
| `npm run smoke:observability-telemetry` | pass | 0 | 134 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 136 |
| `npm run smoke:target-observability-operations` | pass | 0 | 145 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 147 |
| `npm run smoke:target-slo-operations` | pass | 0 | 141 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 142 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 135 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 130 |
| `npm run smoke:target-retention-operations` | pass | 0 | 131 |
| `npm run smoke:target-backup-operations` | pass | 0 | 131 |
| `npm run smoke:production-slo-operating` | pass | 0 | 131 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1323 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 134 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 141 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 133 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 135 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 134 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 136 |
| `npm run smoke:target-provider-operations` | pass | 0 | 135 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 140 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 134 |
| `npm run smoke:production-retention-operating` | pass | 0 | 128 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 145 |
| `npm run smoke:execution-v1-status` | pass | 0 | 434 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 226 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 143 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 575 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "5e6ac5a659de75fe17ce0bf2494239b34951be35"
  }
```
