...
- generatedAt: 2026-07-22T23:48:05.309Z
- branch: codex/f1-8-private-collection-workspace
- verifiedCommit: 30d8022d013dfe38094c2c3292c05fd5bc4bfb18
...
| `npm run smoke:target-identity-session-operations` | pass | 0 | 204 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 195 |
...
| `npm run smoke:support-escalation-review` | pass | 0 | 186 |
...
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 263 |
| `npm run smoke:target-secret-manager` | pass | 0 | 158 |
| `npm run smoke:observability-telemetry` | pass | 0 | 189 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 162 |
| `npm run smoke:target-observability-operations` | pass | 0 | 176 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 169 |
| `npm run smoke:target-slo-operations` | pass | 0 | 204 |
...
| `npm run smoke:web-auth-rbac` | pass | 0 | 1431 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 137 |
...
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 136 |
...
| `npm run smoke:execution-v1-status` | pass | 0 | 569 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 582 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 185 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 165 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 388 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 132 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 136 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "30d8022d013dfe38094c2c3292c05fd5bc4bfb18"
  }
```
