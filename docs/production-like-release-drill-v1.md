...
- generatedAt: 2026-07-22T14:21:36.613Z
- branch: codex/f1-1-training-data-sufficiency
- verifiedCommit: cc19deb60f3d6f948f5be7b1991df532298be922
...
| `npm run smoke:target-identity-session-operations` | pass | 0 | 161 |
...
| `npm run smoke:secret-management` | pass | 0 | 163 |
...
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 124 |
...
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 112 |
| `npm run smoke:target-provider-operations` | pass | 0 | 132 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 113 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 137 |
| `npm run smoke:production-retention-operating` | pass | 0 | 153 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 152 |
| `npm run smoke:execution-v1-status` | pass | 0 | 559 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 601 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 159 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 148 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 389 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 126 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 184 |
| `npm run smoke:runtime-isolation` | pass | 0 | 683 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "cc19deb60f3d6f948f5be7b1991df532298be922"
  }
```
...
```json
{
    ...
    "releaseArtifactHygieneScannedFiles": 119
  }
```
