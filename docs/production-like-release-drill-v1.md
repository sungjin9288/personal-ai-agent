...
- generatedAt: 2026-07-22T05:08:47.783Z
- branch: codex/f2c21-training-recovery
- verifiedCommit: ed5878406eff1538a3ff9bf1dc716d85f764ca49
...
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 258 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 236 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 205 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 239 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 217 |
...
| `npm run smoke:secret-management` | pass | 0 | 199 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 145 |
| `npm run smoke:target-secret-manager` | pass | 0 | 144 |
...
| `npm run smoke:execution-v1-status` | pass | 0 | 529 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 586 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 158 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 167 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 383 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "ed5878406eff1538a3ff9bf1dc716d85f764ca49"
  }
```
...
```json
{
    ...
    "releaseArtifactHygieneScannedFiles": 112
  }
```
