...
- generatedAt: 2026-05-26T11:54:56.866Z
- branch: codex/target-environment-provider-closure-proof-detail
- verifiedCommit: 1cde255f931295e68003f8a8517e9731197fc733
...
| `npm run smoke:execution-v1-status` | pass | 0 | 394 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "1cde255f931295e68003f8a8517e9731197fc733"
  }
```
