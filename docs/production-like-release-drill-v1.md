...
- generatedAt: 2026-05-12T04:12:31.222Z
- branch: codex/post-merge-provider-account-artifact-sync
- verifiedCommit: 35ed1b3ea49b0b247fcec6de0ba55c9b9233d686
...
| `npm run smoke:web-auth-rbac` | pass | 0 | 1269 |
...
| `npm run smoke:target-provider-operations` | pass | 0 | 91 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 90 |
...
| `npm run smoke:execution-v1-status` | pass | 0 | 358 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 115 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 98 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 94 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 243 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 109 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 113 |
| `npm run smoke:runtime-isolation` | pass | 0 | 402 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "35ed1b3ea49b0b247fcec6de0ba55c9b9233d686"
  }
```
