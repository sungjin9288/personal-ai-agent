...
- generatedAt: 2026-07-20T16:07:53.800Z
...
| `npm run smoke:support-escalation-review` | pass | 0 | 117 |
...
| `npm run smoke:target-backup-operations` | pass | 0 | 308 |
| `npm run smoke:production-slo-operating` | pass | 0 | 141 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1389 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 119 |
...
| `npm run smoke:retention-delete-policy` | pass | 0 | 198 |
| `npm run smoke:production-retention-operating` | pass | 0 | 186 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 160 |
| `npm run smoke:execution-v1-status` | pass | 0 | 611 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 865 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 797 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "c04f4e4f3761069d64c3fe3ad135355ab6ce5140"
  }
```
