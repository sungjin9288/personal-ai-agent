...
- generatedAt: 2026-05-12T11:58:41.164Z
- branch: codex/target-environment-blocker-disposition
- verifiedCommit: aa0594dfbd4d04577e9aa5f1a223688776655245
...
| `npm run smoke:runtime-isolation` | pass | 0 | 468 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "aa0594dfbd4d04577e9aa5f1a223688776655245"
  }
```
