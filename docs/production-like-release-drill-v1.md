...
- generatedAt: 2026-07-15T09:26:32.249Z
- branch: main
- verifiedCommit: da31346c92723062be7ffe99034806b1a23ac7b0
...
| `npm run smoke:target-support-architecture` | pass | 0 | 93 |
...
| `npm run smoke:observability-telemetry` | pass | 0 | 105 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 105 |
| `npm run smoke:target-observability-operations` | pass | 0 | 97 |
...
| `npm run smoke:production-provider-readiness` | pass | 0 | 94 |
...
| `npm run smoke:production-readiness-gate` | pass | 0 | 103 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "da31346c92723062be7ffe99034806b1a23ac7b0"
  }
```
