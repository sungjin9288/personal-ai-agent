...
- generatedAt: 2026-07-27T01:55:37.016Z
- branch: codex/council-read-model-board
- verifiedCommit: 4bfaef9f6e103e95e02bad3a8e637fc0a8f7e077
...
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 146 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 146 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 153 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 173 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 143 |
| `npm run smoke:customer-support-operations` | pass | 0 | 147 |
| `npm run smoke:support-escalation-review` | pass | 0 | 132 |
| `npm run smoke:target-support-architecture` | pass | 0 | 151 |
| `npm run smoke:target-support-operations` | pass | 0 | 152 |
| `npm run smoke:secret-management` | pass | 0 | 146 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 181 |
| `npm run smoke:target-secret-manager` | pass | 0 | 141 |
| `npm run smoke:observability-telemetry` | pass | 0 | 139 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 152 |
| `npm run smoke:target-observability-operations` | pass | 0 | 235 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 153 |
| `npm run smoke:target-slo-operations` | pass | 0 | 145 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 139 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 144 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 148 |
| `npm run smoke:target-retention-operations` | pass | 0 | 154 |
| `npm run smoke:target-backup-operations` | pass | 0 | 156 |
| `npm run smoke:production-slo-operating` | pass | 0 | 151 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1407 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 181 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 177 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 179 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 162 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 170 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 185 |
| `npm run smoke:target-provider-operations` | pass | 0 | 187 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 203 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 180 |
| `npm run smoke:production-retention-operating` | pass | 0 | 178 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 192 |
| `npm run smoke:execution-v1-status` | pass | 0 | 865 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 936 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 269 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 201 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 535 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 197 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 168 |
| `npm run smoke:runtime-isolation` | pass | 0 | 795 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "4bfaef9f6e103e95e02bad3a8e637fc0a8f7e077"
  }
```
