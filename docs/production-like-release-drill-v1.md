...
- generatedAt: 2026-07-29T06:58:23.148Z
...
| `npm run smoke:identity-session-admin` | pass | 0 | 121 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 114 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 132 |
...
| `npm run smoke:customer-support-operations` | pass | 0 | 110 |
| `npm run smoke:support-escalation-review` | pass | 0 | 115 |
| `npm run smoke:target-support-architecture` | pass | 0 | 112 |
| `npm run smoke:target-support-operations` | pass | 0 | 114 |
| `npm run smoke:secret-management` | pass | 0 | 112 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 119 |
| `npm run smoke:target-secret-manager` | pass | 0 | 121 |
| `npm run smoke:observability-telemetry` | pass | 0 | 135 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 121 |
| `npm run smoke:target-observability-operations` | pass | 0 | 123 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 118 |
| `npm run smoke:target-slo-operations` | pass | 0 | 118 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 139 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 118 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 115 |
| `npm run smoke:target-retention-operations` | pass | 0 | 114 |
| `npm run smoke:target-backup-operations` | pass | 0 | 120 |
| `npm run smoke:production-slo-operating` | pass | 0 | 114 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1310 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 123 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 116 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 117 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 112 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 115 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 117 |
| `npm run smoke:target-provider-operations` | pass | 0 | 113 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 116 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 113 |
| `npm run smoke:production-retention-operating` | pass | 0 | 112 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 123 |
| `npm run smoke:execution-v1-status` | pass | 0 | 445 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 345 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 155 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 143 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 351 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 139 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 140 |
| `npm run smoke:runtime-isolation` | pass | 0 | 606 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "ee8323226a3b7b64490e0a770f0ebe2ad85bb55f"
  }
```
