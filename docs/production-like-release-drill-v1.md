...
- generatedAt: 2026-07-16T13:25:34.613Z
- branch: codex/rag-retrieval-robustness
- verifiedCommit: f59b0a3a5c3a07090acd5cc1a94d7b5a7dfb958e
...
| `npm run smoke:identity-session-admin` | pass | 0 | 165 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 162 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 181 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 174 |
...
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 196 |
| `npm run smoke:target-secret-manager` | pass | 0 | 188 |
| `npm run smoke:observability-telemetry` | pass | 0 | 166 |
...
| `npm run smoke:production-retention-operating` | pass | 0 | 156 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 165 |
| `npm run smoke:execution-v1-status` | pass | 0 | 605 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 626 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 843 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "f59b0a3a5c3a07090acd5cc1a94d7b5a7dfb958e"
  }
```
...
```json
{
    ...
    "releaseArtifactHygieneScannedFiles": 67
  }
```
