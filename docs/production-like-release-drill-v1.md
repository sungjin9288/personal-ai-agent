...
- generatedAt: 2026-05-12T01:16:13.052Z
- branch: codex/post-merge-execution-v1-artifact-sync
- verifiedCommit: af533049869fc3b03f46e637e8ed7c2634a5334b
...
| `npm run smoke:identity-session-admin` | pass | 0 | 112 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 121 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 119 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 142 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 125 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 124 |
| `npm run smoke:customer-support-operations` | pass | 0 | 144 |
| `npm run smoke:support-escalation-review` | pass | 0 | 164 |
| `npm run smoke:target-support-architecture` | pass | 0 | 143 |
| `npm run smoke:target-support-operations` | pass | 0 | 155 |
| `npm run smoke:secret-management` | pass | 0 | 141 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 129 |
| `npm run smoke:target-secret-manager` | pass | 0 | 119 |
| `npm run smoke:observability-telemetry` | pass | 0 | 117 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 122 |
| `npm run smoke:target-observability-operations` | pass | 0 | 120 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 133 |
| `npm run smoke:target-slo-operations` | pass | 0 | 144 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 120 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 120 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 114 |
| `npm run smoke:target-retention-operations` | pass | 0 | 116 |
| `npm run smoke:target-backup-operations` | pass | 0 | 129 |
| `npm run smoke:production-slo-operating` | pass | 0 | 115 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1291 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 129 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 119 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 115 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 120 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 115 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 148 |
| `npm run smoke:target-provider-operations` | pass | 0 | 122 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 114 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 147 |
| `npm run smoke:production-retention-operating` | pass | 0 | 119 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 133 |
| `npm run smoke:execution-v1-status` | pass | 0 | 376 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 138 |
...
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 116 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 121 |
| `npm run smoke:runtime-isolation` | pass | 0 | 448 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "af533049869fc3b03f46e637e8ed7c2634a5334b"
  }
```
