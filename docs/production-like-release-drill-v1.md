...
- generatedAt: 2026-07-30T02:24:54.594Z
- branch: codex/council-concurrent-schedule-shadow
- verifiedCommit: 05e5daa76c82d3204be9fbf7adac342c8bff653f
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 141 |
| `npm run smoke:identity-session-admin` | pass | 0 | 128 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 115 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 127 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 120 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 122 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 115 |
| `npm run smoke:customer-support-operations` | pass | 0 | 121 |
| `npm run smoke:support-escalation-review` | pass | 0 | 119 |
| `npm run smoke:target-support-architecture` | pass | 0 | 112 |
| `npm run smoke:target-support-operations` | pass | 0 | 115 |
| `npm run smoke:secret-management` | pass | 0 | 112 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 111 |
| `npm run smoke:target-secret-manager` | pass | 0 | 114 |
| `npm run smoke:observability-telemetry` | pass | 0 | 119 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 116 |
| `npm run smoke:target-observability-operations` | pass | 0 | 110 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 112 |
| `npm run smoke:target-slo-operations` | pass | 0 | 110 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 117 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 113 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 104 |
| `npm run smoke:target-retention-operations` | pass | 0 | 108 |
| `npm run smoke:target-backup-operations` | pass | 0 | 109 |
| `npm run smoke:production-slo-operating` | pass | 0 | 106 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1303 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 115 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 126 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 126 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 123 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 113 |
...
| `npm run smoke:production-retention-operating` | pass | 0 | 114 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 130 |
| `npm run smoke:execution-v1-status` | pass | 0 | 536 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 642 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 181 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 156 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 355 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 119 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 123 |
| `npm run smoke:runtime-isolation` | pass | 0 | 584 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "05e5daa76c82d3204be9fbf7adac342c8bff653f"
  }
```
