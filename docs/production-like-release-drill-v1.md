...
- generatedAt: 2026-07-13T06:35:54.314Z
- branch: main
- verifiedCommit: 60051946eaae484d68f9ffeb73b74ca859731b43
...
| `npm run smoke:target-secret-manager` | pass | 0 | 128 |
...
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 116 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 118 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 123 |
...
| `npm run smoke:clean-deployment-release` | pass | 0 | 121 |
| `npm run smoke:execution-v1-status` | pass | 0 | 423 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 252 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "60051946eaae484d68f9ffeb73b74ca859731b43"
  }
```
