...
- generatedAt: 2026-07-13T20:05:54.094Z
- branch: main
- verifiedCommit: 8563a486c3b0e4356e60ba27e5c282193915448d
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 89 |
| `npm run smoke:identity-session-admin` | pass | 0 | 92 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 94 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 93 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 91 |
...
| `npm run smoke:target-secret-manager` | pass | 0 | 91 |
| `npm run smoke:observability-telemetry` | pass | 0 | 91 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 91 |
...
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 91 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 93 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 93 |
| `npm run smoke:target-retention-operations` | pass | 0 | 92 |
| `npm run smoke:target-backup-operations` | pass | 0 | 94 |
| `npm run smoke:production-slo-operating` | pass | 0 | 92 |
...
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 96 |
...
| `npm run smoke:retention-delete-policy` | pass | 0 | 90 |
| `npm run smoke:production-retention-operating` | pass | 0 | 91 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 95 |
| `npm run smoke:execution-v1-status` | pass | 0 | 379 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 211 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 102 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 96 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 272 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 104 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "8563a486c3b0e4356e60ba27e5c282193915448d"
  }
```
