...
- generatedAt: 2026-05-04T16:02:05.727Z
...
| `npm run smoke:execution-v1-status` | pass | 0 | 366 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "613d8a375099eba74ac7d26790049131a8c4abf2"
  }
```
...
```json
{
    ...
    "releaseArtifactHygieneScannedFiles": 14
  }
```
