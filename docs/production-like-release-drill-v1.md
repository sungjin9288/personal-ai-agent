...
- generatedAt: 2026-05-12T16:43:34.808Z
- branch: codex/post-merge-provider-intake-closure-artifact-sync
- verifiedCommit: 0568717609f24e835e05963756a828a00f73f554
...
| `npm run smoke:identity-session-admin` | pass | 0 | 171 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 176 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 179 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 205 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 193 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 180 |
| `npm run smoke:customer-support-operations` | pass | 0 | 169 |
| `npm run smoke:support-escalation-review` | pass | 0 | 163 |
| `npm run smoke:target-support-architecture` | pass | 0 | 163 |
| `npm run smoke:target-support-operations` | pass | 0 | 153 |
| `npm run smoke:secret-management` | pass | 0 | 154 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 154 |
| `npm run smoke:target-secret-manager` | pass | 0 | 159 |
...
| `npm run smoke:target-slo-operations` | pass | 0 | 182 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 188 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 263 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 175 |
| `npm run smoke:target-retention-operations` | pass | 0 | 176 |
| `npm run smoke:target-backup-operations` | pass | 0 | 179 |
| `npm run smoke:production-slo-operating` | pass | 0 | 190 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1401 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 155 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 153 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 158 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 165 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 159 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 156 |
...
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 454 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 188 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "0568717609f24e835e05963756a828a00f73f554"
  }
```
