...
- generatedAt: 2026-07-23T06:09:10.329Z
- branch: codex/f1-12-private-item-review-projection
- verifiedCommit: 49a2a02500da4147cd043ddd9ff725d4f9d1580e
...
| `npm run smoke:identity-session-admin` | pass | 0 | 143 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 132 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 143 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 125 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 124 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 193 |
| `npm run smoke:customer-support-operations` | pass | 0 | 148 |
...
| `npm run smoke:target-secret-manager` | pass | 0 | 137 |
| `npm run smoke:observability-telemetry` | pass | 0 | 116 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 151 |
| `npm run smoke:target-observability-operations` | pass | 0 | 142 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 131 |
| `npm run smoke:target-slo-operations` | pass | 0 | 120 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 135 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 123 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 139 |
| `npm run smoke:target-retention-operations` | pass | 0 | 127 |
| `npm run smoke:target-backup-operations` | pass | 0 | 117 |
| `npm run smoke:production-slo-operating` | pass | 0 | 171 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1399 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 130 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 116 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 138 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 125 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 123 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 123 |
| `npm run smoke:target-provider-operations` | pass | 0 | 123 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 162 |
...
| `npm run smoke:execution-v1-status` | pass | 0 | 551 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 589 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 219 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 170 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 428 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 164 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 173 |
| `npm run smoke:runtime-isolation` | pass | 0 | 739 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "49a2a02500da4147cd043ddd9ff725d4f9d1580e"
  }
```
