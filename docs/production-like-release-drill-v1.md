...
- generatedAt: 2026-05-24T01:53:15.573Z
- branch: codex/main-observability-slo-ui-artifact-sync
- verifiedCommit: 3a9bb7fd180443121133c771c2cd4a62e5ea825f
...
| `npm run smoke:identity-session-admin` | pass | 0 | 169 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 169 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 175 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 170 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 174 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 185 |
| `npm run smoke:customer-support-operations` | pass | 0 | 205 |
| `npm run smoke:support-escalation-review` | pass | 0 | 211 |
| `npm run smoke:target-support-architecture` | pass | 0 | 210 |
| `npm run smoke:target-support-operations` | pass | 0 | 207 |
| `npm run smoke:secret-management` | pass | 0 | 172 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 146 |
| `npm run smoke:target-secret-manager` | pass | 0 | 149 |
| `npm run smoke:observability-telemetry` | pass | 0 | 143 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 147 |
| `npm run smoke:target-observability-operations` | pass | 0 | 146 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 145 |
| `npm run smoke:target-slo-operations` | pass | 0 | 144 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 161 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 171 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 175 |
| `npm run smoke:target-retention-operations` | pass | 0 | 171 |
| `npm run smoke:target-backup-operations` | pass | 0 | 177 |
| `npm run smoke:production-slo-operating` | pass | 0 | 170 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1387 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 177 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 173 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 184 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 209 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 209 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 207 |
| `npm run smoke:target-provider-operations` | pass | 0 | 209 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 181 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 150 |
| `npm run smoke:production-retention-operating` | pass | 0 | 151 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 148 |
| `npm run smoke:execution-v1-status` | pass | 0 | 438 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 193 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 163 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 152 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 365 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 157 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 165 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "3a9bb7fd180443121133c771c2cd4a62e5ea825f"
  }
```
