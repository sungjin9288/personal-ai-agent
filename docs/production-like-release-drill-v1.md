...
- generatedAt: 2026-07-23T08:52:28.782Z
- branch: codex/f1-14-private-item-artifact-request
- verifiedCommit: d538aff4da5ea9250b1a7c761f3318c88bd32ce3
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 140 |
...
| `npm run smoke:target-support-architecture` | pass | 0 | 123 |
...
| `npm run smoke:production-enterprise-controls` | pass | 0 | 196 |
...
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 127 |
| `npm run smoke:target-provider-operations` | pass | 0 | 136 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 171 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 148 |
| `npm run smoke:production-retention-operating` | pass | 0 | 136 |
...
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 136 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 133 |
| `npm run smoke:runtime-isolation` | pass | 0 | 662 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "d538aff4da5ea9250b1a7c761f3318c88bd32ce3"
  }
```
