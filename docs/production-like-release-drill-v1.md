...
- generatedAt: 2026-05-12T11:43:00.305Z
- branch: codex/target-environment-submission-packet
- verifiedCommit: e240d67ee5b4071e7ca621ddb0bbd5a17a2c5673
...
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 129 |
| `npm run smoke:target-retention-operations` | pass | 0 | 115 |
...
| `npm run smoke:target-openai-provider-account` | pass | 0 | 128 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 168 |
...
| `npm run smoke:production-retention-operating` | pass | 0 | 133 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 133 |
| `npm run smoke:execution-v1-status` | pass | 0 | 381 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 152 |
...
| `npm run smoke:backup-restore-drill` | pass | 0 | 146 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "e240d67ee5b4071e7ca621ddb0bbd5a17a2c5673"
  }
```
