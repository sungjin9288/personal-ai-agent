...
- generatedAt: 2026-07-22T20:24:49.740Z
- branch: codex/f1-7-collection-execution-resolution
- verifiedCommit: f003f37d9974805c68d3dd2eff153a1db905500c
...
| `npm run smoke:runtime-isolation` | pass | 0 | 521 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "f003f37d9974805c68d3dd2eff153a1db905500c"
  }
```
