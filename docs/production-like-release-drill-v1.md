...
- generatedAt: 2026-07-15T18:14:01.301Z
- branch: codex/d4-5-mission-run-catalog
- verifiedCommit: a93a40ebabe98702d4f1ad0d3ae5c33b04cf0eb1
...
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 101 |
...
| `npm run smoke:clean-deployment-release` | pass | 0 | 127 |
| `npm run smoke:execution-v1-status` | pass | 0 | 612 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 559 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 122 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 118 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 359 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 243 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 167 |
| `npm run smoke:runtime-isolation` | pass | 0 | 727 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "a93a40ebabe98702d4f1ad0d3ae5c33b04cf0eb1"
  }
```
