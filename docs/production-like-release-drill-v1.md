...
- generatedAt: 2026-07-16T22:22:42.349Z
- branch: codex/workspace-learning-operator-surface
- verifiedCommit: fe7276a05734e1d29056c0e0ad61349742107a4f
...
| `npm run smoke:target-observability-architecture` | pass | 0 | 95 |
...
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 107 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 136 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 93 |
| `npm run smoke:target-retention-operations` | pass | 0 | 93 |
| `npm run smoke:target-backup-operations` | pass | 0 | 92 |
| `npm run smoke:production-slo-operating` | pass | 0 | 95 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1282 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 101 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 95 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 93 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 93 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 93 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 92 |
| `npm run smoke:target-provider-operations` | pass | 0 | 93 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 93 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 92 |
| `npm run smoke:production-retention-operating` | pass | 0 | 91 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 97 |
| `npm run smoke:execution-v1-status` | pass | 0 | 386 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 224 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 108 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 103 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 302 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 109 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 109 |
| `npm run smoke:runtime-isolation` | pass | 0 | 486 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "fe7276a05734e1d29056c0e0ad61349742107a4f"
  }
```
...
```json
{
    ...
    "releaseArtifactHygieneScannedFiles": 83
  }
```
