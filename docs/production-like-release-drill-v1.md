...
- generatedAt: 2026-07-28T01:17:01.608Z
- branch: codex/local-artifact-writer-hardening
- verifiedCommit: 96ddccb91ca89d9cd65c6713d38d3b13a13aa6f8
...
| `npm run smoke:identity-session-admin` | pass | 0 | 104 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 110 |
...
| `npm run smoke:secret-management` | pass | 0 | 99 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "96ddccb91ca89d9cd65c6713d38d3b13a13aa6f8"
  }
```
