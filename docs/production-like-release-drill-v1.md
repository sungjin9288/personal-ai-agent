...
- generatedAt: 2026-05-19T13:08:09.604Z
- branch: codex/target-anthropic-provider-account-stop-condition-wording
- verifiedCommit: 6c5eeedf3ab0909fb1a5332e669b2f894295a8f7
...
| `npm run smoke:execution-v1-status` | pass | 0 | 368 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 136 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 431 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "6c5eeedf3ab0909fb1a5332e669b2f894295a8f7"
  }
```
