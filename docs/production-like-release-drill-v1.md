...
- generatedAt: 2026-05-26T12:18:29.887Z
- branch: codex/main-target-environment-provider-closure-artifact-sync
- verifiedCommit: 70dbfd3028e2e271b1eeff626f5e57d5725bbb20
...
| `npm run smoke:target-backup-operations` | pass | 0 | 138 |
...
| `npm run smoke:production-provider-readiness` | pass | 0 | 143 |
...
| `npm run smoke:clean-deployment-release` | pass | 0 | 146 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "70dbfd3028e2e271b1eeff626f5e57d5725bbb20"
  }
```
