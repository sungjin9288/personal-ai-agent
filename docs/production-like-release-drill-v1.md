...
- generatedAt: 2026-07-04T02:03:51.685Z
- branch: main
- verifiedCommit: 0f0680c120ce74dd0540fc52a932459c55bc8a69
...
| `npm run smoke:identity-session-admin` | pass | 0 | 100 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 99 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 99 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 98 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 99 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 100 |
| `npm run smoke:customer-support-operations` | pass | 0 | 99 |
| `npm run smoke:support-escalation-review` | pass | 0 | 99 |
| `npm run smoke:target-support-architecture` | pass | 0 | 99 |
| `npm run smoke:target-support-operations` | pass | 0 | 116 |
| `npm run smoke:secret-management` | pass | 0 | 98 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 100 |
| `npm run smoke:target-secret-manager` | pass | 0 | 99 |
| `npm run smoke:observability-telemetry` | pass | 0 | 98 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 99 |
| `npm run smoke:target-observability-operations` | pass | 0 | 99 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 99 |
| `npm run smoke:target-slo-operations` | pass | 0 | 100 |
...
| `npm run smoke:target-retention-operations` | pass | 0 | 99 |
| `npm run smoke:target-backup-operations` | pass | 0 | 98 |
| `npm run smoke:production-slo-operating` | pass | 0 | 99 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1285 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 125 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 103 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 138 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 102 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 101 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 100 |
| `npm run smoke:target-provider-operations` | pass | 0 | 100 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 101 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 99 |
| `npm run smoke:production-retention-operating` | pass | 0 | 99 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 107 |
| `npm run smoke:execution-v1-status` | pass | 0 | 429 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 245 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 110 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 105 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 290 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 115 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 117 |
| `npm run smoke:runtime-isolation` | pass | 0 | 470 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "68dc4d8b4c9398933a6a9e944c7be7c364ac397e"
  }
```
...
```json
{
    ...
    "runtimeRows": 8,
    "verifiedCommit": "68dc4d8b4c9398933a6a9e944c7be7c364ac397e"
  }
```
