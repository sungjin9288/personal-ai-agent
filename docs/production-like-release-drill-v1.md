...
- generatedAt: 2026-07-16T20:25:02.342Z
...
| `npm run smoke:target-observability-operations` | pass | 0 | 91 |
...
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 99 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "42e3758ed45da56233f3a2c4954f40aa3fe5191d"
  }
```
...
```json
{
    ...
    "releaseArtifactHygieneScannedFiles": 80
  }
```
