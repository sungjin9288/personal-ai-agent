...
- generatedAt: 2026-05-23T15:22:33.997Z
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 153 |
...
| `npm run smoke:target-support-architecture` | pass | 0 | 135 |
| `npm run smoke:target-support-operations` | pass | 0 | 139 |
...
| `npm run smoke:target-backup-operations` | pass | 0 | 127 |
...
| `npm run smoke:production-provider-readiness` | pass | 0 | 132 |
...
| `npm run smoke:target-provider-operations` | pass | 0 | 146 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 144 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 131 |
| `npm run smoke:production-retention-operating` | pass | 0 | 134 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "4ba2c88dcbbd9c94b71316d04f2cd1a428a7e790"
  }
```
