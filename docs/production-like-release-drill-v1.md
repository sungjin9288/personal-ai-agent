...
- generatedAt: 2026-05-12T12:03:34.987Z
- branch: codex/post-merge-blocker-disposition-artifact-sync
- verifiedCommit: e58f6f89deae0fc253963a7ae9af00923f9b9d9b
...
| `npm run smoke:target-support-operations` | pass | 0 | 122 |
| `npm run smoke:secret-management` | pass | 0 | 127 |
...
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 324 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "e58f6f89deae0fc253963a7ae9af00923f9b9d9b"
  }
```
