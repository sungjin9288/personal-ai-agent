...
- generatedAt: 2026-07-29T03:43:02.055Z
- branch: codex/council-chair-synthesis-contract-shadow
- verifiedCommit: 8a42a749876cc3d504c37fbcbd196ee52834a2b4
...
| `npm run smoke:target-identity-session-operations` | pass | 0 | 118 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 114 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 139 |
...
| `npm run smoke:target-slo-architecture` | pass | 0 | 130 |
| `npm run smoke:target-slo-operations` | pass | 0 | 126 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 124 |
...
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 122 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 129 |
...
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 185 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 738 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "8a42a749876cc3d504c37fbcbd196ee52834a2b4"
  }
```
