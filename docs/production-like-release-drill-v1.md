...
- generatedAt: 2026-05-31T16:22:47.052Z
- branch: codex/execution-v1-artifacts-1ee61d2-refresh
- verifiedCommit: 1ee61d2b82ae601659f2afd35bc599b00817918c
...
| `npm run smoke:identity-session-admin` | pass | 0 | 186 |
...
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 186 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 158 |
| `npm run smoke:customer-support-operations` | pass | 0 | 161 |
| `npm run smoke:support-escalation-review` | pass | 0 | 146 |
| `npm run smoke:target-support-architecture` | pass | 0 | 152 |
| `npm run smoke:target-support-operations` | pass | 0 | 177 |
| `npm run smoke:secret-management` | pass | 0 | 167 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 163 |
| `npm run smoke:target-secret-manager` | pass | 0 | 138 |
| `npm run smoke:observability-telemetry` | pass | 0 | 149 |
...
| `npm run smoke:target-slo-operations` | pass | 0 | 143 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 147 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 133 |
...
| `npm run smoke:production-slo-operating` | pass | 0 | 146 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1385 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 214 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 210 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 214 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 218 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 227 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 212 |
| `npm run smoke:target-provider-operations` | pass | 0 | 215 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 213 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 192 |
| `npm run smoke:production-retention-operating` | pass | 0 | 205 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 213 |
| `npm run smoke:execution-v1-status` | pass | 0 | 578 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 397 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 196 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 206 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 553 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 220 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 240 |
| `npm run smoke:runtime-isolation` | pass | 0 | 743 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "1ee61d2b82ae601659f2afd35bc599b00817918c"
  }
```
