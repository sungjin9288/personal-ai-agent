...
- generatedAt: 2026-08-05T00:23:18.080Z
- branch: codex/local-v1-public-release-source-binding
- verifiedCommit: 2e87073bf4cbab069a958f522dfb74d8332f59ec
...
| `npm run smoke:target-identity-session-operations` | pass | 0 | 163 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 263 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 225 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 185 |
| `npm run smoke:customer-support-operations` | pass | 0 | 167 |
| `npm run smoke:support-escalation-review` | pass | 0 | 181 |
| `npm run smoke:target-support-architecture` | pass | 0 | 181 |
| `npm run smoke:target-support-operations` | pass | 0 | 173 |
| `npm run smoke:secret-management` | pass | 0 | 171 |
...
| `npm run smoke:target-observability-architecture` | pass | 0 | 183 |
| `npm run smoke:target-observability-operations` | pass | 0 | 187 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 167 |
| `npm run smoke:target-slo-operations` | pass | 0 | 185 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 173 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 193 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 204 |
| `npm run smoke:target-retention-operations` | pass | 0 | 190 |
| `npm run smoke:target-backup-operations` | pass | 0 | 198 |
| `npm run smoke:production-slo-operating` | pass | 0 | 220 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1642 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 166 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 159 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 157 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 173 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 207 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 204 |
| `npm run smoke:target-provider-operations` | pass | 0 | 214 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 281 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 197 |
| `npm run smoke:production-retention-operating` | pass | 0 | 174 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 204 |
| `npm run smoke:execution-v1-status` | pass | 0 | 796 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 793 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 252 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 213 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 534 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 192 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 187 |
| `npm run smoke:runtime-isolation` | pass | 0 | 1156 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "2e87073bf4cbab069a958f522dfb74d8332f59ec"
  }
```
