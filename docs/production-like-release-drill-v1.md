...
- generatedAt: 2026-08-02T23:55:13.998Z
- branch: codex/council-concurrent-envelope-shadow
- verifiedCommit: 7099a44f5459e2af91ab7f6062bea5e6317e368b
...
| `npm run smoke:identity-session-admin` | pass | 0 | 120 |
...
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 203 |
...
| `npm run smoke:secret-management` | pass | 0 | 140 |
...
| `npm run smoke:target-slo-operations` | pass | 0 | 121 |
...
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 121 |
| `npm run smoke:target-provider-operations` | pass | 0 | 133 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 132 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 121 |
| `npm run smoke:production-retention-operating` | pass | 0 | 113 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 120 |
| `npm run smoke:execution-v1-status` | pass | 0 | 525 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 596 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 166 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 146 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 374 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 128 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 131 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "7099a44f5459e2af91ab7f6062bea5e6317e368b"
  }
```
