...
- generatedAt: 2026-05-13T15:01:55.879Z
- branch: codex/post-merge-release-blocker-triage-artifact-sync
- verifiedCommit: 9cbad8f1b4197b678dc66c010c8e2a2726c7b88b
...
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 117 |
...
| `npm run smoke:execution-v1-status` | pass | 0 | 412 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "9cbad8f1b4197b678dc66c010c8e2a2726c7b88b"
  }
```
