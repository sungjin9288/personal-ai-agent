...
- generatedAt: 2026-05-22T17:31:21.859Z
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 127 |
| `npm run smoke:identity-session-admin` | pass | 0 | 127 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 125 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 136 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 141 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 140 |
...
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 141 |
...
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 145 |
| `npm run smoke:target-retention-operations` | pass | 0 | 144 |
| `npm run smoke:target-backup-operations` | pass | 0 | 147 |
...
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 147 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 564 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "42a9fa13a00448b4a28a17251ff5eb9901f876a8"
  }
```
