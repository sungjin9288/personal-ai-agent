...
- generatedAt: 2026-07-16T19:07:09.677Z
...
| `npm run smoke:runtime-isolation` | pass | 0 | 499 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "0a0d2a7e5edf2aeaf61e6c48dd3d5666a1f7d4c3"
  }
```
...
```json
{
    ...
    "releaseArtifactHygieneScannedFiles": 78
  }
```
