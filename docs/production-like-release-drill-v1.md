...
- generatedAt: 2026-05-12T04:40:07.194Z
- branch: codex/post-merge-target-environment-artifact-sync
- verifiedCommit: 559e59f4e4c6102305ac033ba746812fa9ab7fb9
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 114 |
| `npm run smoke:identity-session-admin` | pass | 0 | 105 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 106 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 107 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 108 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 111 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 114 |
| `npm run smoke:customer-support-operations` | pass | 0 | 112 |
| `npm run smoke:support-escalation-review` | pass | 0 | 110 |
| `npm run smoke:target-support-architecture` | pass | 0 | 108 |
| `npm run smoke:target-support-operations` | pass | 0 | 108 |
| `npm run smoke:secret-management` | pass | 0 | 111 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 111 |
| `npm run smoke:target-secret-manager` | pass | 0 | 106 |
| `npm run smoke:observability-telemetry` | pass | 0 | 103 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 103 |
| `npm run smoke:target-observability-operations` | pass | 0 | 103 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 106 |
| `npm run smoke:target-slo-operations` | pass | 0 | 105 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 115 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 116 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 104 |
| `npm run smoke:target-retention-operations` | pass | 0 | 102 |
| `npm run smoke:target-backup-operations` | pass | 0 | 105 |
| `npm run smoke:production-slo-operating` | pass | 0 | 104 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1290 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 117 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 104 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 106 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 134 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 131 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 118 |
| `npm run smoke:target-provider-operations` | pass | 0 | 118 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 117 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 115 |
| `npm run smoke:production-retention-operating` | pass | 0 | 118 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 130 |
| `npm run smoke:execution-v1-status` | pass | 0 | 391 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 178 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 124 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 119 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 294 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 121 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 122 |
| `npm run smoke:runtime-isolation` | pass | 0 | 449 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "559e59f4e4c6102305ac033ba746812fa9ab7fb9"
  }
```
