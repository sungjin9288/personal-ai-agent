...
- generatedAt: 2026-05-12T11:06:28.810Z
- branch: codex/post-merge-identity-session-artifact-sync
- verifiedCommit: 71d90264dd2e7920c59c3956ca3ae0381468413c
...
| `npm run smoke:production-enterprise-controls` | pass | 0 | 150 |
...
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 161 |
...
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 175 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "71d90264dd2e7920c59c3956ca3ae0381468413c"
  }
```
