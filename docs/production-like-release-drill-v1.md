...
- generatedAt: 2026-05-13T04:56:27.196Z
- branch: codex/post-merge-fallback-policy-help-artifact-sync
- verifiedCommit: 5b0ea8d8a1132476dc85256a99647e494445bda4
...
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 134 |
...
| `npm run smoke:target-support-operations` | pass | 0 | 146 |
...
| `npm run smoke:observability-telemetry` | pass | 0 | 162 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 154 |
| `npm run smoke:target-observability-operations` | pass | 0 | 142 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 135 |
| `npm run smoke:target-slo-operations` | pass | 0 | 133 |
...
| `npm run smoke:target-retention-operations` | pass | 0 | 123 |
| `npm run smoke:target-backup-operations` | pass | 0 | 122 |
| `npm run smoke:production-slo-operating` | pass | 0 | 122 |
...
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 131 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 121 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 130 |
| `npm run smoke:target-provider-operations` | pass | 0 | 138 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 124 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 122 |
| `npm run smoke:production-retention-operating` | pass | 0 | 123 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 128 |
| `npm run smoke:execution-v1-status` | pass | 0 | 413 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 176 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 132 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 140 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 377 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 154 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 154 |
| `npm run smoke:runtime-isolation` | pass | 0 | 515 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "5b0ea8d8a1132476dc85256a99647e494445bda4"
  }
```
