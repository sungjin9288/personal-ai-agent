...
- generatedAt: 2026-07-23T10:59:41.400Z
- branch: codex/f1-15-private-item-artifact-preparation-resolution
- verifiedCommit: f41df850e9cf24497ca8c6e3f6647df1272a2ba7
...
| `npm run smoke:target-backup-operations` | pass | 0 | 125 |
| `npm run smoke:production-slo-operating` | pass | 0 | 119 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1339 |
...
| `npm run smoke:retention-delete-policy` | pass | 0 | 111 |
| `npm run smoke:production-retention-operating` | pass | 0 | 112 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 138 |
| `npm run smoke:execution-v1-status` | pass | 0 | 691 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 609 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 165 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 133 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 342 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 113 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 113 |
| `npm run smoke:runtime-isolation` | pass | 0 | 578 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "f41df850e9cf24497ca8c6e3f6647df1272a2ba7"
  }
```
