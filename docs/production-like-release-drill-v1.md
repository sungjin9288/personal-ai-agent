...
- generatedAt: 2026-07-20T03:17:14.332Z
- branch: codex/f2c10-candidate-artifact-verification
- verifiedCommit: 269fc47e69662b6bad00476032530559684ca473
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 100 |
| `npm run smoke:identity-session-admin` | pass | 0 | 97 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 107 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 99 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 98 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 96 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 98 |
| `npm run smoke:customer-support-operations` | pass | 0 | 102 |
| `npm run smoke:support-escalation-review` | pass | 0 | 98 |
| `npm run smoke:target-support-architecture` | pass | 0 | 95 |
| `npm run smoke:target-support-operations` | pass | 0 | 101 |
| `npm run smoke:secret-management` | pass | 0 | 108 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 113 |
| `npm run smoke:target-secret-manager` | pass | 0 | 97 |
| `npm run smoke:observability-telemetry` | pass | 0 | 98 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 99 |
| `npm run smoke:target-observability-operations` | pass | 0 | 96 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 96 |
| `npm run smoke:target-slo-operations` | pass | 0 | 95 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 99 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 99 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 103 |
...
| `npm run smoke:web-auth-rbac` | pass | 0 | 1300 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 98 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 96 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 99 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 99 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 102 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 103 |
| `npm run smoke:target-provider-operations` | pass | 0 | 99 |
...
| `npm run smoke:clean-deployment-release` | pass | 0 | 105 |
| `npm run smoke:execution-v1-status` | pass | 0 | 661 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 826 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 152 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 128 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 312 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 110 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 112 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "269fc47e69662b6bad00476032530559684ca473"
  }
```
...
```json
{
    ...
    "releaseArtifactHygieneScannedFiles": 108
  }
```
