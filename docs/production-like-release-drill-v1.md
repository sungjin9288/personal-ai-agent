...
- generatedAt: 2026-07-30T00:09:47.059Z
...
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 128 |
...
| `npm run smoke:target-support-architecture` | pass | 0 | 126 |
| `npm run smoke:target-support-operations` | pass | 0 | 141 |
| `npm run smoke:secret-management` | pass | 0 | 139 |
...
| `npm run smoke:clean-deployment-release` | pass | 0 | 139 |
| `npm run smoke:execution-v1-status` | pass | 0 | 590 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 665 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 309 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 263 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 578 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 264 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "49586b6179382f005bedecfb578f792707e4fcad"
  }
```
