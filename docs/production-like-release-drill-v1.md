...
- generatedAt: 2026-05-18T15:08:12.673Z
- branch: codex/target-slo-operations-stop-condition-wording
- verifiedCommit: 4eaeebb351f3d0e6c63b19c190dc48c81e84ef64
...
| `npm run smoke:tenant-storage-admin` | pass | 0 | 114 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 114 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 114 |
| `npm run smoke:customer-support-operations` | pass | 0 | 168 |
| `npm run smoke:support-escalation-review` | pass | 0 | 140 |
...
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 234 |
| `npm run smoke:target-secret-manager` | pass | 0 | 183 |
| `npm run smoke:observability-telemetry` | pass | 0 | 170 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 170 |
| `npm run smoke:target-observability-operations` | pass | 0 | 139 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 125 |
| `npm run smoke:target-slo-operations` | pass | 0 | 142 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 131 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 129 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 122 |
| `npm run smoke:target-retention-operations` | pass | 0 | 129 |
| `npm run smoke:target-backup-operations` | pass | 0 | 135 |
| `npm run smoke:production-slo-operating` | pass | 0 | 135 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1353 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 136 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 135 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 156 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 141 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 195 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 258 |
| `npm run smoke:target-provider-operations` | pass | 0 | 183 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 130 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 135 |
| `npm run smoke:production-retention-operating` | pass | 0 | 145 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 211 |
| `npm run smoke:execution-v1-status` | pass | 0 | 500 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 281 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 203 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 220 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 368 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "f795e6e61d432969f03fc694d200941bfcbe2437"
  }
```
...
```json
{
    ...
    "runtimeRows": 8,
    "verifiedCommit": "f795e6e61d432969f03fc694d200941bfcbe2437"
  }
```
