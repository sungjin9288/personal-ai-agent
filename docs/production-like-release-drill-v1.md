...
- generatedAt: 2026-07-27T00:43:30.658Z
- branch: codex/council-contract-stub-runtime
- verifiedCommit: ccf76cf7a5220eb821cf9aeb57a772229767e3ef
...
| `npm run smoke:observability-telemetry` | pass | 0 | 123 |
...
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 116 |
| `npm run smoke:target-retention-operations` | pass | 0 | 119 |
| `npm run smoke:target-backup-operations` | pass | 0 | 111 |
| `npm run smoke:production-slo-operating` | pass | 0 | 120 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1313 |
...
| `npm run smoke:clean-deployment-release` | pass | 0 | 122 |
| `npm run smoke:execution-v1-status` | pass | 0 | 431 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 291 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 158 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "ccf76cf7a5220eb821cf9aeb57a772229767e3ef"
  }
```
