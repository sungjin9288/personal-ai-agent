...
- generatedAt: 2026-07-16T23:19:49.301Z
- branch: codex/local-user-learning-conflict-revocation
- verifiedCommit: 3d6dcc91c818bced495b303211835baaa65aae47
...
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 89 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 89 |
...
| `npm run smoke:target-slo-architecture` | pass | 0 | 89 |
...
| `npm run smoke:target-backup-operations` | pass | 0 | 88 |
| `npm run smoke:production-slo-operating` | pass | 0 | 89 |
...
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 89 |
...
| `npm run smoke:retention-delete-policy` | pass | 0 | 89 |
...
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 285 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 101 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "3d6dcc91c818bced495b303211835baaa65aae47"
  }
```
...
```json
{
    ...
    "releaseArtifactHygieneScannedFiles": 85
  }
```
