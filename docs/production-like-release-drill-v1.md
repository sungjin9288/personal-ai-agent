...
- generatedAt: 2026-07-16T07:32:52.887Z
- branch: codex/rag-retrieval-evaluation
- verifiedCommit: 0bc124a18d31571998ce9bcf4e2946c87d3fd03e
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 104 |
| `npm run smoke:identity-session-admin` | pass | 0 | 105 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 99 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 97 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 99 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 100 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 100 |
| `npm run smoke:customer-support-operations` | pass | 0 | 101 |
| `npm run smoke:support-escalation-review` | pass | 0 | 99 |
| `npm run smoke:target-support-architecture` | pass | 0 | 99 |
| `npm run smoke:target-support-operations` | pass | 0 | 106 |
| `npm run smoke:secret-management` | pass | 0 | 100 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 99 |
| `npm run smoke:target-secret-manager` | pass | 0 | 99 |
| `npm run smoke:observability-telemetry` | pass | 0 | 99 |
...
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 102 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 104 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 119 |
| `npm run smoke:target-retention-operations` | pass | 0 | 103 |
...
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 97 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 99 |
| `npm run smoke:target-provider-operations` | pass | 0 | 99 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 100 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 99 |
| `npm run smoke:production-retention-operating` | pass | 0 | 98 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 105 |
| `npm run smoke:execution-v1-status` | pass | 0 | 489 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 481 |
...
| `npm run smoke:backup-restore-drill` | pass | 0 | 116 |
| `npm run smoke:runtime-isolation` | pass | 0 | 513 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "0bc124a18d31571998ce9bcf4e2946c87d3fd03e"
  }
```
