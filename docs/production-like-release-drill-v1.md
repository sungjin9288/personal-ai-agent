...
- generatedAt: 2026-05-23T15:36:31.447Z
...
| `npm run smoke:tenant-storage-admin` | pass | 0 | 121 |
...
| `npm run smoke:target-provider-operations` | pass | 0 | 128 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 132 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 123 |
| `npm run smoke:production-retention-operating` | pass | 0 | 131 |
...
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 332 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "e24f08314e918f5d1fd9933f0179d81bb49d1000"
  }
```
