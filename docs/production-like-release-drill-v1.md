...
- generatedAt: 2026-07-28T06:26:42.580Z
- branch: codex/smoke-all-idempotency
- verifiedCommit: ea504b9c46afda7935473e40e8c56b765c5e0f42
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 166 |
| `npm run smoke:identity-session-admin` | pass | 0 | 161 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 166 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 194 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 182 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 150 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 168 |
| `npm run smoke:customer-support-operations` | pass | 0 | 161 |
| `npm run smoke:support-escalation-review` | pass | 0 | 232 |
| `npm run smoke:target-support-architecture` | pass | 0 | 293 |
| `npm run smoke:target-support-operations` | pass | 0 | 309 |
| `npm run smoke:secret-management` | pass | 0 | 273 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 254 |
| `npm run smoke:target-secret-manager` | pass | 0 | 248 |
| `npm run smoke:observability-telemetry` | pass | 0 | 280 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 219 |
| `npm run smoke:target-observability-operations` | pass | 0 | 176 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 335 |
| `npm run smoke:target-slo-operations` | pass | 0 | 278 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 236 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 223 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 273 |
| `npm run smoke:target-retention-operations` | pass | 0 | 225 |
| `npm run smoke:target-backup-operations` | pass | 0 | 251 |
| `npm run smoke:production-slo-operating` | pass | 0 | 243 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1680 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 332 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 302 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 278 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 341 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 245 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 289 |
| `npm run smoke:target-provider-operations` | pass | 0 | 371 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 316 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 252 |
| `npm run smoke:production-retention-operating` | pass | 0 | 272 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 249 |
| `npm run smoke:execution-v1-status` | pass | 0 | 1004 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 1549 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 424 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 314 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 1133 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 370 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 386 |
| `npm run smoke:runtime-isolation` | pass | 0 | 1929 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "ea504b9c46afda7935473e40e8c56b765c5e0f42"
  }
```
