...
- generatedAt: 2026-07-13T14:41:34.683Z
- branch: main
- verifiedCommit: 038df559c5f3ea7876ba075564de52a886cad668
...
| `npm run smoke:tenant-storage-admin` | pass | 0 | 88 |
...
| `npm run smoke:observability-telemetry` | pass | 0 | 88 |
...
| `npm run smoke:target-provider-operations` | pass | 0 | 89 |
...
| `npm run smoke:clean-deployment-release` | pass | 0 | 93 |
| `npm run smoke:execution-v1-status` | pass | 0 | 379 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 205 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 99 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 93 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 267 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 101 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 105 |
| `npm run smoke:runtime-isolation` | pass | 0 | 436 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "038df559c5f3ea7876ba075564de52a886cad668"
  }
```
