...
- generatedAt: 2026-08-10T08:48:22.962Z
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 242 |
| `npm run smoke:identity-session-admin` | pass | 0 | 266 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 255 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 256 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 252 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 271 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 256 |
| `npm run smoke:customer-support-operations` | pass | 0 | 285 |
| `npm run smoke:support-escalation-review` | pass | 0 | 266 |
| `npm run smoke:target-support-architecture` | pass | 0 | 301 |
| `npm run smoke:target-support-operations` | pass | 0 | 246 |
| `npm run smoke:secret-management` | pass | 0 | 255 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 251 |
| `npm run smoke:target-secret-manager` | pass | 0 | 328 |
| `npm run smoke:observability-telemetry` | pass | 0 | 253 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 255 |
| `npm run smoke:target-observability-operations` | pass | 0 | 236 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 249 |
| `npm run smoke:target-slo-operations` | pass | 0 | 241 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 237 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 305 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 244 |
| `npm run smoke:target-retention-operations` | pass | 0 | 261 |
| `npm run smoke:target-backup-operations` | pass | 0 | 254 |
| `npm run smoke:production-slo-operating` | pass | 0 | 276 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 2014 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 318 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 386 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 325 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 364 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 386 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 595 |
| `npm run smoke:target-provider-operations` | pass | 0 | 609 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 551 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 513 |
| `npm run smoke:production-retention-operating` | pass | 0 | 438 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 416 |
| `npm run smoke:execution-v1-status` | pass | 0 | 3594 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 4018 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 699 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 558 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 1664 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 419 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 386 |
| `npm run smoke:runtime-isolation` | pass | 0 | 1891 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "db5d2ccc570be2ce831b068df341db3edb7683fb"
  }
```
