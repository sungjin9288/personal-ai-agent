...
- generatedAt: 2026-07-16T09:14:53.669Z
- branch: codex/rag-semantic-retrieval-experiment
- verifiedCommit: 4b4849e45be00bd4c2ec352dd81311a20e845385
...
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 118 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 120 |
| `npm run smoke:customer-support-operations` | pass | 0 | 120 |
| `npm run smoke:support-escalation-review` | pass | 0 | 129 |
| `npm run smoke:target-support-architecture` | pass | 0 | 124 |
| `npm run smoke:target-support-operations` | pass | 0 | 125 |
| `npm run smoke:secret-management` | pass | 0 | 121 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 117 |
| `npm run smoke:target-secret-manager` | pass | 0 | 117 |
| `npm run smoke:observability-telemetry` | pass | 0 | 118 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 126 |
| `npm run smoke:target-observability-operations` | pass | 0 | 125 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 122 |
| `npm run smoke:target-slo-operations` | pass | 0 | 123 |
...
| `npm run smoke:production-slo-operating` | pass | 0 | 110 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1312 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 123 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 122 |
...
| `npm run smoke:retention-delete-policy` | pass | 0 | 120 |
| `npm run smoke:production-retention-operating` | pass | 0 | 119 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 124 |
| `npm run smoke:execution-v1-status` | pass | 0 | 537 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 550 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 122 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 122 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 346 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 130 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 135 |
| `npm run smoke:runtime-isolation` | pass | 0 | 569 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "4b4849e45be00bd4c2ec352dd81311a20e845385"
  }
```
