...
- generatedAt: 2026-05-12T11:16:01.789Z
- branch: codex/target-tenant-isolation-evidence-template
- verifiedCommit: a7190c7ccbfc045910f51513768ca5569222d015
...
| `npm run smoke:secret-management` | pass | 0 | 155 |
...
| `npm run smoke:target-observability-architecture` | pass | 0 | 153 |
| `npm run smoke:target-observability-operations` | pass | 0 | 149 |
...
| `npm run smoke:target-openai-provider-account` | pass | 0 | 116 |
...
| `npm run smoke:production-retention-operating` | pass | 0 | 138 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 163 |
| `npm run smoke:execution-v1-status` | pass | 0 | 427 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 180 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 140 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 141 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 492 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "a7190c7ccbfc045910f51513768ca5569222d015"
  }
```
