...
- generatedAt: 2026-07-17T02:12:16.253Z
- branch: codex/local-training-permission-surface
- verifiedCommit: aaab77cf48cf391f6c0bbb6ce22117105bd378cf
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 106 |
| `npm run smoke:identity-session-admin` | pass | 0 | 104 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 100 |
...
| `npm run smoke:support-escalation-review` | pass | 0 | 105 |
| `npm run smoke:target-support-architecture` | pass | 0 | 102 |
| `npm run smoke:target-support-operations` | pass | 0 | 103 |
| `npm run smoke:secret-management` | pass | 0 | 109 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 148 |
| `npm run smoke:target-secret-manager` | pass | 0 | 123 |
| `npm run smoke:observability-telemetry` | pass | 0 | 100 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 106 |
| `npm run smoke:target-observability-operations` | pass | 0 | 112 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 107 |
| `npm run smoke:target-slo-operations` | pass | 0 | 102 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 103 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 100 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 97 |
| `npm run smoke:target-retention-operations` | pass | 0 | 112 |
| `npm run smoke:target-backup-operations` | pass | 0 | 98 |
| `npm run smoke:production-slo-operating` | pass | 0 | 100 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1301 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 149 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 114 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 126 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 128 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 109 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 107 |
| `npm run smoke:target-provider-operations` | pass | 0 | 105 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 111 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 112 |
| `npm run smoke:production-retention-operating` | pass | 0 | 125 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 107 |
| `npm run smoke:execution-v1-status` | pass | 0 | 545 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 552 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 162 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 137 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 352 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 117 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 140 |
| `npm run smoke:runtime-isolation` | pass | 0 | 583 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "aaab77cf48cf391f6c0bbb6ce22117105bd378cf"
  }
```
...
```json
{
    ...
    "releaseArtifactHygieneScannedFiles": 91
  }
```
