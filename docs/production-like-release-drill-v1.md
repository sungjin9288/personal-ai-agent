...
- generatedAt: 2026-05-24T07:08:08.574Z
- branch: codex/main-hosted-identity-gap-artifact-sync
- verifiedCommit: 38c62e4f7cd48dfe9fe532541e265994e68fabb2
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 151 |
...
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 149 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 152 |
...
| `npm run smoke:target-secret-manager` | pass | 0 | 146 |
...
| `npm run smoke:production-provider-readiness` | pass | 0 | 147 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 154 |
...
| `npm run smoke:retention-delete-policy` | pass | 0 | 151 |
| `npm run smoke:production-retention-operating` | pass | 0 | 148 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 154 |
| `npm run smoke:execution-v1-status` | pass | 0 | 434 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 260 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 231 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 310 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 530 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 220 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 209 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "38c62e4f7cd48dfe9fe532541e265994e68fabb2"
  }
```
