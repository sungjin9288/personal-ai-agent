...
- generatedAt: 2026-05-12T11:01:03.491Z
- branch: codex/target-identity-session-evidence-template
- verifiedCommit: 81af2f84a4c5f84d859c44b353f0084337f4371b
...
| `npm run smoke:target-secret-manager` | pass | 0 | 126 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "81af2f84a4c5f84d859c44b353f0084337f4371b"
  }
```
