...
- generatedAt: 2026-08-03T05:37:58.443Z
- branch: codex/public-release-asset-identity
- verifiedCommit: da6b9f39a566dc96223d99f4887bae53cecd3425
...
| `npm run smoke:identity-session-admin` | pass | 0 | 227 |
...
| `npm run smoke:target-observability-architecture` | pass | 0 | 130 |
...
| `npm run smoke:retention-delete-policy` | pass | 0 | 132 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "da6b9f39a566dc96223d99f4887bae53cecd3425"
  }
```
