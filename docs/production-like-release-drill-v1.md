...
- generatedAt: 2026-05-18T11:23:31.220Z
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 225 |
| `npm run smoke:identity-session-admin` | pass | 0 | 215 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 216 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 201 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 224 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 259 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 218 |
| `npm run smoke:customer-support-operations` | pass | 0 | 208 |
| `npm run smoke:support-escalation-review` | pass | 0 | 206 |
| `npm run smoke:target-support-architecture` | pass | 0 | 213 |
| `npm run smoke:target-support-operations` | pass | 0 | 206 |
| `npm run smoke:secret-management` | pass | 0 | 202 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 201 |
| `npm run smoke:target-secret-manager` | pass | 0 | 212 |
| `npm run smoke:observability-telemetry` | pass | 0 | 203 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 198 |
| `npm run smoke:target-observability-operations` | pass | 0 | 201 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 203 |
| `npm run smoke:target-slo-operations` | pass | 0 | 206 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 214 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 213 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 196 |
| `npm run smoke:target-retention-operations` | pass | 0 | 197 |
| `npm run smoke:target-backup-operations` | pass | 0 | 207 |
| `npm run smoke:production-slo-operating` | pass | 0 | 202 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1447 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 203 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 200 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 211 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 209 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 203 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 202 |
| `npm run smoke:target-provider-operations` | pass | 0 | 197 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 194 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 204 |
| `npm run smoke:production-retention-operating` | pass | 0 | 203 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 210 |
| `npm run smoke:execution-v1-status` | pass | 0 | 549 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 304 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 213 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 213 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 510 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 242 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 246 |
