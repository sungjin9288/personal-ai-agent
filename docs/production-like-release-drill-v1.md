...
- generatedAt: 2026-07-20T05:59:50.711Z
- branch: codex/f2c13-immutable-evaluation-inputs
- verifiedCommit: 87ef1970b00dc6a623ec5df3d15c22bb02a30993
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 370 |
| `npm run smoke:identity-session-admin` | pass | 0 | 260 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 316 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 372 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 247 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 121 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 127 |
| `npm run smoke:customer-support-operations` | pass | 0 | 139 |
| `npm run smoke:support-escalation-review` | pass | 0 | 298 |
| `npm run smoke:target-support-architecture` | pass | 0 | 563 |
| `npm run smoke:target-support-operations` | pass | 0 | 1774 |
| `npm run smoke:secret-management` | pass | 0 | 558 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 400 |
| `npm run smoke:target-secret-manager` | pass | 0 | 469 |
| `npm run smoke:observability-telemetry` | pass | 0 | 391 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 400 |
| `npm run smoke:target-observability-operations` | pass | 0 | 574 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 318 |
| `npm run smoke:target-slo-operations` | pass | 0 | 181 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 143 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 125 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 112 |
| `npm run smoke:target-retention-operations` | pass | 0 | 130 |
| `npm run smoke:target-backup-operations` | pass | 0 | 129 |
| `npm run smoke:production-slo-operating` | pass | 0 | 130 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1336 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 217 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 146 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 151 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 127 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 163 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 177 |
| `npm run smoke:target-provider-operations` | pass | 0 | 158 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 121 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 105 |
| `npm run smoke:production-retention-operating` | pass | 0 | 108 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 155 |
| `npm run smoke:execution-v1-status` | pass | 0 | 554 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 634 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 222 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 176 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 485 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 319 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 189 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "87ef1970b00dc6a623ec5df3d15c22bb02a30993"
  }
```
