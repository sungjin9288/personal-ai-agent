...
- generatedAt: 2026-05-25T14:10:58.197Z
- branch: codex/provider-boundary-proof-detail
- verifiedCommit: ff47e62ee655d8c1c961cbbf02f56b7cf0f65fb0
...
| `npm run smoke:identity-session-admin` | pass | 0 | 107 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 105 |
...
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 106 |
...
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 106 |
...
| `npm run smoke:target-observability-operations` | pass | 0 | 102 |
...
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 103 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 99 |
| `npm run smoke:target-retention-operations` | pass | 0 | 99 |
| `npm run smoke:target-backup-operations` | pass | 0 | 101 |
...
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 100 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "ff47e62ee655d8c1c961cbbf02f56b7cf0f65fb0"
  }
```
