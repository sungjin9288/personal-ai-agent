...
- generatedAt: 2026-07-23T01:11:38.932Z
- branch: codex/f1-9-private-collection-item-admission
- verifiedCommit: 2cad513257270b0d6000f744ab10e41e686f662f
...
| `npm run smoke:customer-support-operations` | pass | 0 | 171 |
...
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 158 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 163 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 141 |
| `npm run smoke:target-retention-operations` | pass | 0 | 131 |
| `npm run smoke:target-backup-operations` | pass | 0 | 137 |
| `npm run smoke:production-slo-operating` | pass | 0 | 166 |
...
| `npm run smoke:target-openai-provider-account` | pass | 0 | 132 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 172 |
...
| `npm run smoke:execution-v1-status` | pass | 0 | 617 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 637 |
...
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 131 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 121 |
| `npm run smoke:runtime-isolation` | pass | 0 | 716 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "2cad513257270b0d6000f744ab10e41e686f662f"
  }
```
