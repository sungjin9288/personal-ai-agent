...
- generatedAt: 2026-07-27T06:20:02.903Z
- branch: codex/council-research-evidence
- verifiedCommit: bc67392e65bf0e81bea46ee9aeb8515750ec9ce5
...
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 106 |
...
| `npm run smoke:clean-deployment-release` | pass | 0 | 108 |
| `npm run smoke:execution-v1-status` | pass | 0 | 421 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 244 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 146 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 142 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 372 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 127 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 122 |
| `npm run smoke:runtime-isolation` | pass | 0 | 581 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "bc67392e65bf0e81bea46ee9aeb8515750ec9ce5"
  }
```
