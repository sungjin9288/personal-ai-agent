...
- generatedAt: 2026-07-14T01:21:16.215Z
- branch: main
- verifiedCommit: 49e4db5dd16eb625391a90bff857cdad9eae57f2
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 96 |
| `npm run smoke:identity-session-admin` | pass | 0 | 101 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 98 |
...
| `npm run smoke:support-escalation-review` | pass | 0 | 96 |
...
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 96 |
| `npm run smoke:target-secret-manager` | pass | 0 | 100 |
| `npm run smoke:observability-telemetry` | pass | 0 | 97 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 97 |
...
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 96 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 98 |
| `npm run smoke:target-retention-operations` | pass | 0 | 100 |
| `npm run smoke:target-backup-operations` | pass | 0 | 103 |
| `npm run smoke:production-slo-operating` | pass | 0 | 97 |
...
| `npm run smoke:target-openai-provider-account` | pass | 0 | 95 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 95 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 94 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 96 |
| `npm run smoke:target-provider-operations` | pass | 0 | 94 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 97 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 101 |
| `npm run smoke:production-retention-operating` | pass | 0 | 97 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 105 |
| `npm run smoke:execution-v1-status` | pass | 0 | 392 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 228 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 107 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 100 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 280 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 112 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 112 |
| `npm run smoke:runtime-isolation` | pass | 0 | 459 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "49e4db5dd16eb625391a90bff857cdad9eae57f2"
  }
```
