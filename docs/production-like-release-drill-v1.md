...
- generatedAt: 2026-05-05T15:39:40.615Z
...
| `npm run smoke:production-provider-readiness` | pass | 0 | 134 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "a08bec457ca8887403a8cac04698dd624fb8ff47"
  }
```
...
```json
{
    ...
    "releaseArtifactHygieneScannedFiles": 30
  }
```
