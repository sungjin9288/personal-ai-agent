...
- generatedAt: 2026-07-13T05:40:32.105Z
- branch: main
- verifiedCommit: a5568df443cd8fab132206b5a9eaabc9e72f01eb
...
| `npm run smoke:identity-session-admin` | pass | 0 | 159 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 195 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 191 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 190 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 173 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 159 |
| `npm run smoke:customer-support-operations` | pass | 0 | 169 |
| `npm run smoke:support-escalation-review` | pass | 0 | 195 |
| `npm run smoke:target-support-architecture` | pass | 0 | 202 |
| `npm run smoke:target-support-operations` | pass | 0 | 180 |
| `npm run smoke:secret-management` | pass | 0 | 198 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 193 |
| `npm run smoke:target-secret-manager` | pass | 0 | 164 |
| `npm run smoke:observability-telemetry` | pass | 0 | 172 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 177 |
| `npm run smoke:target-observability-operations` | pass | 0 | 167 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 183 |
| `npm run smoke:target-slo-operations` | pass | 0 | 173 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 175 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 179 |
...
| `npm run smoke:production-slo-operating` | pass | 0 | 178 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1559 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 165 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 163 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 163 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 155 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 163 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 163 |
| `npm run smoke:target-provider-operations` | pass | 0 | 168 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 183 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 169 |
| `npm run smoke:production-retention-operating` | pass | 0 | 176 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 178 |
| `npm run smoke:execution-v1-status` | pass | 0 | 676 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 1318 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 179 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 178 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 459 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 226 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 238 |
| `npm run smoke:runtime-isolation` | pass | 0 | 790 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "a5568df443cd8fab132206b5a9eaabc9e72f01eb"
  }
```
...
```json
{
    ...
    "releaseArtifactHygieneScannedFiles": 65
  }
```
