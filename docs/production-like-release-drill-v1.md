...
- generatedAt: 2026-07-22T18:17:23.631Z
- branch: codex/f1-4-reviewed-data-intake-resolution
- verifiedCommit: 8015ec30cb7b4e6fa7af94e65b7bc27c87620f45
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 101 |
| `npm run smoke:identity-session-admin` | pass | 0 | 105 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 99 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 101 |
...
| `npm run smoke:customer-support-operations` | pass | 0 | 100 |
| `npm run smoke:support-escalation-review` | pass | 0 | 102 |
| `npm run smoke:target-support-architecture` | pass | 0 | 99 |
| `npm run smoke:target-support-operations` | pass | 0 | 104 |
| `npm run smoke:secret-management` | pass | 0 | 103 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 97 |
| `npm run smoke:target-secret-manager` | pass | 0 | 98 |
| `npm run smoke:observability-telemetry` | pass | 0 | 100 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 100 |
| `npm run smoke:target-observability-operations` | pass | 0 | 98 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 100 |
| `npm run smoke:target-slo-operations` | pass | 0 | 115 |
...
| `npm run smoke:target-backup-operations` | pass | 0 | 99 |
| `npm run smoke:production-slo-operating` | pass | 0 | 102 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1290 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 109 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 109 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 110 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 116 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 110 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 108 |
| `npm run smoke:target-provider-operations` | pass | 0 | 109 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 105 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 113 |
| `npm run smoke:production-retention-operating` | pass | 0 | 108 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 124 |
| `npm run smoke:execution-v1-status` | pass | 0 | 429 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 456 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 147 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 141 |
| `npm run smoke:runtime-data-lifecycle` | pass | 0 | 346 |
| `npm run smoke:tenant-data-lifecycle` | pass | 0 | 157 |
| `npm run smoke:backup-restore-drill` | pass | 0 | 137 |
| `npm run smoke:runtime-isolation` | pass | 0 | 638 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "8015ec30cb7b4e6fa7af94e65b7bc27c87620f45"
  }
```
