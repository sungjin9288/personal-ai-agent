...
- generatedAt: 2026-07-28T03:11:44.540Z
- branch: codex/claim-source-attribution-shadow
- verifiedCommit: ef605608eebf5b61a55068908ca0d6457356d800
...
| --- | --- | ---: | ---: |
| `npm run smoke:incident-slo-policy` | pass | 0 | 115 |
| `npm run smoke:identity-session-admin` | pass | 0 | 110 |
| `npm run smoke:hosted-identity-session-architecture` | pass | 0 | 112 |
| `npm run smoke:target-identity-session-operations` | pass | 0 | 131 |
| `npm run smoke:tenant-storage-admin` | pass | 0 | 178 |
| `npm run smoke:hosted-tenant-isolation-architecture` | pass | 0 | 141 |
| `npm run smoke:target-tenant-isolation-operations` | pass | 0 | 158 |
| `npm run smoke:customer-support-operations` | pass | 0 | 181 |
| `npm run smoke:support-escalation-review` | pass | 0 | 170 |
| `npm run smoke:target-support-architecture` | pass | 0 | 139 |
| `npm run smoke:target-support-operations` | pass | 0 | 121 |
| `npm run smoke:secret-management` | pass | 0 | 115 |
| `npm run smoke:target-secret-manager-architecture` | pass | 0 | 113 |
| `npm run smoke:target-secret-manager` | pass | 0 | 109 |
| `npm run smoke:observability-telemetry` | pass | 0 | 110 |
| `npm run smoke:target-observability-architecture` | pass | 0 | 169 |
| `npm run smoke:target-observability-operations` | pass | 0 | 145 |
| `npm run smoke:target-slo-architecture` | pass | 0 | 166 |
| `npm run smoke:target-slo-operations` | pass | 0 | 150 |
| `npm run smoke:target-data-lifecycle-architecture` | pass | 0 | 176 |
| `npm run smoke:target-clean-deployment-architecture` | pass | 0 | 144 |
| `npm run smoke:target-clean-deployment-operations` | pass | 0 | 125 |
| `npm run smoke:target-retention-operations` | pass | 0 | 122 |
| `npm run smoke:target-backup-operations` | pass | 0 | 134 |
| `npm run smoke:production-slo-operating` | pass | 0 | 113 |
| `npm run smoke:web-auth-rbac` | pass | 0 | 1309 |
| `npm run smoke:production-enterprise-controls` | pass | 0 | 100 |
| `npm run smoke:production-provider-readiness` | pass | 0 | 105 |
| `npm run smoke:target-openai-provider-account` | pass | 0 | 106 |
| `npm run smoke:target-anthropic-provider-account` | pass | 0 | 105 |
| `npm run smoke:target-local-provider-architecture` | pass | 0 | 126 |
| `npm run smoke:target-hermes-provider-architecture` | pass | 0 | 168 |
| `npm run smoke:target-provider-operations` | pass | 0 | 148 |
| `npm run smoke:target-deployment-contract` | pass | 0 | 142 |
| `npm run smoke:retention-delete-policy` | pass | 0 | 131 |
| `npm run smoke:production-retention-operating` | pass | 0 | 148 |
| `npm run smoke:clean-deployment-release` | pass | 0 | 142 |
| `npm run smoke:execution-v1-status` | pass | 0 | 499 |
| `npm run smoke:execution-v1-snapshot` | pass | 0 | 694 |
| `npm run smoke:production-readiness-gate` | pass | 0 | 220 |
| `npm run smoke:release-artifact-hygiene` | pass | 0 | 157 |
...
| `npm run smoke:runtime-isolation` | pass | 0 | 622 |
...
```json
{
    ...
    "runtimeRows": 8,
    "snapshotCommit": "ef605608eebf5b61a55068908ca0d6457356d800"
  }
```
