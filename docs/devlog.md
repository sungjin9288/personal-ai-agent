...
- kept the open-create quick action, Korean empty copy, API icon marker, fallback audit composition, and provider list action wiring unchanged
- extended UI learning promotion and harness browse smoke coverage for provider list empty-state delegation
...
- kept the jump-step quick action, Korean empty copy, CK icon marker, and output closeout action wiring unchanged
- extended UI learning promotion and harness browse smoke coverage for output closeout empty-state delegation
...
- kept sort/page-size selected states, control ids, reset action metadata, disabled state, and aria-label copy aligned with the existing memory browse wiring contract
- extended UI learning promotion and harness browse smoke coverage for memory browse controls renderer delegation
...
- kept source label, role list, retrieval reason fallback, snippet summary, and empty-preview copy aligned with the existing render contract
- extended UI learning promotion and harness browse smoke coverage for retrieval preview list renderer delegation
...
- kept search, scope, kind, sort, page size, and current page dirty-state rules aligned with the existing render contract
- extended UI learning promotion smoke coverage for memory browse view model delegation
...
- kept candidate lookup, rollback note prompt, rollback payload construction, mission reload, approval reload, and selected mission refresh behavior aligned with the existing learning promotion contract
- extended UI learning promotion smoke coverage for rollback wiring delegation

## 2026-06-16 Action Inbox Learning Promotion Expire Wiring

- moved action inbox pending learning promotion expiration click wiring onto a dedicated wiring helper
- kept candidate lookup, confirmation copy, expiration note prompt, expiration payload construction, mission reload, approval reload, and selected mission refresh behavior aligned with the existing learning promotion contract
- extended UI learning promotion smoke coverage for expire wiring delegation
...
- kept primary remediation, fallback remediation, recoverable-only fallback confirmation, payload construction, mission reload, approval reload, and selected mission refresh behavior aligned with the existing action inbox contract
- extended UI learning promotion smoke coverage for provider attention wiring delegation
...
- kept recommended, fallback, recoverable-only, specialist route, and learning promotion detail rows aligned with the existing action item contract
- extended UI learning promotion smoke coverage for item command meta renderer delegation
...
- kept blueprint id data attribute, active pressed state, label/title text, visible blueprint metadata, recommended provider detail, specialist tags, and blueprint selection click wiring aligned with the existing agent blueprint contract
- extended UI harness browse smoke coverage for agent blueprint card renderer delegation and direct markup removal
...
- kept clear-release action ids, optional pressed state, data attributes, labels, titles, and visible copy unchanged
- reduced direct clear button markup across release focus and filter surfaces
- extended UI harness browse smoke coverage for release clear action renderer delegation
...
- reduced duplicated copied-state accessibility metadata in the final target evidence packet copy renderer group
- extended UI harness browse smoke coverage for target evidence packet base renderer delegation
...
- kept target evidence filter/provider-only scopes, copy-key generation, and click handler routing unchanged
- reduced duplicated copied-state accessibility metadata in the target evidence guard copy renderer group
- extended UI harness browse smoke coverage for target evidence guard base renderer delegation

## 2026-06-12 Release Target Evidence Register Base Renderer

- moved target evidence production gap, exception register, and risk decision register copy renderers onto the shared release copied-action button renderer
- kept target evidence filter/provider-only scopes, copy-key generation, and click handler routing unchanged
- reduced duplicated copied-state accessibility metadata in the first target evidence register copy renderer group
- extended UI harness browse smoke coverage for target evidence register base renderer delegation
...
- added aria-pressed metadata and copied-state styling to release handoff link copy buttons
- kept handoff preview/open URL generation, artifact routing, and clipboard fallback prompts unchanged
- extended UI harness browse smoke coverage for release handoff link copy-state contracts
...
- added aria-pressed metadata and copied-state styling to target evidence command rerun log copy buttons
- kept command rerun log text generation, shared-provider scoping, provider-only scoping, and clipboard fallback prompts unchanged
- extended UI harness browse smoke coverage for target evidence command rerun log copy-state contracts
...
- added aria-pressed metadata and copied-state styling to target evidence residual blockers copy buttons
- kept residual blockers text generation, shared-provider scoping, provider-only scoping, and clipboard fallback prompts unchanged
- extended UI harness browse smoke coverage for target evidence residual blockers copy-state contracts
...
- added aria-pressed metadata and copied-state styling to target evidence risk decision register copy buttons
- kept risk decision register text generation, shared-provider scoping, provider-only scoping, and clipboard fallback prompts unchanged
- extended UI harness browse smoke coverage for target evidence risk decision register copy-state contracts
...
- added aria-pressed metadata and copied-state styling to target evidence production gap copy buttons
- kept production gap text generation, shared-provider scoping, provider-only scoping, and clipboard fallback prompts unchanged
- extended UI harness browse smoke coverage for target evidence production gap copy-state contracts
...
- added aria-pressed metadata and copied-state styling to blocker slice commands copy buttons
- kept commands text generation, shared-provider scoping, provider-only scoping, and clipboard fallback prompts unchanged
- extended UI harness browse smoke coverage for release blocker slice commands copy-state contracts
...
- added aria-pressed metadata and copied-state styling to blocker slice package copy buttons
- kept package text generation, shared-provider scoping, provider-only scoping, and clipboard fallback prompts unchanged
- extended UI harness browse smoke coverage for release blocker slice package copy-state contracts

## 2026-06-11 Release Blocker API Link Copy Pressed Metadata

- moved release blocker API link and provider-only API link copy controls onto the shared release link copied-state renderer
- added aria-pressed metadata and copied-state styling to blocker API link copy buttons
- kept API URL generation, shared-provider scoping, provider-only scoping, and clipboard fallback prompts unchanged
- extended UI harness browse smoke coverage for release blocker API link copy-state contracts
...
- added aria-pressed metadata and copied-state styling to focused blocker and blocker row closure checklist copy buttons
- kept closure checklist text generation, blocker scoping, and clipboard fallback prompts unchanged
- extended UI harness browse smoke coverage for release blocker closure checklist copy-state contracts
...
- kept blocker focus routing, disabled current-blocker behavior, provider blocker shortcuts, and visible Korean copy unchanged
- extended UI harness browse smoke coverage for release blocker focus pressed-state contracts
...
- kept release flow filter routing, disabled current-flow behavior, provider focus callout actions, and visible Korean copy unchanged
- extended UI harness browse smoke coverage for release flow pressed-state contracts
...
- kept existing approval ids, mission ids, prompt flow, resolution handlers, and visible button copy unchanged
- extended UI learning promotion smoke coverage for the approval list button accessibility rendering contract
...
- kept the existing fallback stop reset behavior and visible button copy unchanged
- extended UI learning promotion smoke coverage for the fallback stop reset disabled-state accessibility rendering contract
