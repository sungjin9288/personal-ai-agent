...
- generatedAt: 2026-06-06T00:43:52.367Z
- sourceBranch: codex/release-provider-action-labels
- sourceCommit: 04adff5f0d2efa5ef68a29f0022759a06854274a
...
| --- | --- | ---: | ---: |
| `npm run preflight:execution-v1:all` | pass | 0 | 6052 |
