...
- generatedAt: 2026-06-05T08:24:34.284Z
- sourceBranch: codex/action-inbox-copy-link-disabled-label
- sourceCommit: 985bd6dc79a23f86cd07c16bc839fcbb6919f8a4
...
| --- | --- | ---: | ---: |
| `npm run preflight:execution-v1:all` | pass | 0 | 9527 |
