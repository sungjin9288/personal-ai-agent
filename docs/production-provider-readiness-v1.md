...
- generatedAt: 2026-05-15T02:09:24.853Z
- sourceBranch: codex/post-provider-readiness-handoff-artifact-sync
- sourceCommit: 15c2a3a8af0afafe89dd5d7fe37f5ad0a83f211b
...
| --- | --- | ---: | ---: |
| `npm run preflight:execution-v1:all` | pass | 0 | 7118 |
