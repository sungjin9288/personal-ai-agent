...
- generatedAt: 2026-06-05T17:18:04.870Z
- sourceBranch: codex/execution-console-action-labels
- sourceCommit: 41ccb1e034701fcd60dd22735d20a306025f96a1
...
| --- | --- | ---: | ---: |
| `npm run preflight:execution-v1:all` | pass | 0 | 6237 |
