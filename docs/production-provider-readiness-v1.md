...
- generatedAt: 2026-06-04T18:52:54.280Z
- sourceBranch: codex/provider-only-copy-shared-scope-audit-lines
- sourceCommit: f9d38b8fa6ecd65bfcd4f39d4fb5c6a7aa1d8a2a
...
| --- | --- | ---: | ---: |
| `npm run preflight:execution-v1:all` | pass | 0 | 8536 |
