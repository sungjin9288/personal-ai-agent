...
- generatedAt: 2026-06-18T02:12:03.687Z
- sourceBranch: codex/release-status-action-wiring
- sourceCommit: b58fc7cd368334459541cebfd2d8485f75f38ab3
...
| --- | --- | ---: | ---: |
| `npm run preflight:execution-v1:all` | pass | 0 | 6105 |
