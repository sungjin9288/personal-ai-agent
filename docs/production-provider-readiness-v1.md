...
- generatedAt: 2026-06-07T15:50:07.328Z
- sourceBranch: codex/document-attachment-input-labels
- sourceCommit: ad2936979095f0e64f65414fdef117825158e8ae
...
| --- | --- | ---: | ---: |
| `npm run preflight:execution-v1:all` | pass | 0 | 6602 |
