...
- generatedAt: 2026-05-17T14:23:50.582Z
- sourceBranch: codex/post-residual-blockers-artifact-refresh
- sourceCommit: f78a0ead5d476b89d7b4180548a6d7357518a987
...
| --- | --- | ---: | ---: |
| `npm run preflight:execution-v1:all` | pass | 0 | 5333 |
