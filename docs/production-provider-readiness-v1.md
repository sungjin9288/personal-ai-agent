...
- generatedAt: 2026-06-12T06:53:58.824Z
- sourceBranch: codex/release-target-evidence-manifest-base-renderer
- sourceCommit: 71b0110b4f0ca793fcfb78f93b7ab2a8e7e80f45
...
| --- | --- | ---: | ---: |
| `npm run preflight:execution-v1:all` | pass | 0 | 5312 |
