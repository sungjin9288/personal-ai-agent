...
- generatedAt: 2026-06-04T03:43:25.403Z
- sourceBranch: codex/provider-only-copy-provider-guard-smoke
- sourceCommit: 34131f476c83a209f9a3db5fa4347001596178c5
...
| --- | --- | ---: | ---: |
| `npm run preflight:execution-v1:all` | pass | 0 | 5734 |
