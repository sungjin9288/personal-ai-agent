...
- generatedAt: 2026-06-19T06:03:38.873Z
- sourceBranch: codex/restore-target-mission-state
- sourceCommit: f27fb1298ecd7460bef0a363b10246bbe4e5bcd6
...
| --- | --- | ---: | ---: |
| `npm run preflight:execution-v1:all` | pass | 0 | 7012 |
