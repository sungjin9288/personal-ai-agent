...
- generatedAt: 2026-06-04T06:08:28.959Z
- sourceBranch: codex/provider-only-release-link-scope-state
- sourceCommit: 70c0bea1c34c49a13cb0829ddde5b6c654c3c2d4
...
| --- | --- | ---: | ---: |
| `npm run preflight:execution-v1:all` | pass | 0 | 7207 |
