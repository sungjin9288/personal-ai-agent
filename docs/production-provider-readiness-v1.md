...
- generatedAt: 2026-06-12T06:09:26.623Z
- sourceBranch: codex/release-target-evidence-intake-base-renderer
- sourceCommit: e5db0a40fe539904589f37eae77a425e02be36c7
...
| --- | --- | ---: | ---: |
| `npm run preflight:execution-v1:all` | pass | 0 | 5326 |
