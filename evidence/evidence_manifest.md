...
- Source code modified: yes, a content-free F1.1 evaluator now separates structurally valid fine-tuning exports from sufficient candidate-review data, and the non-authorizing MLX fixture adapter binds that policy as an unresolved gate without changing the public runtime, CLI, HTTP, storage, or audit contracts
...
- Full deterministic smoke sweep: 236/236 passed with `npm run smoke:all` on 2026-07-22; browser E2E commands remain separately replayed as listed below
