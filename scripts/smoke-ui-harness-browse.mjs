...
try {
  ...
  assert.equal(appJs.includes('/^(focus-release-blocker|focus-release-history|filter-release-history-provider|filter-release-history-attention|focus-release-flow)$/.test(actionName)'), true);
