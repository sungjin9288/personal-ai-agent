...
try {
  ...
  assert.equal(appJs.includes('pressed: item.sameFlowActive'), true);
  assert.equal(appJs.includes('disabled: item.sameFlowActive ? true : null'), true);
  assert.equal(appJs.includes('pressed: item.attentionFlowActive'), true);
  assert.equal(appJs.includes('disabled: item.attentionFlowActive ? true : null'), true);
  assert.equal(appJs.includes('pressed: focused.sameFlowActive'), true);
  assert.equal(appJs.includes('disabled: focused.sameFlowActive'), true);
  assert.equal(appJs.includes('pressed: focused.attentionFlowActive'), true);
  assert.equal(appJs.includes('disabled: focused.attentionFlowActive'), true);
  assert.equal(appJs.includes('pressed: historyFilterOutcome === \'attention\''), true);
  assert.equal(appJs.includes('pressed: filterScope === item.scope'), true);
  assert.equal(appJs.includes('pressed: filterProvider === item.provider'), true);
  assert.equal(appJs.includes('pressed: historyFilterProvider === focused.id'), true);
  ...
  assert.equal(appJs.includes('provider package 복사: ${item.actionLabel}'), true);
  ...
  assert.equal(appJs.includes('provider live 명령 복사: ${item.actionLabel}'), true);
  ...
  assert.equal(appJs.includes('release flow 링크 복사: ${item.actionSummaryLabel}'), true);
  assert.equal(appJs.includes('provider 링크 복사: ${item.actionLabel}'), true);
  ...
  assert.equal(appJs.includes('actionTargetLabel: item?.label || id || item?.path || \'handoff artifact\''), true);
  assert.equal(appJs.includes('handoff summary line 복사: ${artifact.actionTargetLabel}'), true);
  assert.equal(appJs.includes('handoff summary stable line 복사: ${artifact.actionTargetLabel}'), true);
  assert.equal(appJs.includes('handoff summary overview 복사: ${artifact.actionTargetLabel}'), true);
  assert.equal(appJs.includes('renderReleaseHandoffStructuredSummaryCopyButton'), true);
  assert.equal(appJs.includes('createReleaseHandoffDocumentViewModel'), true);
  assert.equal(appJs.includes('renderReleaseHandoffDocuments'), true);
  assert.equal(appJs.includes('releaseHandoffDocumentCopyButtons'), true);
  ...
  assert.equal(appJs.includes('${item.previewButtonLabel}: ${item.actionTargetLabel}'), true);
  assert.equal(appJs.includes("action: 'toggle-release-handoff-preview'"), true);
  assert.equal(appJs.includes('expanded: item.previewActive'), true);
  assert.equal(appJs.includes("disabled: item.previewActive && previewStatus === 'loading'"), true);
  ...
  assert.equal(appJs.includes('handoff preview 링크 복사: ${item.actionTargetLabel}'), true);
  ...
  assert.equal(appJs.includes('handoff artifact 경로 복사: ${item.actionTargetLabel}'), true);
  assert.equal(appJs.includes('handoff preview 닫기: ${artifact.actionTargetLabel}'), true);
  assert.equal(appJs.includes("const currentLabel = currentPreview ? '현재 ' : '';"), true);
  assert.equal(appJs.includes("copiedText: currentPreview ? '현재 line 복사됨' : undefined"), true);
  assert.equal(appJs.includes("copiedText: currentPreview ? '현재 stable line 복사됨' : undefined"), true);
  assert.equal(appJs.includes("copiedText: currentPreview ? '현재 요약 복사됨' : undefined"), true);
  ...
  assert.equal(appJs.includes('renderReleasePreflightAllButton({ actionLabel: `전체 preflight 실행: ${releaseActionLabel}`'), true);
  ...
  assert.equal(appJs.includes('provider: focused.entry.provider'), true);
  assert.equal(appJs.includes('provider: item.provider'), true);
  assert.equal(appJs.includes('disabled: !focused.entry.ready'), true);
  assert.equal(appJs.includes('pressed: focused.entry.liveConfirmArmed'), true);
  assert.equal(appJs.includes('disabled: !item.ready'), true);
  assert.equal(appJs.includes('pressed: item.liveConfirmArmed'), true);
  ...
  assert.equal(appJs.includes('actionLabel: `provider live 검증 취소: ${item.actionLabel}`'), true);
  ...
  assert.equal(appJs.includes('blocker: focused.topBlockerId'), true);
  assert.equal(appJs.includes('provider: focused.id'), true);
  assert.equal(appJs.includes("outcome: focused.latestActionIsAttention ? 'attention' : ''"), true);
  assert.equal(appJs.includes("outcome: 'attention'"), true);
  assert.equal(appJs.includes('actionLabel: `최근 기록 보기: ${item.latestActionLabel}`'), true);
  assert.equal(appJs.includes('actionLabel: `최근 문제 보기: ${item.latestAttentionLabel}`'), true);
  assert.equal(appJs.includes('actionLabel: item.sameFlowActive ? `현재 flow: ${item.latestActionLabel}` : `같은 flow 보기: ${item.latestActionLabel}`'), true);
  assert.equal(appJs.includes('actionLabel: item.attentionFlowActive ? `현재 문제 흐름: ${item.latestAttentionLabel}` : `같은 문제 흐름 보기: ${item.latestAttentionLabel}`'), true);
  assert.equal(appJs.includes('actionLabel: `release history 기록 고정: ${item.actionSummaryLabel}`'), true);
  ...
  assert.equal(appJs.includes('actionLabel: item.providerFocusLabel'), true);
  assert.equal(appJs.includes('provider: item.providerId'), true);
  assert.equal(appJs.includes("action: item.isFocused ? 'clear-release-provider-focus' : 'focus-release-provider'"), true);
  assert.equal(appJs.includes('actionLabel: item.focusButtonLabel'), true);
  ...
  assert.equal(appJs.includes('focused.actionLabel'), true);
  assert.equal(appJs.includes('focused.latestActionLabel'), true);
  assert.equal(appJs.includes('focused.latestAttentionLabel'), true);
  assert.equal(appJs.includes('item.actionLabel'), true);
  assert.equal(appJs.includes('item.liveButtonLabel'), true);
  assert.equal(appJs.includes('focusButtonLabel'), true);
  assert.equal(appJs.includes('item.providerActionLabel'), true);
  assert.equal(appJs.includes('item.providerFocusLabel'), true);
  assert.equal(appJs.includes('item.actionTargetLabel'), true);
  assert.equal(appJs.includes('item.latestActionLabel'), true);
  assert.equal(appJs.includes('item.latestAttentionLabel'), true);
  ...
  assert.equal(appJs.includes("pressed: String(focused.latestAction.id || '').trim() === (view.history?.focusedHistoryId || '')"), true);
  assert.equal(appJs.includes("pressed: String(focused.latestAttentionAction.id || '').trim() === (view.history?.focusedHistoryId || '')"), true);
  assert.equal(appJs.includes("actionSummaryLabel: `${id || 'release action'} · ${actionLabel} · ${outcome || 'unknown'} · ${scopeLabel}${provider ? ` · ${provider}` : ''}`"), true);
  assert.equal(appJs.includes('release history 기록 고정: ${item.actionSummaryLabel}'), true);
  assert.equal(appJs.includes('pressed: item.isFocused'), true);
  assert.equal(appJs.includes("release history ${item.isExpanded ? '상세 닫기' : '상세 보기'}: ${item.actionSummaryLabel}"), true);
  assert.equal(appJs.includes("action: 'toggle-release-history'"), true);
  assert.equal(appJs.includes('expanded: item.isExpanded'), true);
  assert.equal(appJs.includes('value: item.id'), true);
  ...
  assert.equal(appJs.includes('release history 링크 복사: ${item.actionSummaryLabel}'), true);
  assert.equal(appJs.includes('release flow 링크 복사: ${item.actionSummaryLabel}'), true);
  assert.equal(appJs.includes('release history 주의 상태만 보기: ${item.actionSummaryLabel}'), true);
  assert.equal(appJs.includes('release history 같은 scope 보기: ${item.actionSummaryLabel}'), true);
  assert.equal(appJs.includes('release history 같은 provider 보기: ${item.actionSummaryLabel}'), true);
  assert.equal(appJs.includes("pressed: filterOutcome === 'attention'"), true);
  assert.equal(appJs.includes('pressed: filterScope === item.scope'), true);
  assert.equal(appJs.includes('scope: item.scope'), true);
  assert.equal(appJs.includes('pressed: filterProvider === item.provider'), true);
  assert.equal(appJs.includes('provider: item.provider'), true);
  ...
  assert.equal(appJs.includes('release history 필터 해제: ${item.actionSummaryLabel}'), true);
  assert.equal(appJs.includes('최근 기록 보기: ${item.latestActionLabel}'), true);
  assert.equal(appJs.includes('기록 링크 복사: ${item.latestActionLabel}'), true);
  assert.equal(appJs.includes('최근 문제 보기: ${item.latestAttentionLabel}'), true);
  assert.equal(appJs.includes('문제 기록 링크 복사: ${item.latestAttentionLabel}'), true);
  assert.equal(appJs.includes('같은 flow 보기: ${item.latestActionLabel}'), true);
  assert.equal(appJs.includes('flow 링크 복사: ${item.latestActionLabel}'), true);
  assert.equal(appJs.includes('같은 문제 흐름 보기: ${item.latestAttentionLabel}'), true);
  assert.equal(appJs.includes('문제 흐름 링크 복사: ${item.latestAttentionLabel}'), true);
  assert.equal(appJs.includes('renderReleaseRecommendationActionButton'), true);
  assert.equal(appJs.includes('createReleaseRecommendationViewModel'), true);
  assert.equal(appJs.includes('renderReleaseRecommendations'), true);
  assert.equal(appJs.includes('releaseRecommendationCopyButtons'), true);
  ...
  assert.equal(appJs.includes('권장 액션 실행: ${item.actionTargetLabel}'), true);
  ...
  assert.equal(appJs.includes('${item.command.buttonLabel}: ${item.command.label}'), true);
  assert.equal(appJs.includes('현재 provider 카드: ${providerActionLabel}'), true);
  assert.equal(appJs.includes('provider 카드 보기: ${providerActionLabel}'), true);
  assert.equal(appJs.includes('pressed: item.sameProviderFocused'), true);
  assert.equal(appJs.includes('provider 링크 복사: ${item.providerActionLabel}'), true);
  assert.equal(appJs.includes('provider preflight 실행: ${focused.actionLabel}'), true);
  assert.equal(appJs.includes('provider preflight 명령 복사: ${focused.actionLabel}'), true);
  assert.equal(appJs.includes('provider live 검증 실행: ${actionLabel}'), true);
  assert.equal(appJs.includes('provider live 검증 확인: ${actionLabel}'), true);
  assert.equal(appJs.includes('provider env 필요: ${actionLabel}'), true);
  assert.equal(appJs.includes('aria-pressed="${pressed ? \'true\' : \'false\'}"'), true);
  assert.equal(appJs.includes('aria-disabled="${disabled ? \'true\' : \'false\'}"'), true);
  assert.equal(appJs.includes('provider live 명령 복사: ${focused.actionLabel}'), true);
  assert.equal(appJs.includes('provider package 복사: ${focused.actionLabel}'), true);
  assert.equal(appJs.includes('provider blocker 보기: ${focused.actionLabel}'), true);
  assert.equal(appJs.includes('provider blocker package 복사: ${focused.actionLabel}'), true);
  assert.equal(appJs.includes('최근 provider 기록 보기: ${focused.actionLabel} ${focused.latestActionLabel}'), true);
  assert.equal(appJs.includes('같은 provider 기록만 보기: ${focused.actionLabel}'), true);
  assert.equal(appJs.includes('현재 provider flow: ${focused.actionLabel} ${focused.latestActionLabel}'), true);
  assert.equal(appJs.includes('같은 provider flow 보기: ${focused.actionLabel} ${focused.latestActionLabel}'), true);
  assert.equal(appJs.includes('provider flow 링크 복사: ${focused.actionLabel} ${focused.latestActionLabel}'), true);
  assert.equal(appJs.includes('최근 provider 문제 보기: ${focused.actionLabel} ${focused.latestAttentionLabel}'), true);
  assert.equal(appJs.includes('주의 상태만 보기: ${focused.actionLabel}'), true);
  assert.equal(appJs.includes('현재 provider 문제 흐름: ${focused.actionLabel} ${focused.latestAttentionLabel}'), true);
  assert.equal(appJs.includes('같은 provider 문제 흐름 보기: ${focused.actionLabel} ${focused.latestAttentionLabel}'), true);
  assert.equal(appJs.includes('provider 문제 흐름 링크 복사: ${focused.actionLabel} ${focused.latestAttentionLabel}'), true);
  assert.equal(appJs.includes('provider 포커스 해제: ${focused.actionLabel}'), true);
  assert.equal(appJs.includes('pressed: item.isFocused'), true);
  assert.equal(appJs.includes('provider 링크 복사: ${focused.actionLabel}'), true);
  assert.equal(appJs.includes('현재 triage 링크 복사: ${focused.actionLabel}'), true);
  ...
  assert.equal(appJs.includes('provider preflight 실행: ${item.actionLabel}'), true);
  assert.equal(appJs.includes('provider preflight 명령 복사: ${item.actionLabel}'), true);
  assert.equal(appJs.includes('provider live 검증 실행: ${actionLabel}'), true);
  assert.equal(appJs.includes('provider live 검증 확인: ${actionLabel}'), true);
  assert.equal(appJs.includes('provider env 필요: ${actionLabel}'), true);
  assert.equal(appJs.includes('disabled: !item.ready'), true);
  assert.equal(appJs.includes('provider live 명령 복사: ${item.actionLabel}'), true);
  assert.equal(appJs.includes('provider package 복사: ${item.actionLabel}'), true);
  assert.equal(appJs.includes('provider blocker 보기: ${item.actionLabel}'), true);
  assert.equal(appJs.includes('provider blocker package 복사: ${item.actionLabel}'), true);
  assert.equal(appJs.includes('이 provider 카드 보기: ${actionLabel}'), true);
  assert.equal(appJs.includes('provider 링크 복사: ${item.actionLabel}'), true);
  assert.equal(appJs.includes('provider live 검증 취소: ${item.actionLabel}'), true);
  ...
  assert.equal(appJs.includes('function renderActionInboxUnavailableListEmptyState()'), true);
  ...
  assert.equal(appJs.includes('export function createReleaseHistoryProviderViewModel({'), true);
  assert.equal(appJs.includes('export function renderReleaseActionHistory({'), true);
  assert.equal(appJs.includes('export function renderReleaseProviderReadiness({'), true);
  assert.equal(appJs.includes('copyButtons: releaseEvidenceTriageCopyButtons'), true);
  assert.equal(appJs.includes('copyButtons: releaseHistoryProviderCopyButtons'), true);
  ...
  assert.equal(appJs.includes('pressed: focused.topBlockerId === focusedBlockerId'), true);
  assert.equal(appJs.includes('pressed: item.topBlockerId === focusedBlockerId'), true);
  ...
  assert.equal(appJs.includes('handoff artifact 열기: ${item.actionTargetLabel}'), true);
  assert.equal(appJs.includes('handoff preview 새 탭 열기: ${artifact.actionTargetLabel}'), true);
