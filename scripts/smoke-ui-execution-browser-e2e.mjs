...
function seedReleaseHandoffFixtures() {
  ...
  const handoffFixtures = [
    ...
    {
      content: `# Release Handoff Digest Seed\n\ngeneratedAt: ${generatedAt}\n\n- kind: handoff-digest\n`,
    ...
    {
      content: `artifactVersion=execution-v1-release-handoff-manifest-text/seed\ngeneratedAt=${generatedAt}\nkind=handoff-manifest\n`,
      path: path.join(tempScreenshotDir, 'execution-v1-release-handoff-manifest.txt'),
    },
    {
      content: `# Release Handoff Manifest Seed\n\ngeneratedAt: ${generatedAt}\n\n- kind: handoff-manifest\n`,
    ...
    {
      content: `artifactVersion=execution-v1-release-handoff-index-text/seed\ngeneratedAt=${generatedAt}\nkind=handoff-index\n`,
      path: path.join(tempScreenshotDir, 'execution-v1-release-handoff-index.txt'),
    },
    {
      content: `# Release Handoff Index Seed\n\ngeneratedAt: ${generatedAt}\n\n- kind: handoff-index\n`,
...
try {
  ...
  assert.equal(releaseHandoffLinkVerificationSummary.stableLines.length, 18, JSON.stringify(releaseHandoffLinkVerificationSummary));
  assert.equal(
