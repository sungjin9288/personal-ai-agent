...
for (const term of [
  ...
  'src/core/mission-read-service.mjs',
  'src/core/provider-runtime-service.mjs',
...
for (const [filePath, pattern] of [
  ...
  ['src/core/mission-read-service.mjs', /export function createMissionReadService\(/],
  ['src/core/provider-runtime-service.mjs', /export function createProviderRuntimeService\(/],
