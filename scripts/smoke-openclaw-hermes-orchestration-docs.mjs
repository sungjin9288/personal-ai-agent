...
assert.equal(
  packageJson.scripts['smoke:provider-fallback-route-decision'],
...
for (const term of [
  ...
  'persistent state',
  'team-local rule checklists',
  'completion, failure, recovery, continuation, and promotion outcomes',
  'bad lessons',
...
for (const term of [
  ...
  'query loop heartbeat',
  'context governance as budget governance',
  'recovery as a main path with circuit breakers',
  'state sovereignty',
