...
- Treat Anthropic, Hermes, target local provider, hosted SaaS, production identity/session, tenant isolation, secret manager, observability/SLO, hosted interactive demo or production service URL, generalized pilot feedback, and operating metrics as unverified or blocked unless new evidence is added. The separate n=1 deterministic-only pilot record does not change those boundaries.
