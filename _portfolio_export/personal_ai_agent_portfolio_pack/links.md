...
- Demo walkthrough: docs/demo-scenarios-v1.md
- 발표자료: 없음
- Notion: 없음
- Figma: 없음
- 영상 시연: credential-free representative demo evidence로 대체
- 블로그: 없음
- 기타 참고 링크: 없음
- 비고: 현재 패키지는 로컬-first 포트폴리오 검토용이며, public hosted URL은 접근 검증 전까지 제공하지 않는다.
