...
const PROVIDER_CATALOG = Object.freeze({
  ...
  local: Object.freeze({
    ...
    optionalEnv: Object.freeze([
      ...
      'LOCAL_PROVIDER_PROBE_TIMEOUT_MS',
      'LOCAL_PROVIDER_RUN_TIMEOUT_MS',
    ...
    envKeys: Object.freeze({
      ...
      probeTimeoutMs: 'LOCAL_PROVIDER_PROBE_TIMEOUT_MS',
      runTimeoutMs: 'LOCAL_PROVIDER_RUN_TIMEOUT_MS',
    ...
    configurationFields: Object.freeze([
      ...
      Object.freeze({
        key: 'probeTimeoutMs',
        envKey: 'LOCAL_PROVIDER_PROBE_TIMEOUT_MS',
        defaultValue: '5000',
      }),
      Object.freeze({
        key: 'runTimeoutMs',
        envKey: 'LOCAL_PROVIDER_RUN_TIMEOUT_MS',
        defaultValue: '15000',
      }),
      Object.freeze({
        key: 'inputCostPer1MUsd',
